...
// HFmrEF was removed in the 2026 ESC guidelines (HFrEF now covers LVEF <50%,
// HFpEF covers LVEF >=50%). Kept as a selectable value only so patients
// already classified under the 2021 scheme keep a readable label — never
// auto-assigned by fenotipoFromFevi below.
export const FENOTIPOS = [
  { value: 'HFrEF', label: 'HFrEF' },
  { value: 'HFmrEF', label: 'HFmrEF (clasificación 2021, en desuso)' },
  { value: 'HFpEF', label: 'HFpEF' },
  { value: 'HFimpEF', label: 'HFimpEF' },
];

/**
 * Auto-classify fenotipo from a typed FEVI percentage, per the 2026 ESC
 * guidelines (HFrEF <50%, HFpEF >=50% — HFmrEF removed). Returns null when
...
/** Generic patient-reported symptom severity (Subjetivo checklist) — not
 * tied to a specific exam finding, unlike `EDEMA_MI_GRADO`. */
export const SEVERIDAD_SINTOMA = [
