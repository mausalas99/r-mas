...
/**
 * @typedef {'hc' | 'labs' | 'header'} DriveImportReviewStepKind
 */
...
/**
 * @typedef {DriveImportHcReviewStep | DriveImportLabsReviewStep | DriveImportHeaderReviewStep} DriveImportReviewStep
 */
...
export function buildDriveImportReviewSteps(parsed, opts) {
  opts = opts || {};
  const steps = buildHcReviewSteps(parsed, !!opts.createNew);
