...
export function createLabRepoPortalClient(deps = {}) {
  ...
  function storeCookies(res) {
    cookieJar = mergeSetCookie(cookieJar, res);
  }
  ...
  async function ensureRegistroMode(html) {
    ...
    return await post(LAB_REPO_BASE_URL, {
      ...hidden,
  ...
  async function searchByRegistro(registro) {
    ...
    const hidden = buildAspNetHiddenFields(first);
    const controls = parseSearchFormControls(first);
