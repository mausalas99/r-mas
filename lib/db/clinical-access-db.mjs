...
/**
 * @param {import('better-sqlite3').Database} db
 * @param {{ name: string, service: string, onCallDayIndex: number, subAreaFraction?: string, sala?: string|null, teamLeaderName?: string|null, createdBy?: string }} opts
 */
export function createTeam(db, { name, service, onCallDayIndex, subAreaFraction, sala, teamLeaderName, createdBy }) {
