...
test('computeDescongestion includes balance acumulado with override', () => {
  const r = computeDescongestion({
    ingresoDate: '2026-03-13',
    asOfDate: '2026-03-19',
    inicioDescongestion: '2026-03-13',
    ...
    balanceAcumuladoMl: 250,
    overrides: { balanceAcumuladoMl: 300 },
  });
  assert.equal(r.balanceAcumuladoMl, 300);
});
