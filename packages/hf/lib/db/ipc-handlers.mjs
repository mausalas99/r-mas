...
import { registerDbClinicalRepoHandlers } from './ipc-handlers-register-clinical-repo.mjs';
import { registerCardioImageHandlers } from './ipc-handlers-register-cardio-images.mjs';
...
export function registerDbIpcHandlers({ ipcMain, dbManager, app, dialog, safeStorage: _safeStorage, getClientId }) {
  ...
  registerDbClinicalRepoHandlers(ctx);
  registerCardioImageHandlers(ctx);
}
