...
import { buildDriveImportReviewSteps } from './drive-import-review.mjs';
import { editTextToHcPatchValue } from './drive-import-hc-edit.mjs';
...
test('buildDriveImportReviewSteps skips Historia clínica sections', () => {
  const parsed = {
    header: {},
    driveSections: {
  ...
  assert.equal(steps.some((s) => s.kind === 'hc'), false);
});
