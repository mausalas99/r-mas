...
|---------|-----------|------------|
| Laboratorio / SOME | `public/js/labs*.mjs`, `lab-panel.mjs`, `lab-history-some-reparse.mjs` | Magic moment pipeline; Nube manda `sourceText`, peers reparsean |
...
| Cloud sync (Nube) | `public/js/features/cloud-sync/` (`panel-conexion`, `autostart`, `mutate-bridge`, `room-sync-ws`), `cloud/sync-worker/` (`RoomSyncHub` DO) | [security](../core/15-security.md); [spec](../superpowers/specs/2026-08-02-cloud-sync-free-pilot-design.md) (at-rest AES superseded); **realtime DO+WS:** [2026-08-07](../superpowers/specs/2026-08-07-cloud-sync-realtime-do-design.md); mobile: [2026-08-05](../superpowers/specs/2026-08-05-cloud-mobile-ipad-design.md) |
