...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  checkForModuleUpdate: function() {
    return ipcRenderer.invoke('check-for-module-update');
  },
  ...
  adminCodeStatus: function() {
    return ipcRenderer.invoke('db:admin-code-status');
  },
  adminCodeVerify: function(opts) {
    return ipcRenderer.invoke('db:admin-code-verify', opts);
  },
  adminCodeSet: function(opts) {
    return ipcRenderer.invoke('db:admin-code-set', opts);
  },
