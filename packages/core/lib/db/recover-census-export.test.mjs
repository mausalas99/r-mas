...
test('collectPatientsFromBlobs pulls patients from census + LAN snapshots + sidecars', () => {
  ...
  collectPatientsFromBlobs(map, {
    ...
    lanRoomSnapshots: JSON.stringify({
      'sala-2': {
        entries: [{ patient: { id: 'mse7o3e5ki64rzfq1l', nombre: 'SUPUESTO INVENTADO FICTICIO CASOAG', registro: '8100012-7' } }],
      },
    }),
  ...
  assert.equal(map.get('mse7o3e5ki64rzfq1l')?.registro, '8100012-7');
