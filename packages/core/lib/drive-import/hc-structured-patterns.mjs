import ahfConditions from './catalogs/ahf-conditions.json' with { type: 'json' };
import toxicomaniasSubstances from './catalogs/toxicomanias-substances.json' with { type: 'json' };
import { APP_DEDICATED_IDS, AHF_RELATIVES } from './hc-catalog-constants.mjs';
