import { salaOnCallR1 } from '../clinical-scope/guardia-coverage.mjs';
import { resolvePatientSala } from '../clinical-scope/patient-sala.mjs';
import { normalizePendientesJson } from '../entrega/entrega-pendientes.mjs';

/** @param {unknown} clinicalOps decrypted team/guardia data */
...
/** @param {object[]} entries room entries — identity fields plaintext, content fields may still be encrypted envelopes */
