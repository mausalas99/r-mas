...
// Shared assertion for an aborted swap: nothing trashed, and the old app was
// renamed away then renamed straight back (same two paths, reversed).
function assertAbortedAndRolledBack(deps, trashCalls) {
...
describe('runQuietSwap — verify failure after rename', () => {
  it('renames the old app back into place and never trashes it', async () => {
    ...
    assertAbortedAndRolledBack(deps, trashCalls);
  });
});
