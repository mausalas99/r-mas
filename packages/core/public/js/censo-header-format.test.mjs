...
test('formatCensoEquipoLine: la lista del listado gana a los nombres viejos del censo', () => {
  var line = formatCensoEquipoLine({
    residenteR2: 'Viejo R2',
    profesorName: 'Dr. Nota',
    medicosPlantilla: { r2: 'Nuevo R2', r1a: '', r1b: '', profesor: 'Dr. Listado' },
  });
  assert.equal(line, 'Nuevo R2 · Dr. Listado');
});
