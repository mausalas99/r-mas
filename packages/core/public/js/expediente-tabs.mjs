...
export const CONSOLIDATED_TABS_INTER = ['paciente', 'clinico'];
...
export const SALIDA_SECTIONS_SALA = ['listado', 'vpo'];
...
function syncSalidaPanes(target, settings) {
...
export function syncConsolidatedPaneVisibility(granularTab, settings, opts) {
  ...
  syncSalidaPanes(target, settings);
  syncDatosPane();
