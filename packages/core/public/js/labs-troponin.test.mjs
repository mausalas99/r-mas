...
Expediente:	9000019-8	Solicitud:	900010
Nombre:	SINTETICO EJEMPLO MODELO CASOAB	Fecha Registro:	Jul 7 2026 1:24PM
Sexo:	MASCULINO	Ubicación:	URGENCIAS ADULTOS
Edad:	20	Medico:	FICTICIO SINTETICO EJEMPLO A
...
Expediente:	9000019-8
Nombre:	SINTETICO EJEMPLO MODELO CASOAB	Fecha Registro:	Jul 7 2026 10:24AM
BANCO DE SANGRE
HsTnl o Troponina I (Alta Sensibilidad)	
12.5
ng/L	
...
test('procesarLabs incluye bloque TROP para banco de sangre', () => {
  ...
  assert.equal(patient.expediente, '9000019-8');
  assert.equal(patient.name, 'SINTETICO EJEMPLO MODELO CASOAB');
});
