...
var LAB_SECTION_LEAD_RE =
  /^(BH|QS|ESC|PFHs?|GASES|COAG|ORINA|EGO|EU|DEPCR|CUANTORINA|PROT12H|PROT24H|PltCit|LIPASA|CULTIVO|LCR|TROP|GS|SEROL|FROTIS|HECES|PIE|INTERPRETACI[OÓ]N|LIQ|ASCITIS|TIR|ENDO|CARD|FE|FEB|INFL|INM|META|NEF|NIVEL|TM|NUT|GI|TOX|HEPB|VIRAL|MICRO)\b/i;

// Cuenta: cannot sit inside …\b (colon is non-word → \b never matches before space).
var CULTIVO_START_RE =
  /^(?:(?:CULTIVO|BACTERIOLOGIA|UROCULTIVO|HEMOCULTIVO|FUNGICULTIVO|COPROCULTIVO|TINCION\s+DE\s+GRAM|CATETER|ATB|Cultivos|BACILOSCOPIA)\b|Cuenta:)/i;
