...
const MUESTRA_SEROL = `
Expediente:	9000011-3	Solicitud:	900009
Nombre:	GENERICO SUPUESTO INVENTADO CASOAF	Fecha Registro:	May 25 2026 5:07PM
Sexo:	MASCULINO	Ubicación:	MED.1
Edad:	50	Medico:	FICTICIO SINTETICO EJEMPLO A
...
test('procesarLabs incluye bloque SEROL para banco de sangre', () => {
  ...
  assert.equal(patient.expediente, '9000011-3');
  assert.equal(patient.name, 'GENERICO SUPUESTO INVENTADO CASOAF');
});
