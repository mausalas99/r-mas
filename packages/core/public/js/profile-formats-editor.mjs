...
function editorBanner(title, subtitle) {
  return (
    ...
    '<button type="button" class="wb-btn wb-btn-secondary wb-btn-lg" data-onclick="exitFormatsEditor">Volver al expediente</button>' +
    "</div></div>"
  );
}
...
function editorFooter() {
  return (
    ...
    '<button type="button" class="wb-btn wb-btn-primary wb-btn-lg formats-defaults-save-btn" data-onclick="saveDefaultFormatsFromEditor">Guardar</button>' +
    "</div>"
  );
}
...
export function buildNoteDefaultsEditorHtml(st) {
  ...
  return (
    ...
    '<textarea id="fmt-default-nota-evolucion" rows="7" placeholder="N: [Neurológico]&#10;V: [Ventilatorio]…" data-oninput="updateDefaultFormatField" data-oninput-args=\'["notaEvolucion"]\' data-oninput-pass="value">' +
    ...
    '<div class="card-body"><div class="field-group">' +
    '<textarea id="fmt-default-nota-estudios" rows="9" placeholder="FECHA (DD/MM/AA)&#10;QS&#10;BH…" data-oninput="updateDefaultFormatField" data-oninput-args=\'["notaEstudios"]\' data-oninput-pass="value">' +
  ...
  var body = sections
    .map(function (s) {
      return (
        ...
        '" rows="3" placeholder="' +
        esc(s.ph) +
        '" data-oninput="updateDefaultFormatField" data-oninput-args=\'["' +
        s.key +
        '"]\' data-oninput-pass="value">' +
        esc(s.val) +
        "</textarea></div></div>"
      );
    })
