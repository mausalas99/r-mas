...
describe('mobile-team-patient-scope', () => {
  ...
  it('shows an unassigned Interconsultas patient to the on-call IC team, same as desktop', () => {
    const icScope = {
      teams: [
        {
          team_id: 't-ic',
    ...
    const user = { user_id: 'r2-ic', rank: 'R2' };
    const census = [{ id: 'p-ic', servicio: 'Cardiología', area: 'Interconsultas' }];
    const out = filterPatientsForMobileTeamMirror(census, user, icScope, null);
