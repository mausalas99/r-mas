...
function isLabSectionLabel(label, lineIndex) {
  ...
  return /^(BH|QS|ESC|PFHs|GASES|PIE|LCR|EGO|EU|DEPCR|CUANTORINA|PROT12H|PROT24H|PltCit|FROTIS|SEROL|GS|HECES|COAG|LIPASA|TROP|TIR|ENDO|CARD|FE|FEB|INFL|INM|META|NEF|NIVEL|TM|NUT|GI|TOX|HEPB|VIRAL|MICRO)$/i.test(
    t
  );
}
