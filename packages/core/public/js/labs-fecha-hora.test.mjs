...
const HEADER_MAY_AM = `
Expediente:	9000007-8	Solicitud:	9000000028
Nombre:	SUPUESTO INVENTADO CASOAW	Fecha Registro:	May 18 2026 3:24AM
Sexo:	MASCULINO	Ubicación:	NEUROMEDICA
Edad:	70	Medico:	FICTICIO SINTETICO EJEMPLO A
`;

const HEADER_NUM_PM = `
Nombre:	SIMULADO GENERICO CASOAU	Fecha Registro:	07/05/2026 04:32:46 p. m.
`;
