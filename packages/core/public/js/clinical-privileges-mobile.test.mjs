...
// Runs the sidebar filter as the fixture Admin user against scopeFixture.
function filterAsAdmin(census) {
  return filterPatientsForClinicalSidebar(
    census,
...
test('Admin on iPad sidebar filters by joined team', () => {
  ...
  const out = filterAsAdmin(census);
