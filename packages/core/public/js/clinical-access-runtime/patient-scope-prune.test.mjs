...
// Seeds the standard scope on desktop (mobile=false) or mobile Nube, runs fn, then cleans up.
function withSeededScope(mobile, fn) {
  const prevMobile = globalThis.__RPC_MOBILE_WEB__;
  if (mobile) globalThis.__RPC_MOBILE_WEB__ = true;
  else delete globalThis.__RPC_MOBILE_WEB__;
