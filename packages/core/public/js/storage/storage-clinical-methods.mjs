import { readClinicalBlob, readTodosMap, writeTodosMap, writeClinicalBlob, safeParseArray, safeParseObject } from './storage-core.mjs';
...
export const clinicalBlobStorageMethods = {
  ...
  saveMedCatalog(catalog) {
    writeClinicalBlob('medCatalog', 'rpc-medCatalog', buildMedCatalogPayload(catalog), 'clinical.med_catalog_save');
  },
  ...
  saveScheduledProcedures(events) {
    ...
    writeClinicalBlob('scheduledProcedures', 'rpc-scheduled-procedures', filtered, 'clinical.agenda_save');
  },
