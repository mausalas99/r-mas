...
export function evaluarPleuralInfeccion_(pH, glu, leu) {
  var alerts = [];
  // BTS 2023: pH <=7.2 implica alto riesgo de derrame paraneumónico complicado
  // / empiema. Antes el corte era "< 7.2" y un pH de exactamente 7.20 no
  // disparaba la alerta aquí, aunque el algoritmo BTS de Neumo (pH, glucosa y
  // LDH) sí la trataba como alto riesgo — dos módulos con veredictos
  // distintos sobre el mismo líquido.
