...
const ROGELIO_MAY15 = `
Expediente:\t9000099-7\tSolicitud:\t2605150542
Nombre:\tFICTICIO SINTETICO CASOZi\tFecha Registro:\tMay 15 2026 11:31AM
HEMATOLOGIA
DIFERENCIAL MANUAL
SEGMENTADOS\tA\n71\n%\t50 - 70
LINFOCITOS\t*\n25\n%\t10 - 50
...
DIMERO D\t A 2276 ng/mL 0.0 - 500.0`;
  ...
  it('dímero D con UEF y membrete Campo no inventa Fib fantasma', () => {
    const ddCampo = `Expediente:\t9000104-0\tSolicitud:\t2608080013
Nombre:\tFICTICIO SINTETICO EJEMPLO CASOZa\tFecha Registro:\tAug 8 2026 12:37AM
HEMATOLOGIA
DIMERO D
DIMERO D\tA\n881\nng/mL\t0.0 - 500.0
UEF (UNIDADES EQUIVALENTES DE FIBRINOGENO\t*
COMENTARIO\t*
Campo 90001234 Labo -647 LABX 90001 LABY`;
