...
/** Checks the standard p-mine / p-other patients against a scope context for a user. */
function checkMineOtherReadable(user, ctx) {
...
describe('clinical-scope-from-ops', () => {
  ...
  it('builds teams with members and filters patients by joined team', () => {
    ...
    const { mine, other } = checkMineOtherReadable(user, ctx);
