...
export function parseESC_(texto, priorRefs) {
  ...
  // Un electrolito puede llegar solo (p. ej. un K de control sin panel completo)
  // — no descartarlo solo porque el reporte no trae Sodio.
  if ([naData, clData, kData, caData, fData, mgData].every(function (d) {
    return d.valor === '---';
  })) {
    return '';
  }
