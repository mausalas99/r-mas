...
const TARGETS = {
  ...
  ic_board_map:      { appTab: 'nota', selector: '#ic-board-mount',                           focus: false,
                       spotlightClass: 'tour-spotlight-action', showIcBoard: true },
  ic_board_drilldown: { appTab: 'nota', selector: '#ic-board-mount',                          focus: false,
                       spotlightClass: 'tour-spotlight-action', showIcBoard: true },
  ic_board_actions:  { appTab: 'nota', selector: '.ic-board-header',                          focus: false,
                       spotlightClass: 'tour-spotlight-action', showIcBoard: true },
  ic_consult_band:   { appTab: 'nota', selector: '.ic-consult-band',                          focus: false,
                       spotlightClass: 'tour-spotlight-action' },
  ...
  gv7_guardia_toggle: {
    appTab: null,
    selector: '.guardia-census-table [data-wb-chip-id="pendiente"]',
    focus: false,
    openGuardiaDensity: true,
    spotlightClass: 'tour-spotlight-action',
  },
  ...
  gv7_censo_r4: {
    appTab: null,
    selector: '.r4-section-divider, #guardia-census-grid',
    focus: false,
    openGuardiaDensity: true,
    spotlightClass: 'tour-spotlight-action',
  },
