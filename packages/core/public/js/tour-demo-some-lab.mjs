/**
 * Reportes SOME de demostración para el tour guiado (DEMO PÉREZ).
 * Formato copiado desde expediente SOME; valores inventados y no clínicos reales.
 */
...
export const OLDER_DEMO_SOME_LAB_REPORT =
  'Expediente:\t9000095-7\tSolicitud:\t2603050188\n' +
...
export const DEMO_GARCIA_LAB_REPORT =
  'Expediente:\t9000094-3\tSolicitud:\t2605110312\n' +
