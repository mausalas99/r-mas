...
export const tendenciasWindowHandlers = {
  ...
  openTendDynamicTableModal: tc.openTendDynamicTableModal,
  closeTendDynamicTableModal: tc.closeTendDynamicTableModal,
  copyTendDynamicTablePng: tc.copyTendDynamicTablePng,
  copyTendDynamicTableText: tc.copyTendDynamicTableText,
