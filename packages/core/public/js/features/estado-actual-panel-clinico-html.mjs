...
function renderDietProposalBarHtml(dietOptions, selectedIndex) {
      ...
      dietOptions
        .map(function (opt, idx) {
          ...
          return (
            ...
            '"' +
            checked +
            ' data-onchange="selectEaDietOption" data-onchange-args="[' +
            String(idx) +
            ']">' +
            '<span>' +
  ...
  return (
    ...
    '<button type="button" class="ea-btn ea-btn--success" data-onclick="confirmEaDietProposal">Confirmar dieta</button>' +
    '<button type="button" class="ea-btn" data-onclick="discardEaDietProposal">Descartar</button>' +
    '</div></div>'
  );
}
  ...
  return (
    ...
    (anyPending
      ? '<div class="ea-clinico-actions">' +
        '<button type="button" class="ea-btn ea-btn--success" data-onclick="confirmAllEaMedProposals">Confirmar todas las propuestas</button>' +
        '</div>'
      : '') +
    '</div>'
  );
