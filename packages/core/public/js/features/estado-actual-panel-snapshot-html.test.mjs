...
test('renderHistorialSection — cada fila trae Editar y Eliminar con su id', () => {
  ...
  assert.match(html, /data-onclick="editarEstadoActualMedicion" data-onclick-args='\[&quot;row-1&quot;\]'>Editar</);
  assert.match(html, /data-onclick="eliminarEstadoActualMedicion" data-onclick-args='\[&quot;row-1&quot;\]'>Eliminar</);
});
