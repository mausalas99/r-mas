...
/** Pushes one historial entry with `vitals` and asserts the HD line reads ESTABLE. */
function assertStableHdForVitals(vitals) {
...
test('buildEstadoActualText mantiene ESTABLE por defecto con hipotensión (solo el médico lo cambia a mano)', () => {
  assertStableHdForVitals({ tas: 85, tad: 55, fc: 80 });
});
...
test('buildEstadoActualText mantiene ESTABLE con hipertensión aislada', () => {
  assertStableHdForVitals({ tas: 155, tad: 95, fc: 80 });
});
