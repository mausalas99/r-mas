...
function buildInsulinRescateGroupRowHtml(activeId, items) {
  ...
  return (
    ...
    " data-onchange='toggleMedRecetaInsulinRescateSuspendido' data-onchange-pass='checked'" +
    "/>" +
    "</div>" +
    '<div class="med-receta-checkcell">' +
    ...
    " data-onchange='toggleMedRecetaInsulinRescateParaNota' data-onchange-pass='checked'" +
    "/>" +
    "</div>" +
...
function buildInsulinPrandialGroupRowHtml(activeId, items) {
  ...
  return (
    ...
    " data-onchange='toggleMedRecetaInsulinPrandialSuspendido' data-onchange-pass='checked'" +
    "/>" +
    "</div>" +
    '<div class="med-receta-checkcell">' +
    '<input type="checkbox" data-med-soap-chk="1"' +
    ...
    " data-onchange='toggleMedRecetaInsulinPrandialParaNota' data-onchange-pass='checked'" +
    "/>" +
    "</div>" +
    '<div class="med-receta-name">' +
...
function buildPotassiumReposGroupRowHtml(activeId, items) {
  ...
  return (
    ...
    " data-onchange='toggleMedRecetaPotassiumReposSuspendido' data-onchange-pass='checked'" +
    "/>" +
    "</div>" +
    '<div class="med-receta-checkcell">' +
    '<input type="checkbox" data-med-soap-chk="1"' +
    ...
    " data-onchange='toggleMedRecetaPotassiumReposParaNota' data-onchange-pass='checked'" +
    "/>" +
    "</div>" +
    '<div class="med-receta-name">' +
...
function buildStanfordSolutionGroupRowHtml(activeId, items) {
  ...
  return (
    ...
    " data-onchange='toggleMedRecetaStanfordSolutionSuspendido' data-onchange-pass='checked'" +
    "/>" +
    "</div>" +
    '<div class="med-receta-checkcell">' +
    '<input type="checkbox" data-med-soap-chk="1"' +
    ...
    " data-onchange='toggleMedRecetaStanfordSolutionParaNota' data-onchange-pass='checked'" +
    "/>" +
    "</div>" +
    '<div class="med-receta-name">' +
...
function buildMedRecetaRowHtml(activeId, it, fechaActualizacion, allItems) {
  ...
  var soapCell = soapEligible
    ? '<div class="med-receta-checkcell">' +
      ...
      ' data-onchange="toggleMedRecetaParaNota" data-onchange-args=\'' +
      escAttr(JSON.stringify([sid])) +
      "' data-onchange-pass=\"checked\"" +
      "/>" +
      "</div>"
  ...
  return (
    ...
    ' data-onchange="toggleMedRecetaSuspendido" data-onchange-args=\'' +
    escAttr(JSON.stringify([sid])) +
    "' data-onchange-pass=\"checked\"" +
    "/>" +
    "</div>" +
