    ...
    .map((item) => {
      if (item.type === 'legacy_text') {
        ...
        return `<li class="entrega-proc-card entrega-proc-card--legacy" data-item-id="${escapeHtml(item.id)}">
          ...
          ${
            canDel
              ? `<button type="button" class="wb-btn wb-btn-danger-outline entrega-proc-delete" data-action="delete">Eliminar</button>`
              : ''
          }
        </li>`;
      }
    ...
    <div class="entrega-inline-form" role="group" aria-label="Agregar procedimiento">
      ...
      <div class="entrega-inline-form__foot">
        <div class="entrega-inline-form__foot-actions entrega-inline-form__foot-actions--end">
          <button type="button" class="wb-btn wb-btn-secondary wb-btn-lg" data-action="cancel-form">Cancelar</button>
          <button type="button" class="wb-btn wb-btn-primary wb-btn-lg" data-action="add-item">Añadir</button>
        </div>
      </div>
    </div>`;
}
