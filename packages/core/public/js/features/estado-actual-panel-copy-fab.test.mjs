...
test('refreshEaCopyFabVisibility — oculta FAB fuera de Estado actual aunque haya paciente', () => {
  if (typeof document === 'undefined') return;
  const fab = setupFabWithActivePatient({ getActiveInner() { return 'todo'; } });
