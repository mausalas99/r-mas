...
function renderIcExpedienteTabs(bodyEl, nextBtn) {
  var mod = getPlatformShortcutKey();
  bodyEl.innerHTML =
    '<p style="margin:0;line-height:1.5;">En <strong>Interconsulta</strong>, <strong>Paciente</strong> abre en <strong>Resumen</strong>. Grupos: <strong>Resumen</strong> y <strong>Clínico</strong> (Nota, Indicaciones). Labs, tendencias y cultivos viven en <strong>Laboratorio</strong>.</p>' +
