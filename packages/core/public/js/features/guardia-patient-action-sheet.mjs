...
function renderEventualidadStep(ctx) {
  ...
  body.innerHTML =
    ...
    '<button type="button" class="wb-btn wb-btn-secondary wb-btn-lg" id="guardia-patient-action-back">Volver</button>' +
    '<button type="button" class="wb-btn wb-btn-primary wb-btn-lg" id="guardia-patient-action-save">Guardar</button>' +
    '</div>';
