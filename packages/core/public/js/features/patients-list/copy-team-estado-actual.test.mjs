...
describe('copy-team-estado-actual', () => {
  ...
  it('includes only pinned patients that have estado actual, skips unpinned and empty', () => {
    _applyRepoSnapshot({
      patients: [
        { id: 'p1', nombre: 'Ejemplo Casobq', pinned: true, monitoreo: { estadoClinico: { resumen: 'Estable' } } },
        { id: 'p2', nombre: 'Ficticio Casobo', pinned: false, monitoreo: { estadoClinico: { resumen: 'Estable' } } },
