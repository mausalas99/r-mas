...
async function handleUsernameStepSubmit(ev) {
  ...
  if (needsClaim) {
    const { assertLanRoomForUsernameRegister } = await import("/js/chunks/clinical-profile-lan-sync-SWMW26HK.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  } = await import("/js/chunks/clinical-profile-lan-sync-SWMW26HK.js");
  ...
  const { refreshMainClinicalOnboardingIfNeeded } = await import("/js/chunks/clinical-onboarding-main-RCEOIRJ3.js");
...
async function handleResumeIdentityClick() {
  ...
  try {
    ...
    if (!needsUsernameClaim()) {
      const { refreshMainClinicalOnboardingIfNeeded: refreshMainClinicalOnboardingIfNeeded2 } = await import("/js/chunks/clinical-onboarding-main-RCEOIRJ3.js");
...
async function renderOnboardingPanelInto(host) {
  ...
  if (!needsProfileOnboarding()) {
    const { hideMainClinicalOnboarding } = await import("/js/chunks/clinical-onboarding-main-RCEOIRJ3.js");
    hideMainClinicalOnboarding();
    if (host.closest("#clinical-teams-panel-body")) {
      const { renderClinicalTeamsPanel } = await import("/js/chunks/clinical-teams-KS5XOW5S.js");
...
//# sourceMappingURL=/js/chunks/chunk-NYF4YMFU.js.map
