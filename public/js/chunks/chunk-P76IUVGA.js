...
async function enableClinicalLanFromSettings() {
  ...
  try {
    const { closeSettingsDropdown, syncTeamSyncHeaderButton } = await import("/js/chunks/settings-dropdown-B4GGJFNH.js");
    closeSettingsDropdown();
    syncTeamSyncHeaderButton();
  } catch (_e) {
  }
  try {
    const main = await import("/js/chunks/clinical-onboarding-main-JE3A4B53.js");
...
//# sourceMappingURL=/js/chunks/chunk-P76IUVGA.js.map
