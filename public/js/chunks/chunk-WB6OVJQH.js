import {
  ...
  needsTeamOnboarding
} from "/js/chunks/chunk-B4T5CG7D.js";
import {
...
async function openLanConnectPanelForPin() {
  try {
    const { openConnectionDropdown, focusLanShiftPinInput } = await import("/js/chunks/lan-sync-IDQ3ELXI.js");
...
async function handleLanConnectCtaClick() {
  ...
  if (/^\d{6}$/.test(savedPin)) {
    try {
      const { tryEasyLanShiftPinConnect } = await import("/js/chunks/lan-shift-pin-connect-PB3PWCYA.js");
...
async function isLanConnectCtaVisible() {
  ...
  try {
    const lan = await import("/js/chunks/lan-sync-IDQ3ELXI.js");
...
async function openMiRotacion() {
  ...
  const { ensureClinicalPanelSession } = await import("/js/chunks/clinical-panel-host-FGXGMGEW.js");
  const sessionOk = await ensureClinicalPanelSession();
  if (!sessionOk) {
    const mainMod = await import("/js/chunks/clinical-onboarding-main-CLHQAOSE.js");
  ...
  const { wireClinicalTeamsModalChrome } = await import("/js/chunks/teams-roster-modal-chrome-Y4LLN22H.js");
  wireClinicalTeamsModalChrome();
  const { openClinicalTeamsPanel } = await import("/js/chunks/teams-roster-6BFMDI2W.js");
...
//# sourceMappingURL=/js/chunks/chunk-WB6OVJQH.js.map
