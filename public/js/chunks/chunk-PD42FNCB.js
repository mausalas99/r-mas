...
async function ensureLiveSyncRoomForUsernameRegister(opts = {}) {
  const lan = await import("./lan-sync-M6IB5RSY.js");
...
async function applyClinicalDbUnlockCompletion() {
  ...
  try {
    var appState = await import("./app-state-BBIKX7AN.js");
  ...
  try {
    var settingsMod = await import("./clinical-settings-W3NJZ4UH.js");
    var runtime6 = await import("./clinical-access-runtime-R3Q7UHJW.js");
  ...
  try {
    var onboardingMain = await import("./clinical-onboarding-main-FGCA5HTW.js");
...
async function publishClinicalTeamsToLan() {
  try {
    const mod = await import("./lan-sync-M6IB5RSY.js");
...
Desaparecer\xE1 del directorio LAN. Las dem\xE1s R+ en la misma sala \u21C4 lo quitar\xE1n al sincronizar.`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("./clinical-profile-lan-sync-6NADHGDN.js");
...
function backgroundRefreshLanUsersDirectory() {
  void import("./lan-sync-M6IB5RSY.js").then((lanMod) => {
...
async function refreshTeamsUiAfterChange() {
  await fetchClinicalTeamsFromDb();
  import("./clinical-rotation-entry-PQP7NXTW.js").then((m) => m.syncClinicalRotationEntryChrome());
...
async function openClinicalTeamsPanel() {
  ...
  try {
    const { needsClinicalOnboarding } = await import("./clinical-onboarding-EUHJLUQG.js");
    if (needsClinicalOnboarding()) {
      closeClinicalTeamsPanel();
      const { openMiRotacion } = await import("./clinical-rotation-entry-PQP7NXTW.js");
...
async function handleProfileFormSubmit(ev) {
  ...
  if (usernameWillChange) {
    const { assertLanRoomForUsernameRegister: assertLanRoomForUsernameRegister2 } = await import("./clinical-profile-lan-sync-6NADHGDN.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, LAN_PROFILE_PUSH_FAILED_MSG: LAN_PROFILE_PUSH_FAILED_MSG2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("./clinical-profile-lan-sync-6NADHGDN.js");
  const lanPush = await flushClinicalProfileToLan2();
  if (!lanPush.ok && !isBenignLanPushSkipCode2(lanPush.code)) {
  ...
  syncRotationConfigButton();
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  void import("./lan-sync-M6IB5RSY.js").then((mod) => {
    if (typeof mod.scheduleLiveSyncPush === "function") mod.scheduleLiveSyncPush();
  }).catch(() => {
  });
  void import("./patients-GZBFHXNC.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
async function joinTeamById(teamId, subAreaFraction) {
  ...
  if (filterJoinedTeams(clinicalSessionContext.teams, clinicalSessionContext.user).some(
    ...
    const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("./teams-roster-YRBZJ7QM.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await publishClinicalTeamsToLan();
  const { refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("./teams-roster-YRBZJ7QM.js");
...
function wireClinicalTeamsControls() {
  ...
  import("./clinical-rotation-entry-PQP7NXTW.js").then((mod) => {
...
function wireClinicalOpsLanSyncEvents() {
  ...
  if (!document._rpcClinicalTeamsChangedLanWired) {
    ...
    document.addEventListener("rpc-clinical-teams-changed", function() {
      void import("./push-WALLFORC.js").then(function(m) {
...
async function openR4TeamCreationModal() {
  try {
    var mod = await import("./clinical-teams-P76M4LPY.js");
...
async function saveLanSettingsFromUi(opts) {
  ...
  if (pingOk) {
    ...
    void import("./historia-clinica-lan-sync-MQFJQ4QQ.js").then(function(m) {
...
function sendLiveSyncMutation(mutation) {
  ...
  void import("./room-FCZ5TNCP.js").then(function(mod) {
...
async function applyConflictUseServer(payload) {
  ...
  if (server && server.data) {
    if (payload.entityType === "historiaClinica" && payload.patientId) {
      ...
      if (hcRow) {
        var mod = await import("./historia-clinica-lan-sync-MQFJQ4QQ.js");
...
async function applyBootstrapResult(res) {
  ...
  if (typeof document !== "undefined") {
    void import("./clinical-profile-lan-sync-6NADHGDN.js").then((mod) => mod.flushClinicalProfileToLan()).catch(() => {
    });
  }
  migrateLocalPatientsClinicalSala();
}
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("./patients-GZBFHXNC.js").then((mod) => mod.renderPatientList()).catch(() => {
      });
    }
  }
  return migrated;
  ...
  return drainOutbox(rid).then(function(items) {
    ...
    function pushLiveSyncPatchOutbox(envelope) {
      ...
      return trySend().then(function(sent) {
        ...
        return import("./room-FCZ5TNCP.js").then(function(mod) {
...
//# sourceMappingURL=chunk-PD42FNCB.js.map
