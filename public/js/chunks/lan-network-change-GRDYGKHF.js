...
} from "/js/chunks/chunk-3BBN7ZCD.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-U2NHFH23.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-RLXUYVZD.js");
  ...
  const transport = await import("/js/chunks/transport-X2VCMWYH.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-EMGBF7WP.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-GRDYGKHF.js.map
