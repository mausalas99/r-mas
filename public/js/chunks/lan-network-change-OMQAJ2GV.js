...
} from "/js/chunks/chunk-GLKXGRRY.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-KWUTK7UO.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-X5BQO7FN.js");
  ...
  const transport = await import("/js/chunks/transport-BKOES2IM.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-WIPJPRVW.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-OMQAJ2GV.js.map
