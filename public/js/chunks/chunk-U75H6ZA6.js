...
async function enableClinicalLanFromSettings() {
  ...
  try {
    const { closeSettingsDropdown, syncTeamSyncHeaderButton } = await import("/js/chunks/settings-dropdown-VJKNXXGD.js");
    closeSettingsDropdown();
    syncTeamSyncHeaderButton();
  } catch (_e) {
  }
  try {
    const main = await import("/js/chunks/clinical-onboarding-main-FURUJ37H.js");
...
//# sourceMappingURL=/js/chunks/chunk-U75H6ZA6.js.map
