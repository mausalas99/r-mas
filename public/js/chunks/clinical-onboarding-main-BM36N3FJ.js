...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-K6SAA3QO.js").then((m) => m.syncClinicalRotationEntryChrome());
}
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-FAVQJ5L6.js");
...
//# sourceMappingURL=/js/chunks/clinical-onboarding-main-BM36N3FJ.js.map
