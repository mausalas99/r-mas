...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-F7V7E3LR.js").then((m) => m.syncClinicalRotationEntryChrome());
  void import("/js/chunks/tour-engine-DKIIRPRY.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/js/chunks/learn-hub-GFBBGGVS.js").then((m) => {
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-PVY2ELFE.js");
...
//# sourceMappingURL=/js/chunks/chunk-KCH77UA3.js.map
