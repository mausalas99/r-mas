import {
  ...
  needsTeamOnboarding
} from "/js/chunks/chunk-QRJ6UQCR.js";
import {
...
async function openLanConnectPanelForPin() {
  try {
    const { openConnectionDropdown, focusLanShiftPinInput } = await import("/js/chunks/lan-sync-GJHZV543.js");
...
async function handleLanConnectCtaClick() {
  ...
  if (/^\d{6}$/.test(savedPin)) {
    try {
      const { tryEasyLanShiftPinConnect } = await import("/js/chunks/lan-shift-pin-connect-OZKCM663.js");
...
async function isLanConnectCtaVisible() {
  ...
  try {
    ...
    const { getRoomSyncPhase, RoomSyncPhase } = await import("/js/chunks/lan-sync-state-L7ZITS2K.js");
...
async function openMiRotacion() {
  ...
  const { ensureClinicalPanelSession } = await import("/js/chunks/clinical-panel-host-ETMWKX3M.js");
  ...
  const { wireClinicalTeamsModalChrome } = await import("/js/chunks/teams-roster-modal-chrome-MZGLVHII.js");
  wireClinicalTeamsModalChrome();
  const { openClinicalTeamsPanel } = await import("/js/chunks/teams-roster-ZOAJLTR7.js");
...
//# sourceMappingURL=/js/chunks/chunk-3VGQBCPY.js.map
