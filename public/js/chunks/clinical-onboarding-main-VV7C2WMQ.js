...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-N76ZO4SY.js").then((m) => m.syncClinicalRotationEntryChrome());
}
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-DBDCCVOJ.js");
...
//# sourceMappingURL=/js/chunks/clinical-onboarding-main-VV7C2WMQ.js.map
