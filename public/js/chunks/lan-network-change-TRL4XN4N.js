...
} from "/js/chunks/chunk-JT5UK3F3.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-UZTRK7RQ.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-J4HLXZH3.js");
  ...
  const transport = await import("/js/chunks/transport-GNHH5JPT.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-BYAC5RXR.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-TRL4XN4N.js.map
