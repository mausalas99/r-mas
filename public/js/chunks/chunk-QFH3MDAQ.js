...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-JUOSEUOW.js").then((m) => m.syncClinicalRotationEntryChrome());
  void import("/js/chunks/tour-engine-DG2M5RKU.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/js/chunks/learn-hub-VB7IGZPA.js").then((m) => {
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-ANPSEHE4.js");
...
//# sourceMappingURL=/js/chunks/chunk-QFH3MDAQ.js.map
