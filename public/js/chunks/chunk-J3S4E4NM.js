...
async function handleUsernameStepSubmit(ev) {
  ...
  if (needsClaim) {
    const { assertLanRoomForUsernameRegister } = await import("./clinical-profile-lan-sync-3R65VAGQ.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  } = await import("./clinical-profile-lan-sync-3R65VAGQ.js");
  ...
  const { refreshMainClinicalOnboardingIfNeeded } = await import("./clinical-onboarding-main-LNSHJIGJ.js");
...
async function handleResumeIdentityClick() {
  ...
  try {
    ...
    if (!needsUsernameClaim()) {
      const { refreshMainClinicalOnboardingIfNeeded: refreshMainClinicalOnboardingIfNeeded2 } = await import("./clinical-onboarding-main-LNSHJIGJ.js");
...
async function renderOnboardingPanelInto(host) {
  ...
  if (!needsProfileOnboarding()) {
    const { hideMainClinicalOnboarding } = await import("./clinical-onboarding-main-LNSHJIGJ.js");
    hideMainClinicalOnboarding();
    if (host.closest("#clinical-teams-panel-body")) {
      const { renderClinicalTeamsPanel } = await import("./clinical-teams-6O3S6HYA.js");
...
//# sourceMappingURL=chunk-J3S4E4NM.js.map
