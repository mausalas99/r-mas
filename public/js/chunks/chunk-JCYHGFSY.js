...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/js/chunks/entrega-roster-panel-2MERUYBW.js").then(({ deactivateTurnoActivo: deactivateTurnoActivo2, closeEntregaRosterPanel: closeEntregaRosterPanel2 }) => {
      deactivateTurnoActivo2();
      closeEntregaRosterPanel2();
    });
    void import("/js/chunks/guardia-phase-bar-Q6YL56KF.js").then(({ teardownGuardiaPhaseBar: teardownGuardiaPhaseBar2 }) => {
...
function setUiDensity(mode) {
  ...
  void import("/js/chunks/clinical-rotation-entry-3U2XUI3F.js").then((mod) => {
...
async function ensureClinicalPanelSession() {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/js/chunks/db-unlock-QL745KKS.js");
...
async function publishClinicalTeamsToLan() {
  try {
    const mod = await import("/js/chunks/lan-sync-FWVZIHKH.js");
...
async function pullClinicalOpsFromLanRoom(options = {}) {
  ...
  lanClinicalOpsPullInFlight = (async () => {
    try {
      const lan = await import("/js/chunks/lan-sync-FWVZIHKH.js");
...
var LAN_DIRECTORY_POLL_MS = 6e4;
var LAN_DIRECTORY_OPS_SYNC_DEBOUNCE_MS = 800;
var LAN_DIRECTORY_LAN_PULL_MIN_MS = 3e4;
var lastLanDirectoryFingerprint = "";
var lanDirectoryLanPullLastAt = 0;
var lanDirectoryLocalRefreshTimer = null;
...
Desaparecer\xE1 del directorio LAN. Las dem\xE1s R+ en la misma sala \u21C4 lo quitar\xE1n al sincronizar.`
  ...
  const { isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-F277ZDQ6.js");
...
var lanDirectoryPollTimer = null;
var lanDirectoryOpsSyncDebounce = null;
var lanDirectoryRefreshPending = false;
...
async function refreshLanDirectoryUiFromLocalDb(options = {}) {
...
function scheduleLanDirectoryLocalRefresh(force = false) {
...
async function pullLanDirectoryFromHostIfDue(options = {}) {
  ...
  try {
    const lanMod = await import("/js/chunks/lan-sync-FWVZIHKH.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-interactions-7IEGSGCW.js");
...
async function refreshTeamsUiAfterChange() {
  const { refreshClinicalPatientListForScope: refreshClinicalPatientListForScope2 } = await import("/js/chunks/clinical-access-runtime-J3WZWJHL.js");
  await refreshClinicalPatientListForScope2();
  import("/js/chunks/clinical-rotation-entry-3U2XUI3F.js").then((m) => m.syncClinicalRotationEntryChrome());
...
async function openClinicalTeamsPanel(opts = {}) {
  ...
  if (!sessionOk) {
    const mainMod = await import("/js/chunks/clinical-onboarding-main-KLHRKWDF.js");
  ...
  try {
    if (!opts.skipProfileGate) {
      const { needsClinicalOnboarding } = await import("/js/chunks/clinical-onboarding-HT6GCCQT.js");
      if (needsClinicalOnboarding()) {
        closeClinicalTeamsPanel();
        const { openMiRotacion } = await import("/js/chunks/clinical-rotation-entry-3U2XUI3F.js");
  ...
  try {
    const { stopLanAutoDiscovery: stopLanAutoDiscovery2 } = await import("/js/chunks/panel-FK6PKHUT.js");
...
function closeClinicalTeamsPanel() {
  ...
  import("/js/chunks/panel-FK6PKHUT.js").then((m) => {
...
async function handleProfileFormSubmit(ev) {
  ...
  if (usernameWillChange) {
    const { assertLanRoomForUsernameRegister: assertLanRoomForUsernameRegister2 } = await import("/js/chunks/clinical-profile-lan-sync-F277ZDQ6.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, LAN_PROFILE_PUSH_FAILED_MSG: LAN_PROFILE_PUSH_FAILED_MSG2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-F277ZDQ6.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await refreshTeamsUiAfterChange();
  void import("/js/chunks/lan-sync-FWVZIHKH.js").then((mod) => {
    if (typeof mod.scheduleLiveSyncPush === "function") mod.scheduleLiveSyncPush();
  }).catch(() => {
  });
  void import("/js/chunks/patients-C2VS6PQV.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
async function joinTeamById(teamId, subAreaFraction) {
  ...
  if (filterJoinedTeams(clinicalSessionContext.teams, clinicalSessionContext.user).some(
    ...
    const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-JNTQ7K6L.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await publishClinicalTeamsToLan();
  const { refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/js/chunks/teams-roster-JNTQ7K6L.js");
...
async function redirectLanInviteFromTeamJoinField(raw) {
  const text = String(raw || "").trim();
  if (!text) return false;
  const { openConnectionDropdown: openConnectionDropdown2, joinLanFromInviteUi: joinLanFromInviteUi2 } = await import("/js/chunks/lan-sync-FWVZIHKH.js");
...
function loadRoster() {
  return import("/js/chunks/teams-roster-JNTQ7K6L.js");
}
...
function wireClinicalTeamsControls() {
  void import("/js/chunks/teams-roster-modal-chrome-2N7W4KGJ.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/js/chunks/clinical-rotation-entry-3U2XUI3F.js").then((mod) => {
...
function ensureLanSyncPushBridgeWired() {
  ...
  if (!pushBridgeWirePromise) {
    pushBridgeWirePromise = import("/js/chunks/orchestrator-KQ73KD3Y.js").then(function() {
      if (!pushBridge && typeof globalThis !== "undefined") {
  ...
  return drainOutbox(rid).then(function(items) {
    ...
    function pushLiveSyncPatchOutbox(envelope) {
      ...
      return trySend().then(function(sent) {
        ...
        return import("/js/chunks/room-JQODROW2.js").then(function(mod) {
...
function finishReconcilePhase(rid, b) {
  ...
  void import("/js/chunks/room-JQODROW2.js").then(function(mod) {
...
async function consolidateIntoHost(winnerUrl, teamCode, opts) {
  opts = opts || {};
  const room = await import("/js/chunks/room-JQODROW2.js");
...
async function initLanHostPlugAndPlay() {
  ...
  try {
    const pinMod = await import("/js/chunks/lan-shift-pin-connect-DYGMWIV2.js");
...
function ensureLanSyncRoomBridgeWired() {
  ...
  if (!roomBridgeWirePromise) {
    roomBridgeWirePromise = import("/js/chunks/orchestrator-KQ73KD3Y.js").then(function() {
      if (!roomBridge && typeof globalThis !== "undefined") {
...
function applyRoomSyncPhaseAfterReconcile(roomId) {
  ...
  if (lanClient.liveConnected && (liveRid === rid || !liveRid)) {
    ...
    void import("/js/chunks/lan-shift-pin-connect-DYGMWIV2.js").then(function(m) {
...
function startLiveSyncReconnectLoop() {
  ...
  function tick() {
    ...
    if (_liveSyncReconnectAttempt >= 2 && !_shiftPinRediscoverInFlight) {
      ...
      void import("/js/chunks/lan-shift-pin-connect-DYGMWIV2.js").then(function(mod) {
...
function bootLanRoomMembership() {
  ...
  void (async function() {
    var rid = m.roomId;
    try {
      const accessMod = await import("/js/chunks/clinical-access-runtime-J3WZWJHL.js");
...
function syncLiveSyncAfterRoomJoinBody(rid) {
  ...
  return chain.then(function() {
    ...
    void import("/js/chunks/clinical-access-runtime-J3WZWJHL.js").then(function(accessMod) {
    ...
    void import("/js/chunks/historia-clinica-lan-sync-UA73W67W.js").then(function(m) {
...
async function openR4TeamCreationModal() {
  try {
    var mod = await import("/js/chunks/clinical-teams-LSOSCJPO.js");
...
async function applyConflictUseServer(payload) {
  ...
  if (server && server.data) {
    if (payload.entityType === "historiaClinica" && payload.patientId) {
      ...
      if (hcRow) {
        var mod = await import("/js/chunks/historia-clinica-lan-sync-UA73W67W.js");
...
function openEntregaRosterPanel(settings) {
  ...
  document.getElementById("roster-btn-cancel")?.addEventListener("click", () => {
    void (async () => {
      ...
      const { endEntregaPhase: endEntregaPhase2 } = await import("/js/chunks/clinical-entrega-DDSEV6YS.js");
      endEntregaPhase2();
...
async function applyBootstrapResult(res) {
  ...
  await fetchClinicalScopeContextFromDb();
  if (typeof document !== "undefined") {
    void import("/js/chunks/clinical-profile-lan-sync-F277ZDQ6.js").then((mod) => mod.flushClinicalProfileToLan()).catch(() => {
    });
  }
...
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/js/chunks/patients-C2VS6PQV.js").then((mod) => mod.renderPatientList({ silent: true })).catch(() => {
      });
    }
  }
  return migrated;
...
async function ensureTeamAssignedPatientsOnDevice() {
  ...
  if (elevated) {
    ...
    const { filterJoinedTeams: filterJoinedTeams2 } = await import("/js/chunks/shared-SIYEBH66.js");
  ...
  try {
    ...
    if (!rid) return;
    const push = await import("/js/chunks/push-OIEP5ITW.js");
...
async function refreshClinicalPatientListForScope() {
  ...
  if (typeof document === "undefined") return;
  try {
    const mod = await import("/js/chunks/patients-C2VS6PQV.js");
...
async function flushClinicalProfileToLan(opts = {}) {
  ...
  const pushMod = await import("/js/chunks/push-OIEP5ITW.js");
...
//# sourceMappingURL=/js/chunks/chunk-JCYHGFSY.js.map
