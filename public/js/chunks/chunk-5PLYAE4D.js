...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/js/chunks/entrega-roster-panel-ELMCJZHV.js").then(({ deactivateTurnoActivo: deactivateTurnoActivo2, closeEntregaRosterPanel: closeEntregaRosterPanel2 }) => {
      deactivateTurnoActivo2();
      closeEntregaRosterPanel2();
    });
    void import("/js/chunks/guardia-phase-bar-YTQTCTYJ.js").then(({ teardownGuardiaPhaseBar: teardownGuardiaPhaseBar2 }) => {
...
function setUiDensity(mode) {
  ...
  void import("/js/chunks/clinical-rotation-entry-7PBZQRUO.js").then((mod) => {
...
async function ensureLiveSyncRoomForUsernameRegister(opts = {}) {
  const lan = await import("/js/chunks/lan-sync-4WIBIVPI.js");
...
async function flushClinicalProfileToLan(opts = {}) {
  ...
  const pushMod = await import("/js/chunks/push-VBEC6OLG.js");
...
async function ensureClinicalPanelSession() {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/js/chunks/db-unlock-J7DE3M2B.js");
...
async function publishClinicalTeamsToLan() {
  try {
    const mod = await import("/js/chunks/lan-sync-4WIBIVPI.js");
...
Desaparecer\xE1 del directorio LAN. Las dem\xE1s R+ en la misma sala \u21C4 lo quitar\xE1n al sincronizar.`
  ...
  const { isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-WV745DKQ.js");
...
async function pullLanDirectoryFromHostIfDue(options = {}) {
  ...
  try {
    const lanMod = await import("/js/chunks/lan-sync-4WIBIVPI.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-interactions-WMLVPQAC.js");
...
async function refreshTeamsUiAfterChange() {
  const { isLanDirectoryModalOpen: isLanDirectoryModalOpen2 } = await import("/js/chunks/teams-roster-lan-IIW4O54M.js");
  if (isLanDirectoryModalOpen2()) return;
  const { refreshClinicalPatientListForScope: refreshClinicalPatientListForScope2 } = await import("/js/chunks/clinical-access-runtime-WUM2P63U.js");
  await refreshClinicalPatientListForScope2({ allowLanPull: false });
  import("/js/chunks/clinical-rotation-entry-7PBZQRUO.js").then((m) => m.syncClinicalRotationEntryChrome());
...
async function openClinicalTeamsPanel(opts = {}) {
  ...
  if (!sessionOk) {
    const mainMod = await import("/js/chunks/clinical-onboarding-main-YRH6LE7V.js");
  ...
  try {
    if (!opts.skipProfileGate) {
      const { needsClinicalOnboarding } = await import("/js/chunks/clinical-onboarding-QVELZ33D.js");
      if (needsClinicalOnboarding()) {
        closeClinicalTeamsPanel();
        const { openMiRotacion } = await import("/js/chunks/clinical-rotation-entry-7PBZQRUO.js");
  ...
  try {
    const { stopLanAutoDiscovery: stopLanAutoDiscovery2 } = await import("/js/chunks/panel-OYF3P2VQ.js");
...
function closeClinicalTeamsPanel() {
  ...
  import("/js/chunks/panel-OYF3P2VQ.js").then((m) => {
...
async function handleProfileFormSubmit(ev) {
  ...
  if (usernameWillChange) {
    const { assertLanRoomForUsernameRegister: assertLanRoomForUsernameRegister2 } = await import("/js/chunks/clinical-profile-lan-sync-WV745DKQ.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, LAN_PROFILE_PUSH_FAILED_MSG: LAN_PROFILE_PUSH_FAILED_MSG2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-WV745DKQ.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await refreshTeamsUiAfterChange();
  void import("/js/chunks/lan-sync-4WIBIVPI.js").then((mod) => {
    if (typeof mod.pushClinicalOpsLanNow === "function") void mod.pushClinicalOpsLanNow();
  }).catch(() => {
  });
  void import("/js/chunks/patients-KJV5E4IT.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
async function joinTeamById(teamId, subAreaFraction) {
  ...
  if (filterJoinedTeams(clinicalSessionContext.teams, clinicalSessionContext.user).some(
    ...
    const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-W4ITTHCQ.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await publishClinicalTeamsToLan();
  const { refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/js/chunks/teams-roster-W4ITTHCQ.js");
...
async function redirectLanInviteFromTeamJoinField(raw) {
  const text = String(raw || "").trim();
  if (!text) return false;
  const { openConnectionDropdown: openConnectionDropdown2, joinLanFromInviteUi: joinLanFromInviteUi2 } = await import("/js/chunks/lan-sync-4WIBIVPI.js");
...
function loadRoster() {
  return import("/js/chunks/teams-roster-W4ITTHCQ.js");
}
...
function wireClinicalTeamsControls() {
  void import("/js/chunks/teams-roster-modal-chrome-SF35HTGY.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/js/chunks/clinical-rotation-entry-7PBZQRUO.js").then((mod) => {
...
function openEntregaRosterPanel(settings) {
  ...
  document.getElementById("roster-btn-cancel")?.addEventListener("click", () => {
    void (async () => {
      ...
      const { endEntregaPhase: endEntregaPhase2 } = await import("/js/chunks/clinical-entrega-BUEPU5WA.js");
      endEntregaPhase2();
...
async function openOrphanEntrega(btn, settings) {
  ...
  try {
    ...
    const entrega = await import("/js/chunks/clinical-entrega-BUEPU5WA.js");
...
function appendLanShiftPinClientConnectSection(root, gen) {
  ...
  void shouldShowLanShiftPinClientConnect().then(function(offer) {
    ...
    btn.addEventListener("click", function() {
      ...
      btn.disabled = true;
      void import("/js/chunks/lan-shift-pin-connect-YFEB7TJW.js").then(function(m) {
...
async function openR4TeamCreationModal() {
  try {
    var mod = await import("/js/chunks/clinical-teams-ZGXSHRIX.js");
...
async function saveLanSettingsFromUi(opts) {
  ...
  if (pingOk) {
    ...
    void import("/js/chunks/historia-clinica-lan-sync-HDUXRLJP.js").then(function(m) {
...
function wireLanNetworkRefresh() {
  ...
  window.addEventListener("online", function() {
    void import("/js/chunks/room-HIMXR4OE.js").then(function(m) {
...
async function applyConflictUseServer(payload) {
  ...
  if (server && server.data) {
    if (payload.entityType === "historiaClinica" && payload.patientId) {
      ...
      if (hcRow) {
        var mod = await import("/js/chunks/historia-clinica-lan-sync-HDUXRLJP.js");
...
async function applyBootstrapResult(res) {
  ...
  await fetchClinicalScopeContextFromDb();
  if (typeof document !== "undefined") {
    void import("/js/chunks/clinical-profile-lan-sync-WV745DKQ.js").then((mod) => mod.flushClinicalProfileToLan()).catch(() => {
    });
  }
...
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/js/chunks/patients-KJV5E4IT.js").then((mod) => mod.renderPatientList({ silent: true })).catch(() => {
      });
    }
  }
  return migrated;
...
async function ensureTeamAssignedPatientsOnDevice(options) {
  ...
  if (elevated) {
    ...
    const { filterJoinedTeams: filterJoinedTeams2 } = await import("/js/chunks/shared-BSGU27XS.js");
  ...
  try {
    ...
    if (!rid) return;
    const push = await import("/js/chunks/push-VBEC6OLG.js");
...
async function refreshClinicalPatientListForScope(options) {
  ...
  refreshClinicalPatientListForScopeInFlight = (async function() {
    ...
    if (typeof document === "undefined") return;
    try {
      const mod = await import("/js/chunks/patients-KJV5E4IT.js");
...
async function initLanHostPlugAndPlay() {
  ...
  if (!isClinicalRankConfiguredForLan()) return;
  try {
    const pinMod = await import("/js/chunks/lan-shift-pin-connect-YFEB7TJW.js");
...
function ensureLanSyncPushBridgeWired() {
  ...
  if (!pushBridgeWirePromise) {
    pushBridgeWirePromise = import("/js/chunks/orchestrator-4PY4LGTZ.js").then(function() {
      if (!pushBridge && typeof globalThis !== "undefined") {
  ...
  return drainOutbox(rid).then(function(items) {
    ...
    function pushLiveSyncPatchOutbox(envelope) {
      ...
      return trySend().then(function(sent) {
        ...
        return import("/js/chunks/room-HIMXR4OE.js").then(function(mod) {
...
function finishReconcilePhase(rid, b) {
  ...
  void import("/js/chunks/room-HIMXR4OE.js").then(function(mod) {
...
function ensureLanSyncRoomBridgeWired() {
  ...
  if (!roomBridgeWirePromise) {
    roomBridgeWirePromise = import("/js/chunks/orchestrator-4PY4LGTZ.js").then(function() {
      if (!roomBridge && typeof globalThis !== "undefined") {
...
function startLiveSyncReconnectLoop() {
  ...
  function tick() {
    ...
    if (_liveSyncReconnectAttempt >= 2 && !_shiftPinRediscoverInFlight && canAttemptAutoHostDetect()) {
      ...
      void import("/js/chunks/lan-shift-pin-connect-YFEB7TJW.js").then(function(mod) {
...
function bootLanRoomMembership() {
  ...
  void (async function() {
    var rid = m.roomId;
    try {
      const accessMod = await import("/js/chunks/clinical-access-runtime-WUM2P63U.js");
...
function syncLiveSyncAfterRoomJoinBody(rid) {
  ...
  return chain.then(function() {
    ...
    void import("/js/chunks/clinical-access-runtime-WUM2P63U.js").then(function(accessMod) {
...
//# sourceMappingURL=/js/chunks/chunk-5PLYAE4D.js.map
