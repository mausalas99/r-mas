...
} from "/js/chunks/chunk-JTWDCKIQ.js";
import {
...
} from "/js/chunks/chunk-KZDHSMBN.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-SK4DXXLK.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-F5RD3WTM.js");
  ...
  const transport = await import("/js/chunks/transport-VJKDEYNE.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-CEW5AENM.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-FOKTZKRE.js.map
