...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-WZCG2AMA.js").then((m) => m.syncClinicalRotationEntryChrome());
}
...
async function showMainClinicalOnboarding() {
  ...
  try {
    ...
    prefillRegistrationFromUrlParams();
    const rot = await import("/js/chunks/clinical-rotation-entry-WZCG2AMA.js");
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-FDNQGIXG.js");
...
//# sourceMappingURL=/js/chunks/clinical-onboarding-main-5L3MA34O.js.map
