...
async function handleUsernameStepSubmit(ev) {
  ...
  if (needsClaim) {
    const { assertLanRoomForUsernameRegister } = await import("./clinical-profile-lan-sync-6NADHGDN.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  } = await import("./clinical-profile-lan-sync-6NADHGDN.js");
  ...
  const { refreshMainClinicalOnboardingIfNeeded } = await import("./clinical-onboarding-main-FGCA5HTW.js");
...
async function handleResumeIdentityClick() {
  ...
  try {
    ...
    if (!needsUsernameClaim()) {
      const { refreshMainClinicalOnboardingIfNeeded: refreshMainClinicalOnboardingIfNeeded2 } = await import("./clinical-onboarding-main-FGCA5HTW.js");
...
async function renderOnboardingPanelInto(host) {
  ...
  if (!needsProfileOnboarding()) {
    const { hideMainClinicalOnboarding } = await import("./clinical-onboarding-main-FGCA5HTW.js");
    hideMainClinicalOnboarding();
    if (host.closest("#clinical-teams-panel-body")) {
      const { renderClinicalTeamsPanel } = await import("./clinical-teams-P76M4LPY.js");
...
//# sourceMappingURL=chunk-INXYWK3A.js.map
