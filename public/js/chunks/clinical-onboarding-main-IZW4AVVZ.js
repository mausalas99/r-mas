...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-VKGO3NP2.js").then((m) => m.syncClinicalRotationEntryChrome());
}
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-66ILXNFN.js");
...
//# sourceMappingURL=/js/chunks/clinical-onboarding-main-IZW4AVVZ.js.map
