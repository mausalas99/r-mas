...
} from "/js/chunks/chunk-GP7HQCGG.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const panel = await import("/js/chunks/panel-3TGI5BQK.js");
  ...
  const transport = await import("/js/chunks/transport-PVUW7N4U.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-L3TATIM2.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-36AJDFST.js.map
