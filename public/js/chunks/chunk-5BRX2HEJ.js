...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/js/chunks/entrega-roster-panel-O5RC3AKH.js").then(({ deactivateTurnoActivo: deactivateTurnoActivo2, closeEntregaRosterPanel: closeEntregaRosterPanel2 }) => {
      deactivateTurnoActivo2();
      closeEntregaRosterPanel2();
    });
    void import("/js/chunks/guardia-phase-bar-65QP2X7L.js").then(({ teardownGuardiaPhaseBar: teardownGuardiaPhaseBar2 }) => {
...
function setUiDensity(mode) {
  ...
  void import("/js/chunks/clinical-rotation-entry-BQT67XBA.js").then((mod) => {
...
async function ensureLiveSyncRoomForUsernameRegister(opts = {}) {
  const lan = await import("/js/chunks/lan-sync-DGR7VYSZ.js");
...
async function flushClinicalProfileToLan(opts = {}) {
  ...
  const pushMod = await import("/js/chunks/push-S56HJSWB.js");
...
async function ensureClinicalPanelSession() {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/js/chunks/db-unlock-4VSP4PRQ.js");
...
async function publishClinicalTeamsToLan() {
  try {
    const mod = await import("/js/chunks/lan-sync-DGR7VYSZ.js");
...
Desaparecer\xE1 del directorio LAN. Las dem\xE1s R+ en la misma sala \u21C4 lo quitar\xE1n al sincronizar.`
  ...
  const { isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-WOI6ATDN.js");
...
async function pullLanDirectoryFromHostIfDue(options = {}) {
  ...
  try {
    const lanMod = await import("/js/chunks/lan-sync-DGR7VYSZ.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-interactions-ASALFBN5.js");
...
async function refreshTeamsUiAfterChange() {
  const { isLanDirectoryModalOpen: isLanDirectoryModalOpen2 } = await import("/js/chunks/teams-roster-lan-BCNRD3FZ.js");
  if (isLanDirectoryModalOpen2()) return;
  const { refreshClinicalPatientListForScope: refreshClinicalPatientListForScope2 } = await import("/js/chunks/clinical-access-runtime-YGLB7JFR.js");
  await refreshClinicalPatientListForScope2({ allowLanPull: false });
  import("/js/chunks/clinical-rotation-entry-BQT67XBA.js").then((m) => m.syncClinicalRotationEntryChrome());
...
async function openClinicalTeamsPanel(opts = {}) {
  ...
  if (!sessionOk) {
    const mainMod = await import("/js/chunks/clinical-onboarding-main-NFE5AVVB.js");
  ...
  try {
    if (!opts.skipProfileGate) {
      const { needsClinicalOnboarding } = await import("/js/chunks/clinical-onboarding-GARU2A54.js");
      if (needsClinicalOnboarding()) {
        closeClinicalTeamsPanel();
        const { openMiRotacion } = await import("/js/chunks/clinical-rotation-entry-BQT67XBA.js");
  ...
  try {
    const { stopLanAutoDiscovery: stopLanAutoDiscovery2 } = await import("/js/chunks/panel-EC6K3IYV.js");
...
function closeClinicalTeamsPanel() {
  ...
  import("/js/chunks/panel-EC6K3IYV.js").then((m) => {
...
async function handleProfileFormSubmit(ev) {
  ...
  if (usernameWillChange) {
    const { assertLanRoomForUsernameRegister: assertLanRoomForUsernameRegister2 } = await import("/js/chunks/clinical-profile-lan-sync-WOI6ATDN.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, LAN_PROFILE_PUSH_FAILED_MSG: LAN_PROFILE_PUSH_FAILED_MSG2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-WOI6ATDN.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await refreshTeamsUiAfterChange();
  void import("/js/chunks/lan-sync-DGR7VYSZ.js").then((mod) => {
    if (typeof mod.pushClinicalOpsLanNow === "function") void mod.pushClinicalOpsLanNow();
  }).catch(() => {
  });
  void import("/js/chunks/patients-SWQQ37AP.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
async function joinTeamById(teamId, subAreaFraction) {
  ...
  if (filterJoinedTeams(clinicalSessionContext.teams, clinicalSessionContext.user).some(
    ...
    const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-WSEVQQNY.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await publishClinicalTeamsToLan();
  const { refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/js/chunks/teams-roster-WSEVQQNY.js");
...
async function redirectLanInviteFromTeamJoinField(raw) {
  const text = String(raw || "").trim();
  if (!text) return false;
  const { openConnectionDropdown: openConnectionDropdown2, joinLanFromInviteUi: joinLanFromInviteUi2 } = await import("/js/chunks/lan-sync-DGR7VYSZ.js");
...
function loadRoster() {
  return import("/js/chunks/teams-roster-WSEVQQNY.js");
}
...
function wireClinicalTeamsControls() {
  void import("/js/chunks/teams-roster-modal-chrome-Y5LW6Q26.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/js/chunks/clinical-rotation-entry-BQT67XBA.js").then((mod) => {
...
function openEntregaRosterPanel(settings) {
  ...
  document.getElementById("roster-btn-cancel")?.addEventListener("click", () => {
    void (async () => {
      ...
      const { endEntregaPhase: endEntregaPhase2 } = await import("/js/chunks/clinical-entrega-Y6RY5BLB.js");
      endEntregaPhase2();
...
async function openOrphanEntrega(btn, settings) {
  ...
  try {
    ...
    const entrega = await import("/js/chunks/clinical-entrega-Y6RY5BLB.js");
...
function appendLanShiftPinClientConnectSection(root, gen) {
  ...
  void shouldShowLanShiftPinClientConnect().then(function(offer) {
    ...
    btn.addEventListener("click", function() {
      ...
      btn.disabled = true;
      void import("/js/chunks/lan-shift-pin-connect-F5U7BCCM.js").then(function(m) {
...
async function openR4TeamCreationModal() {
  try {
    var mod = await import("/js/chunks/clinical-teams-UKAFRSHP.js");
...
async function saveLanSettingsFromUi(opts) {
  ...
  if (pingOk) {
    ...
    void import("/js/chunks/historia-clinica-lan-sync-63XJ6ODW.js").then(function(m) {
...
function wireLanNetworkRefresh() {
  ...
  window.addEventListener("online", function() {
    void import("/js/chunks/room-OGQ22I6C.js").then(function(m) {
...
async function applyConflictUseServer(payload) {
  ...
  if (server && server.data) {
    if (payload.entityType === "historiaClinica" && payload.patientId) {
      ...
      if (hcRow) {
        var mod = await import("/js/chunks/historia-clinica-lan-sync-63XJ6ODW.js");
...
async function applyBootstrapResult(res) {
  ...
  if (typeof document !== "undefined") {
    void import("/js/chunks/clinical-profile-lan-sync-WOI6ATDN.js").then((mod) => mod.flushClinicalProfileToLan()).catch(() => {
    });
  }
...
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/js/chunks/patients-SWQQ37AP.js").then((mod) => mod.renderPatientList({ silent: true })).catch(() => {
      });
    }
  }
  return migrated;
...
async function scheduleLanPatientReconcile(reason, delayMs2) {
  try {
    ...
    if (!rid) return;
    const push = await import("/js/chunks/push-S56HJSWB.js");
...
async function ensureTeamAssignedPatientsOnDevice2(options) {
  ...
  if (elevated) {
    ...
    const { filterJoinedTeams: filterJoinedTeams2 } = await import("/js/chunks/shared-AZID6I5G.js");
...
async function refreshClinicalPatientListForScope(options) {
  ...
  refreshClinicalPatientListForScopeInFlight = (async function() {
    ...
    if (typeof document === "undefined") return;
    try {
      const mod = await import("/js/chunks/patients-SWQQ37AP.js");
...
async function consolidateIntoHost(winnerUrl, teamCode, opts) {
  opts = opts || {};
  const room = await import("/js/chunks/room-OGQ22I6C.js");
...
async function initLanHostPlugAndPlay() {
  ...
  if (!isClinicalRankConfiguredForLan()) return;
  try {
    const pinMod = await import("/js/chunks/lan-shift-pin-connect-F5U7BCCM.js");
...
function ensureLanSyncPushBridgeWired() {
  ...
  if (!pushBridgeWirePromise) {
    pushBridgeWirePromise = import("/js/chunks/orchestrator-5NDDCBKH.js").then(function() {
      if (!pushBridge && typeof globalThis !== "undefined") {
  ...
  return drainOutbox(rid).then(function(items) {
    ...
    function pushLiveSyncPatchOutbox(envelope) {
      ...
      return trySend().then(function(sent) {
        ...
        return import("/js/chunks/room-OGQ22I6C.js").then(function(mod) {
...
function finishReconcilePhase(rid, b) {
  ...
  void import("/js/chunks/room-OGQ22I6C.js").then(function(mod) {
...
function ensureLanSyncRoomBridgeWired() {
  ...
  if (!roomBridgeWirePromise) {
    roomBridgeWirePromise = import("/js/chunks/orchestrator-5NDDCBKH.js").then(function() {
      if (!roomBridge && typeof globalThis !== "undefined") {
...
function startLiveSyncReconnectLoop() {
  ...
  function tick() {
    ...
    if (_liveSyncReconnectAttempt >= 2 && !_shiftPinRediscoverInFlight && canAttemptAutoHostDetect()) {
      ...
      void import("/js/chunks/lan-shift-pin-connect-F5U7BCCM.js").then(function(mod) {
...
function bootLanRoomMembership() {
  ...
  void (async function() {
    var rid = m.roomId;
    try {
      const accessMod = await import("/js/chunks/clinical-access-runtime-YGLB7JFR.js");
...
function syncLiveSyncAfterRoomJoinBody(rid) {
  ...
  return chain.then(function() {
    ...
    void import("/js/chunks/clinical-access-runtime-YGLB7JFR.js").then(function(accessMod) {
...
//# sourceMappingURL=/js/chunks/chunk-5BRX2HEJ.js.map
