...
} from "/js/chunks/chunk-R467BHXP.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-O5OW4NJX.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-ZZKZBQ2Z.js");
  ...
  const transport = await import("/js/chunks/transport-JRIHV3WZ.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-74FTDCOU.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-H6WYJWHB.js.map
