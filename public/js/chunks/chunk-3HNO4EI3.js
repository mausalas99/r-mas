...
} from "/js/chunks/chunk-HUBJNSP2.js";
import {
  closeQuickHelp
...
function tokenScore(token, text) {
  ...
  for (var ti = 0; ti < t.length; ti++) {
    ...
    var atWordStart = prev === " " || prev === "-" || prev === "\u2014" || prev === "\xB7";
...
function rankItems(query, items, getText) {
  var out = [];
...
function ensureDom() {
  ...
  panel.setAttribute("aria-label", "Ir a secci\xF3n o paciente");
  var input = document.createElement("input");
  input.className = "cmdk-input";
  input.type = "text";
  input.placeholder = 'Ir a\u2026 secci\xF3n o paciente (ej. "tend gar")';
  input.setAttribute("aria-label", "Buscar secci\xF3n o paciente");
...
function registerClinicalQuickExportRuntime(ctx2) {
  if (!ctx2 || typeof ctx2 !== "object") return;
  Object.assign(quickExportRt, ctx2);
}
...
function registerProcedureAgendaRuntime(ctx2) {
  if (!ctx2 || typeof ctx2 !== "object") return;
  Object.assign(rt, ctx2);
}
...
function registerProductivityRuntime(ctx2) {
  if (!ctx2 || typeof ctx2 !== "object") return;
  Object.assign(rt2, ctx2);
}
function esc2(s) {
  return String(s || "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
}
...
function registerAppShellContext(ctx2) {
  if (ctx2 && typeof ctx2 === "object") Object.assign(shellCtx, ctx2);
...
//# sourceMappingURL=/js/chunks/chunk-3HNO4EI3.js.map
