import{Dh as O,Eh as P,Fh as h,Od as K,Va as r,Vd as Q,Wh as X,b as V,wd as Y}from"/js/chunks/chunk-YJEWSNFN.js";import{b as M}from"/js/chunks/chunk-KVCGO4KM.js";import{a as m,b as C,c as x,d as q,f as D,g as W,h as G,i as w,j as F,k as _,l as z,m as j,o as f,q as k,s as J,t as S}from"/js/chunks/chunk-UP7TK6FA.js";function A(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function me(e){return`<div class="clinical-onboarding-progress" aria-label="Progreso del registro">${["Modo","Perfil","Equipo"].map((t,o)=>{let i=o+1;return`<span class="${(i===e?" is-active":"").trim()}" title="${A(t)}" aria-label="${A(t)}">${i}</span>`}).join("")}</div>`}function I({title:e,leadHtml:n,bodyHtml:a,stepperIndex:t=null}){return`
...
//# sourceMappingURL=/js/chunks/chunk-YH3ONPXD.js.map
