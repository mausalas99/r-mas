...
async function handleUsernameStepSubmit(ev) {
  ...
  if (needsClaim) {
    const { assertLanRoomForUsernameRegister } = await import("./clinical-profile-lan-sync-2KFONQS2.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  } = await import("./clinical-profile-lan-sync-2KFONQS2.js");
  ...
  const { refreshMainClinicalOnboardingIfNeeded } = await import("./clinical-onboarding-main-Q4WWIVWH.js");
...
async function handleResumeIdentityClick() {
  ...
  try {
    ...
    if (!needsUsernameClaim()) {
      const { refreshMainClinicalOnboardingIfNeeded: refreshMainClinicalOnboardingIfNeeded2 } = await import("./clinical-onboarding-main-Q4WWIVWH.js");
...
async function renderOnboardingPanelInto(host) {
  ...
  if (!needsProfileOnboarding()) {
    const { hideMainClinicalOnboarding } = await import("./clinical-onboarding-main-Q4WWIVWH.js");
    hideMainClinicalOnboarding();
    if (host.closest("#clinical-teams-panel-body")) {
      const { renderClinicalTeamsPanel } = await import("./clinical-teams-IPEMV2B3.js");
...
//# sourceMappingURL=chunk-OL77AOQX.js.map
