...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-NFGTIXBW.js").then((m) => m.syncClinicalRotationEntryChrome());
  void import("/js/chunks/tour-engine-ZKALGUL6.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/js/chunks/learn-hub-KRVTITRL.js").then((m) => {
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-36KTSR24.js");
...
//# sourceMappingURL=/js/chunks/chunk-AFQQNWMQ.js.map
