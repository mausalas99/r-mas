...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-PAGHBEVP.js").then((m) => m.syncClinicalRotationEntryChrome());
  void import("/js/chunks/tour-engine-FXIEZX6Q.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/js/chunks/learn-hub-Y2DZG73U.js").then((m) => {
...
async function showMainClinicalOnboarding() {
  ...
  try {
    const { flushPendingClinicalOpsLanSnapshot } = await import("/js/chunks/clinical-ops-lan-HRKFCRKL.js");
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-VJKNXXGD.js");
...
//# sourceMappingURL=/js/chunks/chunk-IQ2O3L56.js.map
