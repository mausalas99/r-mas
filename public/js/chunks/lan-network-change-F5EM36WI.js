...
} from "/js/chunks/chunk-DGNQBM5V.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-VIZSHIDF.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-SKMBFH6T.js");
  ...
  const transport = await import("/js/chunks/transport-IJUHMPJJ.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-IMUZ6YY2.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-F5EM36WI.js.map
