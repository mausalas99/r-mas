...
} from "/js/chunks/chunk-5JTZWKGL.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const panel = await import("/js/chunks/panel-GV3B42HC.js");
  ...
  const transport = await import("/js/chunks/transport-UTZGQ5HY.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-WBPYS5HG.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-W7RWCDQT.js.map
