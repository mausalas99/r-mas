...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-QU37T7CJ.js").then((m) => m.syncClinicalRotationEntryChrome());
}
...
async function showMainClinicalOnboarding() {
  ...
  try {
    ...
    prefillRegistrationFromUrlParams();
    const rot = await import("/js/chunks/clinical-rotation-entry-QU37T7CJ.js");
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-CB7EYCJC.js");
...
//# sourceMappingURL=/js/chunks/clinical-onboarding-main-LBYJVJ6Z.js.map
