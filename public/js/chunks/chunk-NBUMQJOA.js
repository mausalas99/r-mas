...
} from "/js/chunks/chunk-NAOXCYGS.js";
import {
  settingsHelpBridge
...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/js/chunks/tour-runtime-KZG4RSTI.js").then((mod) => {
...
function wireLearnHubBodyOnce(host) {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-continue")) {
      closeLearnHub();
      void import("/js/chunks/tour-flow-ONZLRFZ7.js").then((mod) => {
    ...
    if (ev.target.closest("#learn-hub-btn-fundamentos-intro")) {
      closeLearnHub();
      void import("/js/chunks/tour-engine-DJRGNME2.js").then((mod) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/js/chunks/help-content-I36U6564.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-NBUMQJOA.js.map
