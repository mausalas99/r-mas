...
} from "/js/chunks/chunk-NRSXQX3A.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-QT54DRKC.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-ZFDRWTE6.js");
  ...
  const transport = await import("/js/chunks/transport-YOBI7WFW.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-Q4YIPJN4.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-ZK6A7YOQ.js.map
