...
} from "/js/chunks/chunk-QFVFIUOC.js";
import {
...
function mergeClinicalUsersData(localRows, incomingRows) {
  ...
  for (const row of localRows || []) {
    ...
    const handle = normalizeUsername2(row.username);
    if (handle && isValidUsernameFormat2(handle)) byUsername.set(handle, { ...row });
  }
  for (const row of incomingRows || []) {
    if (!row?.user_id) continue;
    const handle = normalizeUsername2(row.username);
    if (!handle || !isValidUsernameFormat2(handle)) continue;
...
function isClinicalOpsLanAvailable() {
  const api2 = dbApi();
  return !!(api2 && typeof api2.dbClinicalOpsExport === "function" && typeof api2.dbClinicalOpsMerge === "function");
}
...
async function collectClinicalOpsForLanSync() {
  const api2 = dbApi();
  if (!api2 || typeof api2.dbClinicalOpsExport !== "function") return null;
  const res = await api2.dbClinicalOpsExport();
...
async function applyClinicalOpsLanSnapshot(snapshot) {
  ...
  const api2 = dbApi();
  if (!api2 || typeof api2.dbClinicalOpsMerge !== "function") return { ok: false, changed: false };
  const res = await api2.dbClinicalOpsMerge({ snapshot });
...
async function ensureLiveSyncRoomForUsernameRegister(opts = {}) {
  const lan = await import("/js/chunks/lan-sync-HDZB2A4R.js");
...
async function flushClinicalProfileToLan(opts = {}) {
  const { isClinicalLocalOnlyMode: isClinicalLocalOnlyMode2 } = await import("/js/chunks/clinical-settings-HETHC6LN.js");
  ...
  const pushMod = await import("/js/chunks/push-LDRV4GO3.js");
...
async function ensureClinicalPanelSession() {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/js/chunks/db-unlock-HOET4OP7.js");
...
async function publishClinicalTeamsToLan() {
  try {
    const mod = await import("/js/chunks/lan-sync-HDZB2A4R.js");
...
Desaparecer\xE1 del directorio LAN. Las dem\xE1s R+ en la misma sala \u21C4 lo quitar\xE1n al sincronizar.`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-DZFTXSYY.js");
...
async function pullLanDirectoryFromHostBeforeDisplay() {
  try {
    const lanMod = await import("/js/chunks/lan-sync-HDZB2A4R.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { needsClinicalLanProfileGate: needsClinicalLanProfileGate2, ensureLanProfileGateDeviceReset } = await import("/js/chunks/clinical-settings-HETHC6LN.js");
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-interactions-RSGPTT4Q.js");
...
async function refreshTeamsUiAfterChange() {
  await fetchClinicalTeamsFromDb();
  import("/js/chunks/clinical-rotation-entry-N76ZO4SY.js").then((m) => m.syncClinicalRotationEntryChrome());
...
async function openClinicalTeamsPanel() {
  ...
  if (!sessionOk) {
    const mainMod = await import("/js/chunks/clinical-onboarding-main-VV7C2WMQ.js");
  ...
  try {
    const { needsClinicalOnboarding } = await import("/js/chunks/clinical-onboarding-S5QOT3ZF.js");
    if (needsClinicalOnboarding()) {
      closeClinicalTeamsPanel();
      const { openMiRotacion } = await import("/js/chunks/clinical-rotation-entry-N76ZO4SY.js");
  ...
  try {
    const { stopLanAutoDiscovery: stopLanAutoDiscovery2 } = await import("/js/chunks/panel-3JHPV53H.js");
...
function closeClinicalTeamsPanel() {
  ...
  import("/js/chunks/panel-3JHPV53H.js").then((m) => {
...
async function handleProfileFormSubmit(ev) {
  ...
  if (usernameWillChange) {
    const { assertLanRoomForUsernameRegister: assertLanRoomForUsernameRegister2 } = await import("/js/chunks/clinical-profile-lan-sync-DZFTXSYY.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, LAN_PROFILE_PUSH_FAILED_MSG: LAN_PROFILE_PUSH_FAILED_MSG2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-DZFTXSYY.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await refreshTeamsUiAfterChange();
  void import("/js/chunks/lan-sync-HDZB2A4R.js").then((mod) => {
    if (typeof mod.scheduleLiveSyncPush === "function") mod.scheduleLiveSyncPush();
  }).catch(() => {
  });
  void import("/js/chunks/patients-MBFPIRN7.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
async function joinTeamById(teamId, subAreaFraction) {
  ...
  if (filterJoinedTeams(clinicalSessionContext.teams, clinicalSessionContext.user).some(
    ...
    const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-QF7MPNG6.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await publishClinicalTeamsToLan();
  const { refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/js/chunks/teams-roster-QF7MPNG6.js");
...
async function redirectLanInviteFromTeamJoinField(raw) {
  const text = String(raw || "").trim();
  if (!text) return false;
  const { openConnectionDropdown: openConnectionDropdown2, joinLanFromInviteUi: joinLanFromInviteUi2 } = await import("/js/chunks/lan-sync-HDZB2A4R.js");
...
function loadRoster() {
  return import("/js/chunks/teams-roster-QF7MPNG6.js");
}
...
function wireClinicalTeamsControls() {
  void import("/js/chunks/teams-roster-modal-chrome-5ICXT5W3.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/js/chunks/clinical-rotation-entry-N76ZO4SY.js").then((mod) => {
  ...
  if (openBtn && !openBtn._rpcTeamsOpenWired) {
    ...
    openBtn.addEventListener("click", () => {
      void import("/js/chunks/clinical-rotation-entry-N76ZO4SY.js").then((m) => m.openMiRotacion());
    });
  }
...
async function consolidateIntoHost(winnerUrl, teamCode, opts) {
  opts = opts || {};
  const room = await import("/js/chunks/room-CSHPSTBK.js");
...
async function initLanHostPlugAndPlay() {
  ...
  try {
    const pinMod = await import("/js/chunks/lan-shift-pin-connect-XJXDTLTH.js");
...
function lanPanelNeedsFullRebuild(root) {
  ...
  if (!runtime3().isMobileWeb() && !isLanSessionConfiguredForRest() && !root.querySelector("#lan-input-invite-link")) {
    return true;
  }
  return false;
}
...
async function renderLanPanelOnce() {
  ...
  var hubStatus = lanHubStatusCopy();
  var needsInvitePaste = !runtime3().isMobileWeb() && !isLanSessionConfiguredForRest();
  ...
  if (lanPanelRenderStale(gen)) return;
  if (runtime3().isMobileWeb() && !hubStatus.connected) {
...
function appendLanShiftPinClientConnectSection(root, gen) {
  ...
  void resolveHostBearerToken().then(function(bearer) {
    ...
    btn.addEventListener("click", function() {
      ...
      if (!/^\d{6}$/.test(pin)) {
        runtime3().showToast("Ingresa los 6 d\xEDgitos del PIN.", "error");
        return;
      }
      btn.disabled = true;
      void import("/js/chunks/lan-shift-pin-connect-XJXDTLTH.js").then(function(m) {
...
async function appendLanShiftPinSection(root, gen) {
  ...
  try {
    ...
    copyBtn.addEventListener("click", function() {
      ...
      runtime3().showToast("PIN del turno copiado.", "success");
    });
    ...
    regenBtn.addEventListener("click", function() {
      void lanFetchAuthed("/api/lan/v1/auth/shift-pin/regenerate", { method: "POST" }).then(
        function(r) {
          if (r && r.ok) {
            runtime3().showToast("PIN del turno renovado.", "success");
            renderLanPanel2({ force: true });
          } else {
            runtime3().showToast("No se pudo renovar el PIN.", "error");
          }
        }
      );
    });
...
async function openR4TeamCreationModal() {
  try {
    var mod = await import("/js/chunks/clinical-teams-YCUK4D3W.js");
...
async function saveLanSettingsFromUi(opts) {
  ...
  if (pingOk) {
    ...
    void import("/js/chunks/historia-clinica-lan-sync-XHHXAW45.js").then(function(m) {
...
function renderPatientListLanSilent() {
  runtime4.renderPatientList({ silent: true });
}
var runtime4 = {
  showToast() {
  },
...
async function applyConflictUseServer(payload) {
  ...
  if (server && server.data) {
    if (payload.entityType === "historiaClinica" && payload.patientId) {
      ...
      if (hcRow) {
        var mod = await import("/js/chunks/historia-clinica-lan-sync-XHHXAW45.js");
...
function applyLiveSyncMerged(merged) {
  ...
  if (todosChanged) runtime4.refreshAllTodoUIs();
  if (patientsChanged && runtime4.getActiveId()) {
    try {
      runtime4.renderNoteForm();
    } catch (_eNote) {
    }
...
async function applyLiveSyncDeltaApplied(msg) {
  ...
  if (partial) {
    ...
    runtime4.showToast('Tu cambio en "' + labels.join(", ") + '" fue reemplazado por una edici\xF3n m\xE1s reciente en la sala.', "warn");
  }
  syncHostBundleEntityFromApplied(msg);
}
...
async function applyBootstrapResult(res) {
  ...
  if (typeof document !== "undefined") {
    void import("/js/chunks/clinical-profile-lan-sync-DZFTXSYY.js").then((mod) => mod.flushClinicalProfileToLan()).catch(() => {
    });
  }
...
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/js/chunks/patients-MBFPIRN7.js").then((mod) => mod.renderPatientList({ silent: true })).catch(() => {
      });
    }
  }
  return migrated;
...
async function refreshClinicalUserProfile() {
  const { ensureLanProfileGateDeviceReset } = await import("/js/chunks/clinical-settings-HETHC6LN.js");
...
function ensureLanSyncPushBridgeWired() {
  ...
  if (!pushBridgeWirePromise) {
    pushBridgeWirePromise = import("/js/chunks/orchestrator-KVLVFCAV.js").then(function() {
      if (!pushBridge && typeof globalThis !== "undefined") {
  ...
  return drainOutbox(rid).then(function(items) {
    ...
    function pushLiveSyncPatchOutbox(envelope) {
      ...
      return trySend().then(function(sent) {
        ...
        return import("/js/chunks/room-CSHPSTBK.js").then(function(mod) {
...
function finishReconcilePhase(rid, b) {
  ...
  void import("/js/chunks/room-CSHPSTBK.js").then(function(mod) {
...
function ensureLanSyncRoomBridgeWired() {
  ...
  if (!roomBridgeWirePromise) {
    roomBridgeWirePromise = import("/js/chunks/orchestrator-KVLVFCAV.js").then(function() {
      if (!roomBridge && typeof globalThis !== "undefined") {
...
function startLiveSyncReconnectLoop() {
  ...
  function tick() {
    ...
    if (_liveSyncReconnectAttempt >= 2 && !_shiftPinRediscoverInFlight) {
      ...
      void import("/js/chunks/lan-shift-pin-connect-XJXDTLTH.js").then(function(mod) {
...
//# sourceMappingURL=/js/chunks/chunk-KTHNH3AM.js.map
