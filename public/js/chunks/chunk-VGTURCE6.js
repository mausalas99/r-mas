...
function readEntregaPhaseActive(storage2 = globalThis.localStorage) {
  try {
    const raw = storage2?.getItem(ENTREGA_PHASE_LS_KEY);
    if (!raw) return false;
...
//# sourceMappingURL=/js/chunks/chunk-VGTURCE6.js.map
