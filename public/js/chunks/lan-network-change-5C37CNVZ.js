...
} from "/js/chunks/chunk-TNNT64GE.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-ZR4IZ5FQ.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-Z7UKR4H3.js");
  ...
  const transport = await import("/js/chunks/transport-2OAAJWOX.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-PB3PWCYA.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-5C37CNVZ.js.map
