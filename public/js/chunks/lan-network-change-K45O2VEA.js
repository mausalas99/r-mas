...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const panel = await import("/js/chunks/panel-D42ZCYTB.js");
  ...
  const transport = await import("/js/chunks/transport-YCCUPALV.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-TRVOZWZF.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-K45O2VEA.js.map
