...
} from "/js/chunks/chunk-LHN3OQE7.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-KRMTTBJA.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-7HAF4TBL.js");
  ...
  const transport = await import("/js/chunks/transport-HXVUHD6D.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-BVHYOHEM.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-XDYXPFAL.js.map
