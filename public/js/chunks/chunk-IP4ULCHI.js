...
async function openMiRotacion() {
  ...
  if (needsClinicalOnboarding()) {
    const mainMod = await import("./clinical-onboarding-main-G6AMUHOI.js");
    if (!mainMod.focusMainClinicalOnboarding()) await mainMod.showMainClinicalOnboarding();
    return;
  }
  const { openClinicalTeamsPanel } = await import("./clinical-teams-37G4N2SV.js");
...
//# sourceMappingURL=chunk-IP4ULCHI.js.map
