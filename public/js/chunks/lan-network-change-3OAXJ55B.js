...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const panel = await import("/js/chunks/panel-XXIH5MIP.js");
  ...
  const transport = await import("/js/chunks/transport-KRMQUKCS.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-M4SSBWG4.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-3OAXJ55B.js.map
