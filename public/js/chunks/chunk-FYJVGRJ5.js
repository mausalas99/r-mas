...
async function openMiRotacion() {
  ...
  if (needsClinicalOnboarding()) {
    const mainMod = await import("./clinical-onboarding-main-Q4WWIVWH.js");
    if (!mainMod.focusMainClinicalOnboarding()) await mainMod.showMainClinicalOnboarding();
    return;
  }
  const { openClinicalTeamsPanel } = await import("./clinical-teams-IPEMV2B3.js");
...
//# sourceMappingURL=chunk-FYJVGRJ5.js.map
