...
async function enableClinicalLanFromSettings() {
  ...
  try {
    const { closeSettingsDropdown, syncTeamSyncHeaderButton } = await import("/js/chunks/settings-dropdown-IC65QO5I.js");
    closeSettingsDropdown();
    syncTeamSyncHeaderButton();
  } catch (_e) {
  }
  try {
    const main = await import("/js/chunks/clinical-onboarding-main-M6XLNQK2.js");
...
//# sourceMappingURL=/js/chunks/chunk-ZEYZNFZF.js.map
