...
async function enableClinicalLanFromSettings() {
  ...
  try {
    const { closeSettingsDropdown, syncTeamSyncHeaderButton } = await import("/js/chunks/settings-dropdown-2QJ5JBT3.js");
    closeSettingsDropdown();
    syncTeamSyncHeaderButton();
  } catch (_e) {
  }
  try {
    const main = await import("/js/chunks/clinical-onboarding-main-R6COIHXU.js");
...
//# sourceMappingURL=/js/chunks/chunk-V6BOYJ6M.js.map
