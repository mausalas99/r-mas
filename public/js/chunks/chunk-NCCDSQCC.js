...
async function openMiRotacion() {
  ...
  if (needsClinicalOnboarding()) {
    const mainMod = await import("./clinical-onboarding-main-FGCA5HTW.js");
    if (!mainMod.focusMainClinicalOnboarding()) await mainMod.showMainClinicalOnboarding();
    return;
  }
  const { openClinicalTeamsPanel } = await import("./clinical-teams-P76M4LPY.js");
...
//# sourceMappingURL=chunk-NCCDSQCC.js.map
