...
async function openMiRotacion() {
  ...
  if (needsClinicalOnboarding()) {
    const mainMod = await import("./clinical-onboarding-main-U6VVNAB5.js");
    if (!mainMod.focusMainClinicalOnboarding()) await mainMod.showMainClinicalOnboarding();
    return;
  }
  const { openClinicalTeamsPanel } = await import("./clinical-teams-C7U4OBQQ.js");
...
//# sourceMappingURL=chunk-MN3CHURH.js.map
