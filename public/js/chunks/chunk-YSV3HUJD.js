...
async function openMiRotacion() {
  ...
  if (needsClinicalOnboarding()) {
    const mainMod = await import("./clinical-onboarding-main-LNSHJIGJ.js");
    if (!mainMod.focusMainClinicalOnboarding()) await mainMod.showMainClinicalOnboarding();
    return;
  }
  const { openClinicalTeamsPanel } = await import("./clinical-teams-6O3S6HYA.js");
...
//# sourceMappingURL=chunk-YSV3HUJD.js.map
