...
} from "/js/chunks/chunk-6PJW64ZF.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-M7C67HSW.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-JZAYSSKV.js");
  ...
  const transport = await import("/js/chunks/transport-LQ4BLFC5.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-QILK4VUV.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-F7UMV3G3.js.map
