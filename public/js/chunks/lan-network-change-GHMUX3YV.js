...
} from "/js/chunks/chunk-474F5VYY.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-4YJ3IZGM.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-3Y4UKQ5G.js");
  ...
  const transport = await import("/js/chunks/transport-6MEKC6RP.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-CKKXSHIJ.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-GHMUX3YV.js.map
