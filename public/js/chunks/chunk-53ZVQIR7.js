...
} from "/js/chunks/chunk-2FBYCGA3.js";
import {
  fundamentosModuleCount,
  isFundamentosChapterId,
  loadFundamentosProgress
} from "/js/chunks/chunk-CJ6T2DXH.js";
import {
  isNeoCompanionStepComplete
} from "/js/chunks/chunk-WOVXK7VJ.js";
import {
  loadTourProgress
} from "/js/chunks/chunk-ZN2W2FIJ.js";
import {
...
} from "/js/chunks/chunk-C23OXAIC.js";
import {
  GUARDIA_V7_CHAPTERS,
...
} from "/js/chunks/chunk-POM2RBQV.js";
import {
  isMobileWeb
...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/js/chunks/tour-runtime-CDVMJ6MS.js").then((mod) => {
...
function wireLearnHubBodyOnce(host) {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-continue")) {
      closeLearnHub();
      void import("/js/chunks/tour-flow-POOEE46M.js").then((mod) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/js/chunks/help-content-TQ5YY2SS.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-53ZVQIR7.js.map
