...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-SUWIUHFA.js").then((m) => m.syncClinicalRotationEntryChrome());
  void import("/js/chunks/tour-engine-4YYHIXQN.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/js/chunks/learn-hub-OK7TTPQS.js").then((m) => {
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-RYSKIC33.js");
...
//# sourceMappingURL=/js/chunks/chunk-UPFOQE2C.js.map
