...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-6PA356OJ.js").then((m) => m.syncClinicalRotationEntryChrome());
  void import("/js/chunks/tour-engine-WUDW4KWA.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/js/chunks/learn-hub-KSFEZJCR.js").then((m) => {
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-B4GGJFNH.js");
...
//# sourceMappingURL=/js/chunks/chunk-MQC23P6N.js.map
