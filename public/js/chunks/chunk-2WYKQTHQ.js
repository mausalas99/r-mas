...
async function enableClinicalLanFromSettings() {
  ...
  try {
    const { closeSettingsDropdown, syncTeamSyncHeaderButton } = await import("/js/chunks/settings-dropdown-IOHNCUST.js");
    closeSettingsDropdown();
    syncTeamSyncHeaderButton();
  } catch (_e) {
  }
  try {
    const main = await import("/js/chunks/clinical-onboarding-main-ARUISWUU.js");
...
//# sourceMappingURL=/js/chunks/chunk-2WYKQTHQ.js.map
