...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/js/chunks/tour-runtime-C75IKFUI.js").then((mod) => {
...
function wireLearnHubBodyOnce(host) {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-continue")) {
      closeLearnHub();
      void import("/js/chunks/tour-flow-ML7B33W6.js").then((mod) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/js/chunks/help-content-X4SVFS4W.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-PKQ6C3MV.js.map
