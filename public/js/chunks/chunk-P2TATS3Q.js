...
async function discoverLanHostsOnSubnetViaBeacon(ownBaseUrl) {
...
var GUARDIA_MODE_LABEL_OFF = "Censo completo";
var GUARDIA_MODE_LABEL_ON = "Solo mis entregas";
var GUARDIA_MODE_TOGGLE_TITLE = "Filtra el censo: todos los pacientes de tu alcance o solo tus entregas recibidas.";
...
async function ensureLiveSyncRoomForUsernameRegister(opts = {}) {
  const lan = await import("/js/chunks/lan-sync-ZCN7OBCC.js");
...
async function flushClinicalProfileToLan(opts = {}) {
  ...
  const pushMod = await import("/js/chunks/push-QYQ3QJBJ.js");
...
async function ensureClinicalPanelSession() {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/js/chunks/db-unlock-UEI6ZS5M.js");
...
async function publishClinicalTeamsToLan() {
  try {
    const mod = await import("/js/chunks/lan-sync-ZCN7OBCC.js");
...
Desaparecer\xE1 del directorio LAN. Las dem\xE1s R+ en la misma sala \u21C4 lo quitar\xE1n al sincronizar.`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-HEGREZOF.js");
...
async function pullLanDirectoryFromHostBeforeDisplay() {
  try {
    const lanMod = await import("/js/chunks/lan-sync-ZCN7OBCC.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-interactions-AFTDJFX6.js");
...
async function refreshTeamsUiAfterChange() {
  await fetchClinicalTeamsFromDb();
  import("/js/chunks/clinical-rotation-entry-MQKB74ZZ.js").then((m) => m.syncClinicalRotationEntryChrome());
...
async function openClinicalTeamsPanel() {
  ...
  if (!sessionOk) {
    const mainMod = await import("/js/chunks/clinical-onboarding-main-BC3QP7TI.js");
  ...
  try {
    const { needsClinicalOnboarding } = await import("/js/chunks/clinical-onboarding-DGUBRMF3.js");
    if (needsClinicalOnboarding()) {
      closeClinicalTeamsPanel();
      const { openMiRotacion } = await import("/js/chunks/clinical-rotation-entry-MQKB74ZZ.js");
  ...
  try {
    const { stopLanAutoDiscovery: stopLanAutoDiscovery2 } = await import("/js/chunks/panel-2HDWCEHP.js");
...
function closeClinicalTeamsPanel() {
  ...
  import("/js/chunks/panel-2HDWCEHP.js").then((m) => {
...
async function handleProfileFormSubmit(ev) {
  ...
  if (usernameWillChange) {
    const { assertLanRoomForUsernameRegister: assertLanRoomForUsernameRegister2 } = await import("/js/chunks/clinical-profile-lan-sync-HEGREZOF.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, LAN_PROFILE_PUSH_FAILED_MSG: LAN_PROFILE_PUSH_FAILED_MSG2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-HEGREZOF.js");
  ...
  syncRotationConfigButton();
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  void import("/js/chunks/lan-sync-ZCN7OBCC.js").then((mod) => {
    if (typeof mod.scheduleLiveSyncPush === "function") mod.scheduleLiveSyncPush();
  }).catch(() => {
  });
  void import("/js/chunks/patients-PSUK37PP.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
async function joinTeamById(teamId, subAreaFraction) {
  ...
  if (filterJoinedTeams(clinicalSessionContext.teams, clinicalSessionContext.user).some(
    ...
    const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-D7KKA5TS.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await publishClinicalTeamsToLan();
  const { refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/js/chunks/teams-roster-D7KKA5TS.js");
...
async function redirectLanInviteFromTeamJoinField(raw) {
  const text = String(raw || "").trim();
  if (!text) return false;
  const { openConnectionDropdown: openConnectionDropdown2, joinLanFromInviteUi: joinLanFromInviteUi2 } = await import("/js/chunks/lan-sync-ZCN7OBCC.js");
...
function loadRoster() {
  return import("/js/chunks/teams-roster-D7KKA5TS.js");
}
...
function wireClinicalTeamsControls() {
  void import("/js/chunks/teams-roster-modal-chrome-RSPLFN5L.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/js/chunks/clinical-rotation-entry-MQKB74ZZ.js").then((mod) => {
...
async function appendLanShiftPinSection(root, gen) {
  ...
  try {
    ...
    lead.textContent = "Comparte este PIN al registrar @usuario (Configura tu rotaci\xF3n). V\xE1lido hasta fin de mes.";
...
async function openR4TeamCreationModal() {
  try {
    var mod = await import("/js/chunks/clinical-teams-WMU6MOPN.js");
...
function lanHubStatusCopy() {
  if (!lanClient.connected) {
    ...
    return {
      connected: false,
      line: "Sin red \u2014 buscando anfitri\xF3n en la Wi\u2011Fi del hospital\u2026",
      hint: "Si otra Mac ya es anfitri\xF3n, pide su enlace (\u21C4 \u2192 Copiar enlace de sala) o p\xE9galo abajo."
    };
  }
  if (isLanRemoteJoinMode()) {
...
async function saveLanSettingsFromUi(opts) {
  ...
  if (pingOk) {
    ...
    void import("/js/chunks/historia-clinica-lan-sync-D7QNUFAZ.js").then(function(m) {
...
async function applyConflictUseServer(payload) {
  ...
  if (server && server.data) {
    if (payload.entityType === "historiaClinica" && payload.patientId) {
      ...
      if (hcRow) {
        var mod = await import("/js/chunks/historia-clinica-lan-sync-D7QNUFAZ.js");
...
async function applyBootstrapResult(res) {
  ...
  if (typeof document !== "undefined") {
    void import("/js/chunks/clinical-profile-lan-sync-HEGREZOF.js").then((mod) => mod.flushClinicalProfileToLan()).catch(() => {
    });
  }
  migrateLocalPatientsClinicalSala();
}
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/js/chunks/patients-PSUK37PP.js").then((mod) => mod.renderPatientList()).catch(() => {
      });
    }
  }
  return migrated;
...
function ensureLanSyncPushBridgeWired() {
  ...
  if (!pushBridgeWirePromise) {
    pushBridgeWirePromise = import("/js/chunks/orchestrator-BBYCAB6U.js").then(function() {
      if (!pushBridge && typeof globalThis !== "undefined") {
  ...
  return drainOutbox(rid).then(function(items) {
    ...
    function pushLiveSyncPatchOutbox(envelope) {
      ...
      return trySend().then(function(sent) {
        ...
        return import("/js/chunks/room-W5BB6CPO.js").then(function(mod) {
...
function finishReconcilePhase(rid, b) {
  ...
  void import("/js/chunks/room-W5BB6CPO.js").then(function(mod) {
...
function ensureLanSyncRoomBridgeWired() {
  ...
  if (!roomBridgeWirePromise) {
    roomBridgeWirePromise = import("/js/chunks/orchestrator-BBYCAB6U.js").then(function() {
      if (!roomBridge && typeof globalThis !== "undefined") {
...
//# sourceMappingURL=/js/chunks/chunk-P2TATS3Q.js.map
