...
} from "/js/chunks/chunk-GT6NZJ64.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-U6IREUAL.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-MJMD46LP.js");
  ...
  const transport = await import("/js/chunks/transport-E2KKJNRP.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-3YAVYDD2.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-3OIGIJ3O.js.map
