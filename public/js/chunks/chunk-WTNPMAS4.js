import {
  ...
  needsTeamOnboarding
} from "/js/chunks/chunk-67BJJSBU.js";
import {
...
async function openLanConnectPanel() {
  try {
    const { openConnectionDropdown } = await import("/js/chunks/lan-sync-ZCN7OBCC.js");
...
function syncLanConnectCta(show) {
  ...
  if (!btn) {
    ...
    btn.textContent = "Con\xE9ctate a la sala";
    btn.title = "Pega el enlace de invitaci\xF3n o escanea el anfitri\xF3n para aparecer en la guardia";
...
async function openMiRotacion() {
  ...
  const { ensureClinicalPanelSession } = await import("/js/chunks/clinical-panel-host-H2RI5H3K.js");
  ...
  const { wireClinicalTeamsModalChrome } = await import("/js/chunks/teams-roster-modal-chrome-RSPLFN5L.js");
  wireClinicalTeamsModalChrome();
  const { openClinicalTeamsPanel } = await import("/js/chunks/teams-roster-D7KKA5TS.js");
...
//# sourceMappingURL=/js/chunks/chunk-WTNPMAS4.js.map
