...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-4CCHSS2H.js").then((m) => m.syncClinicalRotationEntryChrome());
}
...
async function showMainClinicalOnboarding() {
  ...
  try {
    ...
    prefillRegistrationFromUrlParams();
    const rot = await import("/js/chunks/clinical-rotation-entry-4CCHSS2H.js");
...
//# sourceMappingURL=/js/chunks/clinical-onboarding-main-VSNJIPFL.js.map
