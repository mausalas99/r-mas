...
} from "/js/chunks/chunk-PBCVTB75.js";
import {
  fundamentosModuleCount,
  isFundamentosChapterId,
  loadFundamentosProgress
} from "/js/chunks/chunk-GDISREMV.js";
import {
  isNeoCompanionStepComplete
} from "/js/chunks/chunk-4NCUFN7B.js";
import {
  loadTourProgress
} from "/js/chunks/chunk-3YMZD64L.js";
import {
  needsClinicalOnboarding
} from "/js/chunks/chunk-YFODTUDN.js";
import {
  settingsHelpBridge
...
} from "/js/chunks/chunk-CROJ7P5B.js";
import {
  isMobileWeb
} from "/js/chunks/chunk-P2YWPNVB.js";
...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/js/chunks/tour-runtime-NB2PTCQO.js").then((mod) => {
...
function renderLearnHubBody(focusTrack = "guardia-v7") {
  ...
  parts.push('<div class="learn-hub-track-body">');
  parts.push(
    '<p class="learn-hub-fundamentos-lead">Tutorial completo Sala o Interconsulta (~15 min, DEMO P\xC9REZ).</p>'
  );
  parts.push('<div class="learn-hub-module-list">');
  parts.push(
    '<div class="learn-hub-module-card learn-hub-module-card--cta"><button type="button" class="learn-hub-module-hit learn-hub-module-hit--cta" id="learn-hub-btn-fundamentos-intro"><span class="learn-hub-module-index learn-hub-module-index--cta" aria-hidden="true">\u2605</span><span class="learn-hub-module-main"><span class="learn-hub-module-title">Tutorial completo \xB7 Sala o Interconsulta</span><span class="learn-hub-module-meta">~15 min \xB7 DEMO P\xC9REZ</span></span><span class="learn-hub-module-chevron" aria-hidden="true">\u203A</span></button></div>'
  );
...
function wireLearnHubBodyOnce(host) {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-continue")) {
      closeLearnHub();
      void import("/js/chunks/tour-flow-7FMCJRML.js").then((mod) => {
    ...
    if (ev.target.closest("#learn-hub-btn-fundamentos-intro")) {
      closeLearnHub();
      void import("/js/chunks/tour-engine-B2AZL2QY.js").then((mod) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/js/chunks/help-content-WFVV3YTW.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-Z52HWBLD.js.map
