...
} from "/js/chunks/chunk-QGNVT676.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-4CZ6VZGQ.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-O2M3KYGB.js");
  ...
  const transport = await import("/js/chunks/transport-OYSPW364.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-MNQWBJHQ.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-4MT55BDU.js.map
