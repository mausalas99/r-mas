...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/js/chunks/tour-runtime-W5P7F66X.js").then((mod) => {
...
function wireLearnHubBodyOnce(host) {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-continue")) {
      closeLearnHub();
      void import("/js/chunks/tour-flow-PLE3QJOI.js").then((mod) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/js/chunks/help-content-XJA3Q6YV.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-YMSNCPLZ.js.map
