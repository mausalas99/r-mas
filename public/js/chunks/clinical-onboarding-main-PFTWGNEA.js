...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-RR57DVPP.js").then((m) => m.syncClinicalRotationEntryChrome());
}
...
async function showMainClinicalOnboarding() {
  ...
  try {
    ...
    prefillRegistrationFromUrlParams();
    const rot = await import("/js/chunks/clinical-rotation-entry-RR57DVPP.js");
...
//# sourceMappingURL=/js/chunks/clinical-onboarding-main-PFTWGNEA.js.map
