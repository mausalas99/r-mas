...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/js/chunks/clinical-rotation-entry-MQKB74ZZ.js").then((m) => m.syncClinicalRotationEntryChrome());
}
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/js/chunks/settings-dropdown-S7R7DLZS.js");
...
//# sourceMappingURL=/js/chunks/clinical-onboarding-main-BC3QP7TI.js.map
