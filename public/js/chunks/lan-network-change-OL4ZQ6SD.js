...
} from "/js/chunks/chunk-OXLT6UFL.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-IMTYAMQ7.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-DQQQA7FJ.js");
  ...
  const transport = await import("/js/chunks/transport-S5TIRI36.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-Y4D5FDN3.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-OL4ZQ6SD.js.map
