...
} from "/js/chunks/chunk-26VLU5E6.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-QHR3LZTE.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-CJFKYW5V.js");
  ...
  const transport = await import("/js/chunks/transport-NAXDHBQZ.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-33PXDCN6.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-3IWQMKTG.js.map
