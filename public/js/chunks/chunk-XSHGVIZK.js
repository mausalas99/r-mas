...
async function ensureLiveSyncRoomForUsernameRegister(opts = {}) {
  const lan = await import("./lan-sync-EQGXHHSF.js");
...
async function applyClinicalDbUnlockCompletion() {
  ...
  try {
    ...
    var runtime6 = await import("./clinical-access-runtime-OP7JGM25.js");
  ...
  try {
    var onboardingMain = await import("./clinical-onboarding-main-Q4WWIVWH.js");
...
async function publishClinicalTeamsToLan() {
  try {
    const mod = await import("./lan-sync-EQGXHHSF.js");
...
Desaparecer\xE1 del directorio LAN. Las dem\xE1s R+ en la misma sala \u21C4 lo quitar\xE1n al sincronizar.`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("./clinical-profile-lan-sync-2KFONQS2.js");
...
function backgroundRefreshLanUsersDirectory() {
  void import("./lan-sync-EQGXHHSF.js").then((lanMod) => {
...
async function refreshTeamsUiAfterChange() {
  await fetchClinicalTeamsFromDb();
  import("./clinical-rotation-entry-BLYRKN4I.js").then((m) => m.syncClinicalRotationEntryChrome());
...
async function openClinicalTeamsPanel() {
  ...
  try {
    const { needsClinicalOnboarding } = await import("./clinical-onboarding-FZG5VJDR.js");
    if (needsClinicalOnboarding()) {
      closeClinicalTeamsPanel();
      const { openMiRotacion } = await import("./clinical-rotation-entry-BLYRKN4I.js");
...
async function handleProfileFormSubmit(ev) {
  ...
  if (usernameWillChange) {
    const { assertLanRoomForUsernameRegister: assertLanRoomForUsernameRegister2 } = await import("./clinical-profile-lan-sync-2KFONQS2.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, LAN_PROFILE_PUSH_FAILED_MSG: LAN_PROFILE_PUSH_FAILED_MSG2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("./clinical-profile-lan-sync-2KFONQS2.js");
  const lanPush = await flushClinicalProfileToLan2();
  if (!lanPush.ok && !isBenignLanPushSkipCode2(lanPush.code)) {
  ...
  syncRotationConfigButton();
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  void import("./lan-sync-EQGXHHSF.js").then((mod) => {
    if (typeof mod.scheduleLiveSyncPush === "function") mod.scheduleLiveSyncPush();
  }).catch(() => {
  });
  void import("./patients-MTBICMB3.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
async function joinTeamById(teamId, subAreaFraction) {
  ...
  if (filterJoinedTeams(clinicalSessionContext.teams, clinicalSessionContext.user).some(
    ...
    const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("./teams-roster-2ZM6HGCL.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await publishClinicalTeamsToLan();
  const { refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("./teams-roster-2ZM6HGCL.js");
...
function wireClinicalTeamsControls() {
  ...
  import("./clinical-rotation-entry-BLYRKN4I.js").then((mod) => {
...
function wireClinicalOpsLanSyncEvents() {
  ...
  if (!document._rpcClinicalTeamsChangedLanWired) {
    ...
    document.addEventListener("rpc-clinical-teams-changed", function() {
      void import("./push-OWN5HIF3.js").then(function(m) {
...
async function openR4TeamCreationModal() {
  try {
    var mod = await import("./clinical-teams-IPEMV2B3.js");
...
async function saveLanSettingsFromUi(opts) {
  ...
  if (pingOk) {
    ...
    void import("./historia-clinica-lan-sync-ERYM4NKQ.js").then(function(m) {
...
function sendLiveSyncMutation(mutation) {
  ...
  void import("./room-Z3PUOH2Y.js").then(function(mod) {
...
async function applyConflictUseServer(payload) {
  ...
  if (server && server.data) {
    if (payload.entityType === "historiaClinica" && payload.patientId) {
      ...
      if (hcRow) {
        var mod = await import("./historia-clinica-lan-sync-ERYM4NKQ.js");
...
async function applyBootstrapResult(res) {
  ...
  if (typeof document !== "undefined") {
    void import("./clinical-profile-lan-sync-2KFONQS2.js").then((mod) => mod.flushClinicalProfileToLan()).catch(() => {
    });
  }
  migrateLocalPatientsClinicalSala();
}
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("./patients-MTBICMB3.js").then((mod) => mod.renderPatientList()).catch(() => {
      });
    }
  }
  return migrated;
  ...
  return drainOutbox(rid).then(function(items) {
    ...
    function pushLiveSyncPatchOutbox(envelope) {
      ...
      return trySend().then(function(sent) {
        ...
        return import("./room-Z3PUOH2Y.js").then(function(mod) {
...
//# sourceMappingURL=chunk-XSHGVIZK.js.map
