...
} from "/js/chunks/chunk-IGTF6APZ.js";
import {
...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/js/chunks/entrega-roster-panel-CBIATHYI.js").then(({ deactivateTurnoActivo: deactivateTurnoActivo2, closeEntregaRosterPanel: closeEntregaRosterPanel2 }) => {
      deactivateTurnoActivo2();
      closeEntregaRosterPanel2();
    });
    void import("/js/chunks/guardia-phase-bar-SSFSSXHG.js").then(({ teardownGuardiaPhaseBar: teardownGuardiaPhaseBar2 }) => {
...
async function ensureClinicalPanelSession() {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/js/chunks/db-unlock-OOSFBODG.js");
...
async function publishClinicalTeamsToLan() {
  try {
    const mod = await import("/js/chunks/lan-sync-OAPA3BOK.js");
...
async function pullClinicalOpsFromLanRoom(options = {}) {
  ...
  lanClinicalOpsPullInFlight = (async () => {
    try {
      const lan = await import("/js/chunks/lan-sync-OAPA3BOK.js");
...
Desaparecer\xE1 del directorio LAN. Las dem\xE1s R+ en la misma sala \u21C4 lo quitar\xE1n al sincronizar.`
  ...
  const { isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-UFU7GJY3.js");
...
async function pullLanDirectoryFromHostBeforeDisplay() {
  try {
    const lanMod = await import("/js/chunks/lan-sync-OAPA3BOK.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-interactions-ED2GOCJ6.js");
...
async function refreshTeamsUiAfterChange() {
  const { refreshClinicalPatientListForScope: refreshClinicalPatientListForScope2 } = await import("/js/chunks/clinical-access-runtime-F33AZW5C.js");
  await refreshClinicalPatientListForScope2();
  import("/js/chunks/clinical-rotation-entry-TNO55QPG.js").then((m) => m.syncClinicalRotationEntryChrome());
...
async function openClinicalTeamsPanel(opts = {}) {
  ...
  if (!sessionOk) {
    const mainMod = await import("/js/chunks/clinical-onboarding-main-HGOKWVF5.js");
  ...
  try {
    if (!opts.skipProfileGate) {
      const { needsClinicalOnboarding } = await import("/js/chunks/clinical-onboarding-COYVZSON.js");
      if (needsClinicalOnboarding()) {
        closeClinicalTeamsPanel();
        const { openMiRotacion } = await import("/js/chunks/clinical-rotation-entry-TNO55QPG.js");
  ...
  try {
    const { stopLanAutoDiscovery: stopLanAutoDiscovery2 } = await import("/js/chunks/panel-3ZEFGMIX.js");
...
function closeClinicalTeamsPanel() {
  ...
  import("/js/chunks/panel-3ZEFGMIX.js").then((m) => {
...
async function handleProfileFormSubmit(ev) {
  ...
  if (usernameWillChange) {
    const { assertLanRoomForUsernameRegister: assertLanRoomForUsernameRegister2 } = await import("/js/chunks/clinical-profile-lan-sync-UFU7GJY3.js");
...
\xBFRecuperar tu cuenta en este dispositivo?`
  ...
  const { flushClinicalProfileToLan: flushClinicalProfileToLan2, LAN_PROFILE_PUSH_FAILED_MSG: LAN_PROFILE_PUSH_FAILED_MSG2, isBenignLanPushSkipCode: isBenignLanPushSkipCode2 } = await import("/js/chunks/clinical-profile-lan-sync-UFU7GJY3.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await refreshTeamsUiAfterChange();
  void import("/js/chunks/lan-sync-OAPA3BOK.js").then((mod) => {
    if (typeof mod.scheduleLiveSyncPush === "function") mod.scheduleLiveSyncPush();
  }).catch(() => {
  });
  void import("/js/chunks/patients-56ILPBCB.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
async function joinTeamById(teamId, subAreaFraction) {
  ...
  if (filterJoinedTeams(clinicalSessionContext.teams, clinicalSessionContext.user).some(
    ...
    const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/js/chunks/teams-roster-HWXFJLLA.js");
  ...
  document.dispatchEvent(new CustomEvent("rpc-clinical-teams-changed"));
  await publishClinicalTeamsToLan();
  const { refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/js/chunks/teams-roster-HWXFJLLA.js");
...
async function redirectLanInviteFromTeamJoinField(raw) {
  const text = String(raw || "").trim();
  if (!text) return false;
  const { openConnectionDropdown: openConnectionDropdown2, joinLanFromInviteUi: joinLanFromInviteUi2 } = await import("/js/chunks/lan-sync-OAPA3BOK.js");
...
function loadRoster() {
  return import("/js/chunks/teams-roster-HWXFJLLA.js");
}
...
function wireClinicalTeamsControls() {
  void import("/js/chunks/teams-roster-modal-chrome-FZ4XVH4M.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/js/chunks/clinical-rotation-entry-TNO55QPG.js").then((mod) => {
...
function ensureLanSyncPushBridgeWired() {
  ...
  if (!pushBridgeWirePromise) {
    pushBridgeWirePromise = import("/js/chunks/orchestrator-Q5A47OIE.js").then(function() {
      if (!pushBridge && typeof globalThis !== "undefined") {
  ...
  return drainOutbox(rid).then(function(items) {
    ...
    function pushLiveSyncPatchOutbox(envelope) {
      ...
      return trySend().then(function(sent) {
        ...
        return import("/js/chunks/room-S7JOR2AN.js").then(function(mod) {
...
function finishReconcilePhase(rid, b) {
  ...
  void import("/js/chunks/room-S7JOR2AN.js").then(function(mod) {
...
async function consolidateIntoHost(winnerUrl, teamCode, opts) {
  opts = opts || {};
  const room = await import("/js/chunks/room-S7JOR2AN.js");
...
async function initLanHostPlugAndPlay() {
  ...
  try {
    const pinMod = await import("/js/chunks/lan-shift-pin-connect-5PFKCDE4.js");
...
function ensureLanSyncRoomBridgeWired() {
  ...
  if (!roomBridgeWirePromise) {
    roomBridgeWirePromise = import("/js/chunks/orchestrator-Q5A47OIE.js").then(function() {
      if (!roomBridge && typeof globalThis !== "undefined") {
...
function applyRoomSyncPhaseAfterReconcile(roomId) {
  ...
  if (lanClient.liveConnected && (liveRid === rid || !liveRid)) {
    ...
    void import("/js/chunks/lan-shift-pin-connect-5PFKCDE4.js").then(function(m) {
...
function startLiveSyncReconnectLoop() {
  ...
  function tick() {
    ...
    if (_liveSyncReconnectAttempt >= 2 && !_shiftPinRediscoverInFlight) {
      ...
      void import("/js/chunks/lan-shift-pin-connect-5PFKCDE4.js").then(function(mod) {
...
function bootLanRoomMembership() {
  ...
  void (async function() {
    var rid = m.roomId;
    try {
      const accessMod = await import("/js/chunks/clinical-access-runtime-F33AZW5C.js");
...
function syncLiveSyncAfterRoomJoinBody(rid) {
  ...
  return chain.then(function() {
    ...
    void import("/js/chunks/clinical-access-runtime-F33AZW5C.js").then(function(accessMod) {
    ...
    void import("/js/chunks/historia-clinica-lan-sync-UWVN7WP3.js").then(function(m) {
...
async function openR4TeamCreationModal() {
  try {
    var mod = await import("/js/chunks/clinical-teams-QWHJMA3X.js");
...
async function applyConflictUseServer(payload) {
  ...
  if (server && server.data) {
    if (payload.entityType === "historiaClinica" && payload.patientId) {
      ...
      if (hcRow) {
        var mod = await import("/js/chunks/historia-clinica-lan-sync-UWVN7WP3.js");
...
function openEntregaRosterPanel(settings) {
  ...
  document.getElementById("roster-btn-cancel")?.addEventListener("click", () => {
    void (async () => {
      ...
      const { endEntregaPhase: endEntregaPhase2 } = await import("/js/chunks/clinical-entrega-U7WPUI24.js");
      endEntregaPhase2();
...
async function applyBootstrapResult(res) {
  ...
  await fetchClinicalScopeContextFromDb();
  if (typeof document !== "undefined") {
    void import("/js/chunks/clinical-profile-lan-sync-UFU7GJY3.js").then((mod) => mod.flushClinicalProfileToLan()).catch(() => {
    });
  }
...
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/js/chunks/patients-56ILPBCB.js").then((mod) => mod.renderPatientList({ silent: true })).catch(() => {
      });
    }
  }
  return migrated;
...
async function ensureTeamAssignedPatientsOnDevice() {
  ...
  const { filterJoinedTeams: filterJoinedTeams2 } = await import("/js/chunks/shared-Q57T4NF7.js");
  ...
  try {
    ...
    if (!rid) return;
    const push = await import("/js/chunks/push-AFUF7UCU.js");
...
async function refreshClinicalPatientListForScope() {
  ...
  if (typeof document === "undefined") return;
  try {
    const mod = await import("/js/chunks/patients-56ILPBCB.js");
...
async function flushClinicalProfileToLan(opts = {}) {
  ...
  const pushMod = await import("/js/chunks/push-AFUF7UCU.js");
...
//# sourceMappingURL=/js/chunks/chunk-N7JQFGRQ.js.map
