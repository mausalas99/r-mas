...
} from "/js/chunks/chunk-SU62SY34.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  const room = await import("/js/chunks/room-AQNELMMY.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/js/chunks/panel-M2LA6Q7F.js");
  ...
  const transport = await import("/js/chunks/transport-RRBFQJDZ.js");
  if (typeof transport.initLanHostPlugAndPlay === "function") {
    await transport.initLanHostPlugAndPlay();
  }
  if (isLanRemoteJoinMode()) {
    const pin = await import("/js/chunks/lan-shift-pin-connect-EXDV4XZ5.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-CO26HUYY.js.map
