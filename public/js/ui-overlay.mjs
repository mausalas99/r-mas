...
/** @type {ReturnType<typeof createModalDismissRegistry>|null} */
var dismissRegistry = null;
/** @type {WeakSet<HTMLElement>} */
var wiredScrims = typeof WeakSet !== 'undefined' ? new WeakSet() : null;
...
/** @param {HTMLElement|null|undefined} scrim */
...
/**
 * @param {{ stop?: () => void, finished?: Promise<void> }|null} controls
 * @param {() => void} cleanup
 */
...
/** @param {HTMLElement} panel @param {HTMLElement|null|undefined} scrim */
...
export function openDialog(opts) {
  ...
  registerOverlayLayer(function () { return !closed; }, scrim, function () {
    closeLayer('esc');
  });
 ...
 * @param {number} dismissVelocity
 * @param {() => void} requestClose
 */

/** @param {HTMLElement} panel @param {number} pointerId */
...
export function openSheet(opts) {
  ...
  var animControls = null;
  var previousFocus = typeof document !== 'undefined' ? document.activeElement : null;
  var dismissVelocity = opts.dismissVelocity == null
    ? DEFAULT_DISMISS_VELOCITY
    : opts.dismissVelocity;
  ...
  function closeLayer(reason) {
    ...
    var closeKf = reduced
      ? { opacity: [1, 0] }
      : { transform: [pointer.sheetTransform(dragPx), 'translateY(100%)'] };
...
/**
 * @param {{ panel: HTMLElement, trigger?: HTMLElement, nested?: boolean, onClose?: () => void }} opts
 */
