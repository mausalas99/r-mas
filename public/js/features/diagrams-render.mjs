...
function svgGamble(secs) {
  var na = g(secs, "ESC", "Na"),
    k = g(secs, "ESC", "K");
  var cl = g(secs, "ESC", "Cl"),
    hco3 = g(secs, "GASES", "Bica") || g(secs, "ESC", "HCO3");
  var f = g(secs, "ESC", "F"),
    ca = g(secs, "ESC", "Ca");
  var bun = g(secs, "QS", "BUN"),
    cr = g(secs, "QS", "Cr");
  var glu = g(secs, "QS", "Glu"),
    mg = g(secs, "ESC", "Mg");
  ...
  return (
    ...
    cell(c2, "Cl", cl, true) +
    cell(c3, "P", f, true) +
    cell(c4, "BUN", bun, true) +
    cell(c1, "K", k, false) +
    cell(c2, "HCO3", hco3, false) +
    cell(c3, "Ca", ca, false) +
    cell(c4, "Cr", cr, false) +
...
function svgPFH(secs) {
  ...
  return (
    ...
    LINE +
    "/>" +
    '<line x1="22"    y1="52"   x2="248"   y2="52"   ' +
    LINE +
    "/>" +
    '<line x1="22"    y1="104"  x2="248"   y2="104"  ' +
    LINE +
    "/>" +
    '<line x1="22"    y1="145"  x2="248"   y2="145"  ' +
    LINE +
    "/>" +
    '<line x1="' +
    cx +
