/**
 * Build verbal lab interpretation text for Eventualidades → timeline Labs (`labsText`).
 * Prosa corrida en español (biometría / química / gasometría), solo hallazgos.
 * Va a labsText / timeline Labs — no crea entradas clínicas de Eventualidad.
 */
...
import { consolidateLabSetsForEventualidad } from './lab-eventualidad-consolidate.mjs';
...
export function buildLabEventualidadInterpretText(labSets, opts) {
  ...
  var sections = [];
  consolidated.forEach(function (set) {
