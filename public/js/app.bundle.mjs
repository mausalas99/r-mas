...
} from "/js/chunks/chunk-PY33PFAY.js";
import "/js/chunks/chunk-PMNXZSBY.js";
import {
  AHF_RELATIVES,
  APP_DEDICATED_IDS,
...
} from "/js/chunks/chunk-2KXC3ZOY.js";
import {
  windowHandlers as windowHandlers15
} from "/js/chunks/chunk-P6U534TZ.js";
import {
  closeSettingsDropdown,
  syncTeamSyncHeaderButton
} from "/js/chunks/chunk-O2OKXKS2.js";
import {
...
} from "/js/chunks/chunk-CC2QAE6O.js";
import {
...
function ensureSettingsHelpLoaded() {
  ...
  if (!settingsHelpPromise) {
    settingsHelpPromise = import("/js/chunks/settings-help-ZUEK6LIN.js").then(function(mod) {
...
function ensurePlatformLoaded() {
  ...
  if (!platformPromise) {
    platformPromise = import("/js/chunks/platform-LMAVU7JN.js").then(function(mod) {
      platformModule = mod;
      return mod;
    });
  }
...
var CLINICAL_DB_BOOT_STEPS = [
  ...
  },
  {
    ...
    async run() {
      loadSettings();
      const mod = await import("/js/chunks/clinical-onboarding-main-BM36N3FJ.js");
  ...
  },
  {
    ...
    async run(ctx) {
      ...
      syncClinicalRotationEntryChrome();
      syncGuardiaModeButtonVisibility();
      ctx.teamsMod = await import("/js/chunks/clinical-teams-XQMJ75BE.js");
    }
  },
  {
