...
export const MANEJO_ATB_FAMILIES = [
  { id: 'carbapenem', label: 'Carbapenémicos' },
  { id: 'pip-tazo', label: 'Piperacilina-tazobactam' },
  { id: 'cephalosporin', label: 'Cefalosporinas' },
  { id: 'penicillin', label: 'Penicilinas' },
  { id: 'glycopeptide', label: 'Glicopéptidos' },
  { id: 'oxazolidinone', label: 'Oxazolidinonas' },
  { id: 'lipopeptide', label: 'Lipopéptidos' },
  { id: 'aminoglycoside', label: 'Aminoglucósidos' },
  { id: 'fluoroquinolone', label: 'Fluoroquinolonas' },
  { id: 'anaerobic', label: 'Anaerobicidas' },
  { id: 'tetracycline', label: 'Tetraciclinas' },
  { id: 'polymyxin', label: 'Polimixinas' },
];
...
export const MANEJO_ATB_DRUGS = [
  ...
  },
  {
    ...
    family: 'glycopeptide',
    name: 'Vancomicina',
    adultDose: 'Carga 20–30 mg/kg; mantenimiento 15–20 mg/kg c/12h',
    indications: ['MRSA', 'Staphylococcus', 'Enterococcus sensible'],
    renalNote: 'TDM valle 15–20 mcg/mL infecciones graves',
    route: 'IV',
    someAbbrev: ['VANCO'],
  ...
  },
  {
    ...
    indications: ['Atypicals', 'MRSA comunitario (alternativa)'],
    renalNote: 'No ajuste renal',
    route: 'IV/VO',
    someAbbrev: ['DOXY', 'DOX'],
    organismHints: [],
