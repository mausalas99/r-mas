...
export const MANEJO_PROTOCOLS = [
  ...
  },
  {
    ...
    indicationText: '20–30 mg/kg (default 25). Cada 5 mg = 1 ml. Infusión 2 h c/12 h en glucosado 5%.',
    calculatorId: 'vanco-load',
    copyTemplate: '',
    notes: ['Niveles antes de 4ª dosis si pasa a mantenimiento'],
  },
  {
    id: 'vanco-load-20',
    category: 'fluidos',
    title: 'Vancomicina — carga 20 mg/kg',
    indicationText: '20 mg/kg. Cada 5 mg = 1 ml. Infusión 2 h c/12 h en glucosado 5%.',
    calculatorId: 'vanco-load',
    calculatorParams: { mgPerKg: 20 },
    copyTemplate: '',
    notes: ['Dosis inferior del rango de carga'],
  },
  {
    id: 'vanco-load-30',
    category: 'fluidos',
    title: 'Vancomicina — carga 30 mg/kg',
    indicationText: '30 mg/kg. Cada 5 mg = 1 ml. Infusión 2 h c/12 h en glucosado 5%.',
    calculatorId: 'vanco-load',
    calculatorParams: { mgPerKg: 30 },
    copyTemplate: '',
    notes: ['Dosis superior del rango de carga'],
  },
  {
    id: 'vanco-maint',
    category: 'fluidos',
    title: 'Vancomicina — mantenimiento',
    indicationText: '15–20 mg/kg (default 17.5). Misma regla de dilución: mg/5 = cc en G5% 2 h c/12 h.',
    calculatorId: 'vanco-maint',
    copyTemplate: '',
    notes: ['Solicitar niveles antes de 4ª dosis de mantenimiento'],
  },
  {
    id: 'vanco-levels-note',
    category: 'fluidos',
    title: 'Vancomicina — niveles',
    indicationText: 'Nivel valle objetivo 15–20 mcg/ml (ajustar según institución).',
    calculatorId: null,
    copyTemplate: 'VANCOMICINA: NIVELES VALLE 15–20 MCG/ML ANTES DE 4ª DOSIS MANTENIMIENTO',
    notes: ['Coordinar con laboratorio y farmacia'],
  },
  {
    id: 'mg-infusion-9h',
    category: 'fluidos',
  ...
  },
  {
    ...
    indicationText:
      'Enjuagues q8h antes de alimentos: nistatina, hidróxido de aluminio, difenhidramina, dexametasona y doxiciclina (protocolo oral institucional).',
    calculatorId: null,
    copyTemplate:
      'SOLUCIÓN STANFORD: NISTATINA, AL MAG, DIFENHIDRAMINA, DEXA, DOXICICLINA — ENJUAGUES Q8H ANTES DE ALIMENTOS',
    notes: ['Una sola entrada combinada según protocolo HU'],
  },
];
