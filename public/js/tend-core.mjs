...
export function tendEligibleSectionKey(sec) {
  var u = String(sec == null ? '' : sec)
    ...
    .toUpperCase();
  if (!u) return false;
  return /^(BH|PLTCIT|QS|ESC|PFHS|GASES|LCR|LIQ|PROT12H|PROT24H|PIE|EGO|EU|CUANTORINA|FROTIS|LIPASA|TROP|TIR|ENDO|CARD|FE|INFL|INM|META|NEF|NIVEL|TM|NUT|GI|TOX)$/.test(
    u
  );
}
