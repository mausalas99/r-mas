...
var LAB_SECTION_BASE =
  /^(BH|QS|ESC|PFHs|GASES|PIE|LCR|EGO|EU|CUANTORINA|PROT12H|PROT24H|PltCit|FROTIS|SEROL|GS|HECES|LIPASA|TROP|TIR|ENDO|CARD|FE|FEB|INFL|INM|META|NEF|NIVEL|TM|NUT|GI|TOX|HEPB|VIRAL|MICRO)\b/i;
