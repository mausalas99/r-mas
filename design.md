...
- Botones de acción con texto en 8px: van redondos (`--radius-pill`, decisión del owner 2026-09-22). `--radius-control` (8px) solo para botones de icono, menús y cajas; insignias usan `--radius-badge` (6px), botones en fila usan `--radius-row-btn` (7px).
