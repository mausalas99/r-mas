...
2. **Mi equipo con 2+ pacientes** (con registro) → modal con checkboxes + fechas (aunque haya paciente activo).
3. **Solo un paciente** (activo o único en equipo) → modal solo fechas → fetch ese paciente.
