...
| Procedure/study parsing → Pendientes, hemodialysis UF → balance | `docs/superpowers/plans/2026-09-05-procedure-parsing-and-uf-balance.md` — **Slice 1 done 2026-09-05** (ESTUDIOS/PROCEDIMIENTO now become Pendientes on paste, tested 67/67). Slice 2 (hemodialysis "no fue" reminder in estado actual registro) and Slice 3 (ultrafiltrado egreso field) in progress. |
