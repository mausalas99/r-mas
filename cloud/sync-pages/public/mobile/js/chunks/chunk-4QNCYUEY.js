...
var commandPaletteWindowHandlersLazy = buildLazyWindowHandlers(
  ...
  function() {
    return import("/mobile/js/chunks/command-palette-U6CI3QII.js");
  }
);
var clinicalSyncModeSettingsHandlersLazy = buildLazyWindowHandlers(
  ...
  function() {
    return import("/mobile/js/chunks/clinical-sync-mode-settings-Y5NL3XBR.js");
  }
);
...
function ensureChartsLoaded() {
  ...
  if (!chartsPromise) {
    chartsPromise = Promise.all([
      import("/mobile/js/chunks/tendencias-NZ3Z3AKC.js"),
...
function ensureSettingsHelpLoaded() {
  ...
  if (!settingsHelpPromise) {
    settingsHelpPromise = import("/mobile/js/chunks/settings-help-QYUBTBFT.js").then(function(mod) {
...
function ensurePlatformLoaded() {
  ...
  if (!platformPromise) {
    platformPromise = import("/mobile/js/chunks/platform-R4JO4Y53.js").then(function(mod) {
      platformModule = mod;
...
function ensureEntregaLoaded() {
  ...
  if (!entregaPromise) {
    entregaPromise = import("/mobile/js/chunks/clinical-entrega-MXCLZZTE.js").then(function(mod) {
      entregaModule = mod;
      return mod;
    });
  }
...
function ensureEaVitalHistoryLoaded() {
  ...
  if (!eaVitalHistoryPromise) {
    eaVitalHistoryPromise = import("/mobile/js/chunks/estado-actual-vital-history-modal-LC2VGZAA.js").then(function(mod) {
...
function ensureNotaEvolucionLoaded() {
  ...
  if (!notaEvolucionPromise) {
    notaEvolucionPromise = import("/mobile/js/chunks/nota-evolucion-panel-OB27LDDK.js").then(function(mod) {
...
function ensureLabsLoaded() {
  ...
  if (!labsPromise) {
    labsPromise = import("/mobile/js/chunks/lab-panel-3XUS3OA2.js").then(function(mod) {
      labsModule = mod;
...
//# sourceMappingURL=/js/chunks/chunk-4QNCYUEY.js.map
