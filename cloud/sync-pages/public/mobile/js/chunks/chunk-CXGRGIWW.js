...
} from "/mobile/js/chunks/chunk-MYKE46DH.js";
import {
  isCutoverDone,
  isCutoverPending,
  setCutoverFlag
...
async function defaultAssignPatientToTeam(patientId, teamId) {
  const { assignPatientToTeamClinical } = await import("/mobile/js/chunks/patient-team-assign-ui-PAXTPJLI.js");
...
async function renderCompletedOnboarding(host) {
  ...
  const { hideMainClinicalOnboarding } = await import("/mobile/js/chunks/clinical-onboarding-main-JGMTC5M4.js");
  hideMainClinicalOnboarding();
  if (host.closest("#clinical-teams-panel-body")) {
    const { renderClinicalTeamsPanel } = await import("/mobile/js/chunks/clinical-teams-BAVA5ZAH.js");
...
async function renderNoSessionOnboarding(host) {
  ...
  const { buildOnboardingSessionBlockHtml } = await import("/mobile/js/chunks/clinical-onboarding-main-JGMTC5M4.js");
...
//# sourceMappingURL=/js/chunks/chunk-CXGRGIWW.js.map
