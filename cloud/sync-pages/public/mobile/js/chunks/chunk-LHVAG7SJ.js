...
function resumeClinicalOnboardingAfterTourIfNeeded() {
  void import("/mobile/js/chunks/tour-flow-O5B5DATI.js").then((mod) => {
    if (mod && typeof mod.handlePostGuidedTourOnboardingResume === "function") {
      void mod.handlePostGuidedTourOnboardingResume();
      return;
    }
    void import("/mobile/js/chunks/clinical-onboarding-main-RY7HE6NV.js").then((main) => {
...
function tryShowGuidedTourIntroIfNeeded() {
  void import("/mobile/js/chunks/tour-intro-education-OKPZGLVV.js").then((mod) => {
...
function initGuidedTourGate() {
  ...
  void import("/mobile/js/chunks/learn-hub-AUOVLRBJ.js").then(function(hub) {
...
function openTutorialIntroFromSettings() {
  return resolveAppVersionForTour().then(function(v) {
    window.__RPC_APP_VERSION__ = normalizeTourVersionLabel(v);
    return import("/mobile/js/chunks/learn-hub-AUOVLRBJ.js").then((hub) => {
...
async function tryShowPostRegistrationEducationIfNeeded() {
  ...
  const { needsClinicalOnboarding, needsTeamOnboardingStep } = await import("/mobile/js/chunks/clinical-onboarding-E22OJSDA.js");
  ...
  if (shouldOfferGuardiaV7Education({
    ...
    const { maybeShowGuardiaV7UpgradeCard } = await import("/mobile/js/chunks/guardia-v7-upgrade-card-I6LMHXSB.js");
  ...
  if (shouldShowFundamentosTourIntro({ curVersion: cur, storedDoneVersion: stored, needsOnboarding: false })) {
    markGuidedTourVersionDone();
    setTimeout(() => {
      void import("/mobile/js/chunks/learn-hub-AUOVLRBJ.js").then((hub) => {
        if (typeof hub.openLearnHub === "function") hub.openLearnHub({ focusTrack: "fundamentos" });
      });
    }, 80);
  }
...
//# sourceMappingURL=/js/chunks/chunk-LHVAG7SJ.js.map
