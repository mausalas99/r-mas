...
} from "/mobile/js/chunks/chunk-VNP6GDZ5.js";
import {
...
} from "/mobile/js/chunks/chunk-KW6FOZVD.js";
...
import {
  showToast
} from "/mobile/js/chunks/chunk-3ADS2QIW.js";
  ...
  const runtime = startCloudSyncRuntime({
    ...
    applyPullResult: async (result) => {
      try {
        ...
        try {
          const { showCloudMobileEmptyCensusBanner: showCloudMobileEmptyCensusBanner2 } = await import("/mobile/js/chunks/resolve-active-room-ZNGWOKE5.js");
          showCloudMobileEmptyCensusBanner2();
          const patientsMod = await import("/mobile/js/chunks/patients-KV425J4Y.js");
  ...
  async function onConnected(gateEl) {
    ...
    try {
      ...
      try {
        ...
        if (sala) {
          const { pullClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-A7FFMSUY.js");
...
//# sourceMappingURL=/js/chunks/boot-EIQEHQTT.js.map
