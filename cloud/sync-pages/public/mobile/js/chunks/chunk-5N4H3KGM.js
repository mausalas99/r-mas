...
function importLazyRoutes() {
  return import("/mobile/js/chunks/lazy-feature-routes-Q6ZFNJCB.js");
}
...
function deferMobileWebBoot_() {
  void import("/mobile/js/chunks/app-shell-mobile-boot-CLVJ5TN6.js").then(function(mod) {
...
function scheduleDeferredShellInits(_showToast) {
  ...
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/paste-smart-4NFAYO4T.js").then(function(mod) {
      mod.initPasteSmart();
    });
  });
  _rpcDeferInit(function() {
...
function scheduleDeferredUiInits(showToast2) {
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/productivity-AJXEFYLN.js").then(function(mod) {
      mod.initProductivityKeyboardShortcuts();
    });
  });
  void import("/mobile/js/chunks/app-shell-keyboard-QVEDWCMS.js").then(function(mod) {
    mod.initShellKeyboardShortcuts(showToast2);
  });
  void import("/mobile/js/chunks/keyboard-shortcuts-nudge-5TCCKJ3R.js").then(function(mod) {
...
function createPatientUpdateHandler(shellCtx2, syncWorkContextChrome2) {
  function refreshPatientChromeAfterUpdate() {
    ...
    void import("/mobile/js/chunks/pase-board-UHG6EFMU.js").then(function(mod) {
      mod.renderPaseBoard();
    });
    renderRoundOverviewPanels();
    if (shellCtx2.getActiveAppTab() === "agenda") {
      void import("/mobile/js/chunks/agenda-OWXSFAUV.js").then(function(mod) {
...
function loadShowToast() {
  ...
  if (!showToastLoadPromise) {
    showToastLoadPromise = import("/mobile/js/chunks/ui-toast-SWIWD6T6.js").then(function(mod) {
...
if (typeof window !== "undefined") {
  ...
  window.__hybridDemoSheet = function() {
    return import("/mobile/js/chunks/ui-overlay-J3N5FVAL.js").then(function(mod) {
...
function initModalDismiss() {
  void import("/mobile/js/chunks/app-shell-modals-L6R6NC7V.js").then(function(mod) {
    mod.initModalDismiss();
  });
}
function quickExportCurrentPatientLazy() {
  var args = arguments;
  void import("/mobile/js/chunks/clinical-quick-export-7STWBL27.js").then(function(mod) {
...
function registerAppShellContext(ctx) {
  ...
  void import("/mobile/js/chunks/command-palette-YDH7YOEB.js").then(function(mod) {
...
function syncWorkContextChrome() {
  ...
  void import("/mobile/js/chunks/header-context-IFTDBEBF.js").then(function(mod) {
...
//# sourceMappingURL=/js/chunks/chunk-5N4H3KGM.js.map
