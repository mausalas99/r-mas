...
} from "/mobile/js/chunks/chunk-HUBYG4EJ.js";
import {
  loadGuardiaV7Progress,
  resetGuardiaV7Chapter
} from "/mobile/js/chunks/chunk-OO36DDH5.js";
import {
  loadTourProgress
...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/mobile/js/chunks/tour-runtime-IKY75SE2.js").then((mod) => {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/mobile/js/chunks/help-content-YQMUIZV3.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-FG5JDOT2.js.map
