...
} from "/mobile/js/chunks/chunk-KESF4FLC.js";
import {
...
import {
  showToast
} from "/mobile/js/chunks/chunk-VRNWC4P2.js";
import {
  closeModalAnimated
...
async function ensureClinicalPanelSession(opts = {}) {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/mobile/js/chunks/db-unlock-VMMGX4OJ.js");
...
async function publishClinicalTeamsToSync() {
  try {
    const mod = await import("/mobile/js/chunks/mutate-bridge-clinical-ops-DPZ6NDIY.js");
...
async function pullClinicalOpsFromCloudRoom(options = {}) {
  ...
  cloudClinicalOpsPullInFlight = (async () => {
    try {
      ...
      const { clinicalSessionContext: clinicalSessionContext2 } = await import("/mobile/js/chunks/clinical-access-runtime-AIZQAPAG.js");
      const { getCloudSyncToken: getCloudSyncToken2 } = await import("/mobile/js/chunks/settings-X3WJCWR2.js");
      ...
      if (!salas.length) {
        const { autostartCloudSyncIfConfigured } = await import("/mobile/js/chunks/autostart-P2DKHQBJ.js");
        const rtMod = await import("/mobile/js/chunks/panel-conexion-runtime-O62UVHI3.js");
      ...
      const { pullClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-HQSTMOK5.js");
...
function scheduleBackgroundClinicalOpsPush(options = {}) {
  void (async () => {
    try {
      const { pushClinicalOpsForSalas, listLocalTeamSalas } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-HQSTMOK5.js");
...
async function publishClinicalTeamsAfterChange(options = {}) {
  if (isCloudSyncActive()) {
    try {
      const { syncClinicalOpsForSala, pushClinicalOpsForSalas, listLocalTeamSalas } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-HQSTMOK5.js");
...
Desaparecer\xE1 del directorio. Las dem\xE1s R+ en la misma sala Nube lo quitar\xE1n al sincronizar.`
  ...
  const { reloadDirectoryUsersAfterMutation } = await import("/mobile/js/chunks/teams-roster-directory-load-CZQPGP6J.js");
...
async function handleLanAssignButtonClick(btn) {
  ...
  try {
    const { scheduleCloudSyncPush: scheduleCloudSyncPush2 } = await import("/mobile/js/chunks/mutate-bridge-OGE2GEEP.js");
...
async function resolveTeamMemberHintHtml(joinedTeams) {
  ...
  try {
    ...
    const { getCloudSyncRoomId } = await import("/mobile/js/chunks/settings-X3WJCWR2.js");
...
async function resolveTeamIdFromDirectory(raw) {
  try {
    const { pullClinicalOpsFromCloudRoom: pullClinicalOpsFromCloudRoom2 } = await import("/mobile/js/chunks/teams-guardia-bridge-HZ4X2SHO.js");
    await pullClinicalOpsFromCloudRoom2({ timeoutMs: 8e3, force: true });
    const { fetchClinicalTeamsFromDb: fetchClinicalTeamsFromDb2 } = await import("/mobile/js/chunks/clinical-access-runtime-AIZQAPAG.js");
...
async function openTeamsPanelAfterAlreadyJoined() {
  ...
  const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/mobile/js/chunks/teams-roster-EPQZ33ZN.js");
...
async function finalizeSuccessfulTeamJoin(team, teamId, cycle) {
  ...
  const { closeClinicalTeamsPanel: closeClinicalTeamsPanel2, refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/mobile/js/chunks/teams-roster-shell-NRMLAWXA.js");
  await fetchClinicalTeamsFromDb();
  ...
  void import("/mobile/js/chunks/ensure-turn-room-LH5JI4KU.js").then(
...
async function redirectLanInviteFromTeamJoinField(raw) {
  ...
  const { openConnectionDropdown } = await import("/mobile/js/chunks/panel-chrome-5M6FF2SQ.js");
...
function loadRoster() {
  return import("/mobile/js/chunks/teams-roster-EPQZ33ZN.js");
}
...
async function mountEquipoTeamsPanel(host, opts = {}) {
  ...
  try {
    const { needsClinicalOnboarding: needsClinicalOnboarding2 } = await import("/mobile/js/chunks/clinical-onboarding-5SWDFJP6.js");
  ...
  try {
    const { renderClinicalTeamsPanelInto: renderClinicalTeamsPanelInto2 } = await import("/mobile/js/chunks/teams-roster-panel-JAKHFPNO.js");
...
function restoreCreateTeamPanelDraft(draft) {
  ...
  void import("/mobile/js/chunks/teams-roster-create-7IXREFSF.js").then((m) => {
...
async function maybeRefreshClinicalOpsDirectory(skipPull, browseSala, homeSala) {
  ...
  const { isClinicalTeamsPanelActive: isClinicalTeamsPanelActive2 } = await import("/mobile/js/chunks/teams-roster-shell-NRMLAWXA.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/mobile/js/chunks/teams-roster-interactions-L4H7OVLP.js");
...
async function refreshTeamsUiAfterChange(opts = {}) {
  const { isDirectoryModalOpen: isDirectoryModalOpen2 } = await import("/mobile/js/chunks/teams-roster-users-VBE5RD3P.js");
  if (isDirectoryModalOpen2()) return;
  const { refreshClinicalPatientListForScope: refreshClinicalPatientListForScope2 } = await import("/mobile/js/chunks/clinical-access-runtime-AIZQAPAG.js");
  await refreshClinicalPatientListForScope2({ allowLanPull: true });
  import("/mobile/js/chunks/clinical-rotation-entry-KWXHGOOS.js").then((m) => m.syncClinicalRotationEntryChrome());
  if (isClinicalTeamsPanelActive()) {
    if (!opts.force) {
      const { isClinicalTeamsPanelUserInteracting: isClinicalTeamsPanelUserInteracting2 } = await import("/mobile/js/chunks/teams-roster-panel-draft-UUNSI33F.js");
...
async function openClinicalTeamsPanel(opts = {}) {
  const { openConexionEquipoPanel } = await import("/mobile/js/chunks/panel-equipo-nav-JNNJO62A.js");
...
async function openClinicalTeamsPanelModal(opts = {}) {
  ...
  try {
    const { wireClinicalTeamsModalChrome: wireClinicalTeamsModalChrome2 } = await import("/mobile/js/chunks/teams-roster-modal-chrome-KNKEM7IH.js");
...
async function handleProfileFormSubmit(ev) {
  ...
  void import("/mobile/js/chunks/mutate-bridge-clinical-ops-DPZ6NDIY.js").then((mod) => {
    if (typeof mod.pushCloudClinicalOpsNow === "function") void mod.pushCloudClinicalOpsNow();
  }).catch(() => {
  });
  void import("/mobile/js/chunks/patients-C7M2CDCW.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
function buildAnionGapStep_(agVal, agcVal) {
  ...
  if (display != null && isFinite(display)) {
    var label = agcVal != null ? "Ani\xF3n gap corregido por alb\xFAmina (AGc)" : "Ani\xF3n gap";
    if (display < 8) {
    ...
    if (agcVal != null && agVal != null) {
      anionGap.interpretation += " AG crudo " + String(Math.round((agVal + Number.EPSILON) * 10) / 10) + " \u2192 AGc " + String(Math.round((agcVal + Number.EPSILON) * 10) / 10) + " (correcci\xF3n +2.5\xD7(4\u2212Alb)).";
    }
  } else {
...
function buildGasoMetricsRow(lab, ev) {
  ...
  metrics.appendChild(
    gasoMetricChip(
      ev.steps.anionGap.corrected != null ? "AGc" : "Ani\xF3n gap",
...
function buildGasoSteps(ev) {
  ...
  var agBadge = ag.corrected != null ? "AGc " + ag.corrected + " (AG " + ag.value + ") mEq/L" : ag.value != null ? ag.value + " mEq/L" : null;
...
function renderGasoEmptySlot(slot, escHtml, message, isError) {
  ...
  slot.innerHTML = '<p class="tend-empty" style="font-size:13px;color:' + color + ';">' + escHtml(message) + "</p>";
}
function refillGasoExtendedSlot(slot, latest, fio2, escHtml) {
  if (!slot) return;
  slot.innerHTML = "";
  if (!latest || !latest.parsedBySection) {
    renderGasoEmptySlot(slot, escHtml, "Sin valores recientes disponibles para gasometr\xEDa.", false);
    return;
  }
  ...
  try {
    ...
    renderGasoEmptySlot(slot, escHtml, "No se pudo calcular la gasometr\xEDa extendida.", true);
...
function wireInheritPatientsButtons() {
  document.querySelectorAll(".clinical-teams-inherit-btn").forEach((btn) => {
    ...
    btn.addEventListener("click", async () => {
      ...
      const { openInheritPatientsModal, wireInheritPatientsModal } = await import("/mobile/js/chunks/teams-roster-inherit-patients-modal-FPCPHY5M.js");
...
function wireClinicalTeamsControls() {
  void import("/mobile/js/chunks/teams-roster-modal-chrome-KNKEM7IH.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/mobile/js/chunks/clinical-rotation-entry-KWXHGOOS.js").then((mod) => {
    mod.wireClinicalRotationEntryControls();
    mod.syncClinicalRotationEntryChrome();
  });
  void import("/mobile/js/chunks/clinical-rotation-LQ6U43OY.js").then((mod) => {
...
async function persistSalaFromModal() {
  ...
  const { persistProfileFromPanel: persistProfileFromPanel2 } = await import("/mobile/js/chunks/teams-roster-profile-persist-FXKZ4QWH.js");
  const user = clinicalSessionContext.user || {};
...
async function confirmNuevaRotacion() {
  ...
  document.dispatchEvent(new CustomEvent("rpc-guardia-rotation-changed"));
  try {
    const { publishClinicalTeamsAfterChange: publishClinicalTeamsAfterChange2 } = await import("/mobile/js/chunks/teams-guardia-bridge-HZ4X2SHO.js");
...
function wireGuardiaRotationControls() {
  ...
  void import("/mobile/js/chunks/teams-roster-inherit-patients-modal-FPCPHY5M.js").then(
...
async function pushClinicalOpsAfterTeamAssign(teamSala) {
  const lan = await import("/mobile/js/chunks/mutate-bridge-OGE2GEEP.js").catch(() => null);
  if (lan?.pushClinicalOpsLanNow) await lan.pushClinicalOpsLanNow();
  if (!teamSala) return;
  try {
    const { pushClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-HQSTMOK5.js");
...
async function mirrorAssignedPatientToCloud(pid) {
  ...
  const { getClinicalScopeContextForEvaluate: getClinicalScopeContextForEvaluate2 } = await import("/mobile/js/chunks/clinical-access-runtime-AIZQAPAG.js");
  const scopeCtx = getClinicalScopeContextForEvaluate2();
  try {
    const cloud = await import("/mobile/js/chunks/mutate-bridge-OGE2GEEP.js");
    if (!patient) {
      if (typeof cloud.scheduleCloudSyncPush === "function") cloud.scheduleCloudSyncPush();
      return;
    }
    const { mirrorPatientCensusToOperationalSala, patientBelongsToActiveCloudRoom } = await import("/mobile/js/chunks/cloud-census-sala-push-XW4SNQ32.js");
...
async function onPatientTeamAssignChange(teamId) {
  ...
  if (res.ok) {
    ...
    const patientsMod = await import("/mobile/js/chunks/patients-C7M2CDCW.js").catch(() => null);
...
async function notifyAssignToast(msg, type) {
  try {
    const shell = await import("/mobile/js/chunks/app-shell-CYKX4DYP.js");
...
function wireRosterFooter(guardiasMap) {
  document.getElementById("roster-btn-cancel")?.addEventListener("click", () => {
    void (async () => {
      ...
      const { endEntregaPhase: endEntregaPhase2 } = await import("/mobile/js/chunks/clinical-entrega-77FSKVXI.js");
      endEntregaPhase2();
...
async function tryRestoreOrphanPatientFromLan(patientId) {
  ...
  const lan = await import("/mobile/js/chunks/mutate-bridge-OGE2GEEP.js");
...
async function openEntregaForOrphan(patientId, guardiaId) {
  const entrega = await import("/mobile/js/chunks/clinical-entrega-77FSKVXI.js");
...
async function removeOrphanPatientLocally(patientId) {
  if (!patientInLocalCensus(patientId)) return;
  const lanMod = await import("/mobile/js/chunks/mutate-bridge-OGE2GEEP.js");
...
function invalidateEventualidadesRelatedCaches() {
  ...
  void import("/mobile/js/chunks/pase-board-inner-cache-6ZULGJAO.js").then(function(m) {
...
function syncGuardiaLearnNudgeChrome() {
  const host = document.getElementById("guardia-census-head");
  if (!host) return;
  void import("/mobile/js/chunks/guardia-v7-progress-VWRW4Z5U.js").then(function(progressMod) {
...
function appendGuardiaLearnNudge(host) {
  void Promise.all([
    import("/mobile/js/chunks/guardia-v7-progress-VWRW4Z5U.js"),
    import("/mobile/js/chunks/learn-hub-MOTWQ4OS.js")
  ]).then(function(mods) {
...
function ensureGuardiaBoardBootstrapped(settings) {
  ...
  void import("/mobile/js/chunks/clinical-rotation-entry-KWXHGOOS.js").then((mod) => {
    mod.syncClinicalRotationEntryChrome?.();
  });
...
function invalidateMobileSidebarPatientCache() {
  if (typeof document === "undefined") return;
  void import("/mobile/js/chunks/patients-C7M2CDCW.js").then((mod) => {
...
async function countTeamMemberMissingPatients(user, teams, assignments, localIds, now) {
  const { filterJoinedTeams: filterJoinedTeams2 } = await import("/mobile/js/chunks/shared-AXGD6H2V.js");
  const { resolvePatientTeamIdFromAssignments: resolvePatientTeamIdFromAssignments2 } = await import("/mobile/js/chunks/clinico-access-XELRIMXU.js");
...
async function runNubePatientReconcile(_reason) {
  ...
  nubePatientReconcileInFlight = (async function() {
    try {
      const { getSharedNubeRuntime } = await import("/mobile/js/chunks/panel-conexion-runtime-O62UVHI3.js");
      const { autostartCloudSyncIfConfigured } = await import("/mobile/js/chunks/autostart-P2DKHQBJ.js");
...
async function refreshClinicalPatientListForScope(options) {
  ...
  setRefreshClinicalPatientListForScopeInFlight(
    (async function() {
      ...
      if (typeof document === "undefined") return;
      try {
        const mod = await import("/mobile/js/chunks/patients-C7M2CDCW.js");
...
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/mobile/js/chunks/patients-C7M2CDCW.js").then((mod) => mod.renderPatientList({ silent: true })).catch(() => {
      });
    }
  }
  return migrated;
...
async function refreshDesktopPatientListAfterScopePrune() {
  ...
  try {
    const { renderGuardiaCensusGrid: renderGuardiaCensusGrid2 } = await import("/mobile/js/chunks/guardia-grid-RASP7TSO.js");
...
//# sourceMappingURL=/js/chunks/chunk-AVZ5WV63.js.map
