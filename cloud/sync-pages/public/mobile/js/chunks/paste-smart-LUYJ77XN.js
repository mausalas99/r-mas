...
function loadLabPasteRuntime() {
  return import("/mobile/js/chunks/lazy-feature-routes-M2XCF2YY.js").then(function(routes) {
    return routes.ensureLabsLoaded();
  }).then(function() {
    return Promise.all([
      import("/mobile/js/chunks/lab-bulk-preview-modal-D3YGZUW3.js"),
      import("/mobile/js/chunks/lab-panel-workbench-YD63Y5AX.js")
    ]);
  }).then(function(mods) {
    return {
...
//# sourceMappingURL=/js/chunks/paste-smart-LUYJ77XN.js.map
