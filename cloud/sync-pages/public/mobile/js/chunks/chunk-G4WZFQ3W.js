...
} from "/mobile/js/chunks/chunk-5NXKHEZO.js";
import {
  renderSyncModeChoicePanel,
  wireSyncModeOnboardingInteractions
} from "/mobile/js/chunks/chunk-KYJHH3SC.js";
import {
...
async function handleClinicalRegistrationSubmit(deps) {
  ...
  const { refreshClinicalUserProfile } = await import("/mobile/js/chunks/clinical-access-runtime-KAV32YSL.js");
  await refreshClinicalUserProfile();
  deps.closeModal();
  maybePersistMobilePairing_();
  resolvePendingRegistration_(deps);
  try {
    const { refreshMainClinicalOnboardingIfNeeded: refreshMainClinicalOnboardingIfNeeded2 } = await import("/mobile/js/chunks/clinical-onboarding-main-RY7HE6NV.js");
...
function hideMainClinicalOnboarding() {
  ...
  void import("/mobile/js/chunks/tour-engine-X62EEPCL.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/mobile/js/chunks/learn-hub-AUOVLRBJ.js").then((m) => {
...
async function refreshTeamOnboardingShellOnly() {
  ...
  const { renderTeamOnboardingInto, wireTeamOnboardingInteractions } = await import("/mobile/js/chunks/clinical-onboarding-team-URUN4C5N.js");
...
async function showMainClinicalOnboardingBody() {
  ...
  try {
    const { fetchClinicalTeamsFromDb } = await import("/mobile/js/chunks/clinical-access-runtime-KAV32YSL.js");
    await fetchClinicalTeamsFromDb();
  } catch {
  }
  try {
    const { getCloudSyncToken } = await import("/mobile/js/chunks/settings-KQZK5HV5.js");
    if (getCloudSyncToken()) {
      const { tryResumeOnboardingFromStoredCloudToken } = await import("/mobile/js/chunks/clinical-onboarding-existing-login-INOEBTE7.js");
  ...
  try {
    ...
    const rot = await import("/mobile/js/chunks/clinical-rotation-entry-HJMTCXVR.js");
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/mobile/js/chunks/settings-dropdown-PT6WDBNE.js");
...
//# sourceMappingURL=/js/chunks/chunk-G4WZFQ3W.js.map
