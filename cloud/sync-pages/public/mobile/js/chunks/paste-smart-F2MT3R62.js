...
function loadLabPasteRuntime() {
  return import("/mobile/js/chunks/lazy-feature-routes-SNUITVIW.js").then(function(routes) {
    return routes.ensureLabsLoaded();
  }).then(function() {
    return Promise.all([
      import("/mobile/js/chunks/lab-bulk-preview-modal-GLEJGP2X.js"),
      import("/mobile/js/chunks/lab-panel-workbench-VWNOBFLJ.js")
    ]);
  }).then(function(mods) {
    return {
...
//# sourceMappingURL=/js/chunks/paste-smart-F2MT3R62.js.map
