...
// public/js/features/cloud-sync/mutate-bridge-direct-push.mjs
async function pushCloudCensusNow() {
  ...
  const { collectPatientEntriesForCloudPush } = await import("/mobile/js/chunks/cloud-census-collect-5H4OBJWC.js");
  ...
  try {
    ...
    const { pushCloudOpsDirect } = await import("/mobile/js/chunks/cloud-push-direct-Q5Z2FBC7.js");
    ...
    void import("/mobile/js/chunks/lab-sync-diagnostics-2NA4QEXB.js").then(function(labDiag) {
...
function enqueueCloudMutation(clientMutationId, ops) {
...
async function flushCloudSyncOutbox() {
...
async function collectCloudBundleOps(meta) {
  ...
  } = await import("/mobile/js/chunks/cloud-census-collect-5H4OBJWC.js");
  const entries = await collectPatientEntriesForCloudPush();
  ...
  const {
    ...
    pushOpsToSalaRoom
  } = await import("/mobile/js/chunks/cloud-census-sala-push-4WRZZEKA.js");
  const { getClinicalScopeContextForEvaluate } = await import("/mobile/js/chunks/clinical-access-runtime-7PNW7XFE.js");
...
function enqueueCloudLabSidecarsForPatient(patientId) {
  ...
  void import("/mobile/js/chunks/cloud-census-sala-push-4WRZZEKA.js").then(async function(mod) {
    const { getClinicalScopeContextForEvaluate } = await import("/mobile/js/chunks/clinical-access-runtime-7PNW7XFE.js");
    const scopeCtx = getClinicalScopeContextForEvaluate();
...
function enqueueCloudPatientAdmit(patient) {
  ...
  void (async function() {
    const mod = await import("/mobile/js/chunks/cloud-census-sala-push-4WRZZEKA.js");
    const { getClinicalScopeContextForEvaluate } = await import("/mobile/js/chunks/clinical-access-runtime-7PNW7XFE.js");
    const scopeCtx = getClinicalScopeContextForEvaluate();
...
async function pushCloudClinicalOpsNow() {
  ...
  const { pushClinicalOpsForSalas, listLocalTeamSalas, pushClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-SWM445J2.js");
...
//# sourceMappingURL=/js/chunks/chunk-WJVW5GRE.js.map
