...
async function refreshChromeAfterLocalOnlyExit() {
  try {
    const { closeSettingsDropdown, syncTeamSyncHeaderButton } = await import("/mobile/js/chunks/settings-dropdown-OE6EF6O2.js");
  ...
  try {
    const main = await import("/mobile/js/chunks/clinical-onboarding-main-VNLNQA5N.js");
    await main.refreshMainClinicalOnboardingIfNeeded();
  } catch (_e) {
    void _e;
  }
  try {
    const rot = await import("/mobile/js/chunks/clinical-rotation-entry-ZNLXERIG.js");
...
async function enableClinicalLanFromSettings() {
  ...
  setClinicalSyncModeLocalOnly(false);
  try {
    const lan = await import("/mobile/js/chunks/mutate-bridge-NWVDH4HI.js");
...
//# sourceMappingURL=/js/chunks/clinical-sync-mode-settings-UJLXGAKX.js.map
