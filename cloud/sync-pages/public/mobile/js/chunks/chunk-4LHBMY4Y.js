...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/mobile/js/chunks/tour-runtime-DMWYLDQ4.js").then((mod) => {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/mobile/js/chunks/help-content-MBLIR2GX.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-4LHBMY4Y.js.map
