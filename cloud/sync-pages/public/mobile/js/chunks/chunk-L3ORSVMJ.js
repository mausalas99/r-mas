...
function captureDatosModalRestoreIfNeeded() {
  ...
  if (typeof rt2.getActiveAppTab !== "function" || typeof rt2.getActiveInner !== "function") return;
  datosModalRestore = {
    appTab: rt2.getActiveAppTab(),
    innerTab: rt2.getActiveInner() || "todo"
  };
}
function restoreDatosModalContext() {
  ...
  var settings = typeof rt2.getSettings === "function" ? rt2.getSettings() : {};
  var targetInner = migrateGranularInner(ctx.innerTab || "todo", settings);
  if (typeof rt2.switchAppTab === "function" && ctx.appTab && typeof rt2.getActiveAppTab === "function" && rt2.getActiveAppTab() !== ctx.appTab) {
    rt2.switchAppTab(ctx.appTab);
  }
  if (typeof rt2.setActiveInner === "function" && typeof rt2.getActiveInner === "function") {
    var currentInner = migrateGranularInner(rt2.getActiveInner() || "todo", settings);
    if (currentInner !== targetInner) {
      rt2.setActiveInner(targetInner);
      if (typeof rt2.syncInnerTabVisualOnly === "function") rt2.syncInnerTabVisualOnly();
    }
  }
}
...
function closePatientDatosModal() {
  ...
  if (typeof rt2.refreshExpedienteAfterPatientSelect === "function") {
    rt2.refreshExpedienteAfterPatientSelect();
  }
}
...
async function finalizeMobilePatientCommit(patient, fromBulkPreview) {
  ...
  try {
    var access = await import("/mobile/js/chunks/clinical-access-runtime-KAV32YSL.js");
...
//# sourceMappingURL=/js/chunks/chunk-L3ORSVMJ.js.map
