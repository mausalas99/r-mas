...
function loadLabPasteRuntime() {
  return import("/mobile/js/chunks/lazy-feature-routes-5GFDJTJG.js").then(function(routes) {
    return routes.ensureLabsLoaded();
  }).then(function() {
    return Promise.all([
      import("/mobile/js/chunks/lab-bulk-preview-modal-MN2DWT2O.js"),
      import("/mobile/js/chunks/lab-panel-workbench-3IVZUQZQ.js")
    ]);
  }).then(function(mods) {
    return {
...
//# sourceMappingURL=/js/chunks/paste-smart-CKAYQ5WP.js.map
