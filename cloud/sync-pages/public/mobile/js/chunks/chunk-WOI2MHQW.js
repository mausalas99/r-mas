...
} from "/mobile/js/chunks/chunk-NMO3BDA4.js";
import {
  hydrateClinicalTeamsAfterCloudPull
} from "/mobile/js/chunks/chunk-ZKUQGQZX.js";
import {
  getClientId,
...
import {
  ensureTurnRoom
} from "/mobile/js/chunks/chunk-O7LRWY7C.js";
import {
  createOutbox
...
} from "/mobile/js/chunks/chunk-UX725VAF.js";
import {
  isCutoverDone,
  isCutoverPending,
  setCutoverFlag
...
async function refreshOnboardingHost() {
  const { refreshMainClinicalOnboardingIfNeeded } = await import("/mobile/js/chunks/clinical-onboarding-main-ZM6SYRA6.js");
...
async function scheduleOptionalPush() {
  try {
    const { scheduleCloudSyncPush } = await import("/mobile/js/chunks/mutate-bridge-7CJF23JI.js");
...
async function pushProfileToLanAndNotify(sala, needsClaim) {
  ...
  if (!localOnly && !lanPush.ok && isLanProfileNeedsConnectCode(lanPush.code)) {
    ...
    const rot = await import("/mobile/js/chunks/clinical-rotation-entry-2SRV3X5Y.js");
...
async function renderCompletedOnboarding(host) {
  if (needsTeamOnboardingStep()) {
    const { renderTeamOnboardingInto, wireTeamOnboardingInteractions } = await import("/mobile/js/chunks/clinical-onboarding-team-3CFZFWQC.js");
  ...
  if (host.closest("#clinical-teams-panel-body")) {
    const { renderClinicalTeamsPanel } = await import("/mobile/js/chunks/clinical-teams-DUFQHK54.js");
...
async function renderNoSessionOnboarding(host) {
  ...
  const { buildOnboardingSessionBlockHtml } = await import("/mobile/js/chunks/clinical-onboarding-main-ZM6SYRA6.js");
...
async function renderOnboardingPanelInto(host) {
  ...
  if (isClinicalLocalOnlyMode(settings)) {
    ...
    const { wireOnboardingSessionRecoveryOnce } = await import("/mobile/js/chunks/clinical-onboarding-main-ZM6SYRA6.js");
...
//# sourceMappingURL=/js/chunks/chunk-WOI2MHQW.js.map
