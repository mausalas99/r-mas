...
function loadLabPasteRuntime() {
  return import("/mobile/js/chunks/lazy-feature-routes-ZCXKOWSO.js").then(function(routes) {
    return routes.ensureLabsLoaded();
  }).then(function() {
    return Promise.all([
      import("/mobile/js/chunks/lab-bulk-preview-modal-KRWBV7AZ.js"),
      import("/mobile/js/chunks/lab-panel-workbench-KEBPXX5W.js")
    ]);
  }).then(function(mods) {
    return {
...
//# sourceMappingURL=/js/chunks/paste-smart-A3REWYM7.js.map
