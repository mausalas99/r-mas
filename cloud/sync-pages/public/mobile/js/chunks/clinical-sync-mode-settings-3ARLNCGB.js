...
async function refreshChromeAfterLocalOnlyExit() {
  try {
    const { closeSettingsDropdown, syncTeamSyncHeaderButton } = await import("/mobile/js/chunks/settings-dropdown-SLVV4MQP.js");
  ...
  try {
    const main = await import("/mobile/js/chunks/clinical-onboarding-main-ZRF46NME.js");
    await main.refreshMainClinicalOnboardingIfNeeded();
  } catch (_e) {
    void _e;
  }
  try {
    const rot = await import("/mobile/js/chunks/clinical-rotation-entry-GU2XTJ4K.js");
...
async function enableClinicalLanFromSettings() {
  ...
  setClinicalSyncModeLocalOnly(false);
  try {
    const lan = await import("/mobile/js/chunks/mutate-bridge-SSVVHAFB.js");
...
//# sourceMappingURL=/js/chunks/clinical-sync-mode-settings-3ARLNCGB.js.map
