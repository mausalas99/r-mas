...
function loadLabPasteRuntime() {
  return import("/mobile/js/chunks/lazy-feature-routes-ZJDGXVX3.js").then(function(routes) {
    return routes.ensureLabsLoaded();
  }).then(function() {
    return Promise.all([
      import("/mobile/js/chunks/lab-bulk-preview-modal-TCCQNTA5.js"),
      import("/mobile/js/chunks/lab-panel-workbench-RXZNMX62.js")
    ]);
  }).then(function(mods) {
    return {
...
//# sourceMappingURL=/js/chunks/paste-smart-DVLKFOFD.js.map
