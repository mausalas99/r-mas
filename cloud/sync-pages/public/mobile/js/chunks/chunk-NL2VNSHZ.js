...
var commandPaletteWindowHandlersLazy = buildLazyWindowHandlers(
  ...
  function() {
    return import("/mobile/js/chunks/command-palette-KWT3SPW7.js");
  }
);
var clinicalSyncModeSettingsHandlersLazy = buildLazyWindowHandlers(
  ...
  function() {
    return import("/mobile/js/chunks/clinical-sync-mode-settings-JWOQ24TK.js");
  }
);
...
function ensureChartsLoaded() {
  ...
  if (!chartsPromise) {
    chartsPromise = Promise.all([
      import("/mobile/js/chunks/tendencias-FCBSDBFM.js"),
...
function ensureSettingsHelpLoaded() {
  ...
  if (!settingsHelpPromise) {
    settingsHelpPromise = import("/mobile/js/chunks/settings-help-GC2YZCM7.js").then(function(mod) {
...
function ensurePlatformLoaded() {
  ...
  if (!platformPromise) {
    platformPromise = import("/mobile/js/chunks/platform-QXAY5X5Y.js").then(function(mod) {
      platformModule = mod;
...
function ensureEntregaLoaded() {
  ...
  if (!entregaPromise) {
    entregaPromise = import("/mobile/js/chunks/clinical-entrega-LVO6RJ7F.js").then(function(mod) {
      entregaModule = mod;
      return mod;
    });
  }
...
function ensureEaVitalHistoryLoaded() {
  ...
  if (!eaVitalHistoryPromise) {
    eaVitalHistoryPromise = import("/mobile/js/chunks/estado-actual-vital-history-modal-TPH2GI3Z.js").then(function(mod) {
...
function ensureLabsLoaded() {
  ...
  if (!labsPromise) {
    labsPromise = import("/mobile/js/chunks/lab-panel-5UGNCPQ2.js").then(function(mod) {
      labsModule = mod;
...
//# sourceMappingURL=/js/chunks/chunk-NL2VNSHZ.js.map
