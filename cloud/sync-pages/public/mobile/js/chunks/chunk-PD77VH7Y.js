...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/mobile/js/chunks/entrega-roster-panel-XGOQL2MM.js").then(({ closeEntregaRosterPanel }) => {
      closeEntregaRosterPanel();
    });
    void import("/mobile/js/chunks/clinical-entrega-CKPZGXS4.js").then(({ endEntregaPhase }) => {
      endEntregaPhase();
    });
    void import("/mobile/js/chunks/guardia-phase-bar-O2GY5SY2.js").then(({ teardownGuardiaPhaseBar }) => {
...
//# sourceMappingURL=/js/chunks/chunk-PD77VH7Y.js.map
