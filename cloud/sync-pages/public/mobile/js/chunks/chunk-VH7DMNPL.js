...
async function pushCloudCensusNow() {
  ...
  const { collectPatientEntriesForCloudPush } = await import("/mobile/js/chunks/cloud-census-collect-WJXTLGOM.js");
  ...
  try {
    ...
    void import("/mobile/js/chunks/lab-sync-diagnostics-4XJAKVHX.js").then(function(labDiag) {
...
async function collectCloudBundleOps(meta) {
  ...
  } = await import("/mobile/js/chunks/cloud-census-collect-WJXTLGOM.js");
  const entries = await collectPatientEntriesForCloudPush();
  ...
  const {
    ...
    pushOpsToSalaRoom
  } = await import("/mobile/js/chunks/cloud-census-sala-push-NUJHVZDI.js");
...
function enqueueCloudLabSidecarsForPatient(patientId) {
  ...
  void import("/mobile/js/chunks/cloud-census-sala-push-NUJHVZDI.js").then(async function(mod) {
    const { getClinicalScopeContextForEvaluate } = await import("/mobile/js/chunks/clinical-access-runtime-OFZ4WTIT.js");
    const scopeCtx = getClinicalScopeContextForEvaluate();
...
function enqueueCloudPatientAdmit(patient) {
  ...
  void (async function() {
    const mod = await import("/mobile/js/chunks/cloud-census-sala-push-NUJHVZDI.js");
    const { getClinicalScopeContextForEvaluate } = await import("/mobile/js/chunks/clinical-access-runtime-OFZ4WTIT.js");
    const scopeCtx = getClinicalScopeContextForEvaluate();
...
async function pushCloudClinicalOpsNow() {
  ...
  const { pushClinicalOpsForSalas, listLocalTeamSalas, pushClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-QBGEN6LN.js");
...
//# sourceMappingURL=/js/chunks/chunk-VH7DMNPL.js.map
