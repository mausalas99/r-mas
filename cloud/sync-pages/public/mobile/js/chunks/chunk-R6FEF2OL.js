import {
  ...
  runMigrationProbe,
  tryAutoUnlockDb
} from "/mobile/js/chunks/chunk-KWIGON6B.js";
import {
  isDbMode
...
function finishUnlockFlow(result) {
  ...
  void import("/mobile/js/chunks/db-unlock-completion-EBM6OCRP.js").then((mod) => mod.applyClinicalDbUnlockCompletion());
}
...
function syncDbSecuritySectionUi() {
  ...
  void import("/mobile/js/chunks/settings-dropdown-TVRS2TGZ.js").then(function(m) {
...
async function retryClinicalDbUnlockForOnboarding() {
  const { isDbMode: isDbMode2 } = await import("/mobile/js/chunks/db-storage-bridge-62UAGY7B.js");
...
//# sourceMappingURL=/js/chunks/chunk-R6FEF2OL.js.map
