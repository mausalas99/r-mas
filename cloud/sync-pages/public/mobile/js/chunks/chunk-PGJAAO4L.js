...
} from "/mobile/js/chunks/chunk-RJF23Y2T.js";
import {
  hideTourIntroModal,
...
function ensureConnectionExpandedForTour(_stepId) {
  ...
  void import("/mobile/js/chunks/panel-conexion-tour-KLDTVA5F.js").then(function(m) {
...
function applyGuardiaTourLayoutForStep(stepId) {
  void import("/mobile/js/chunks/tour-guards-BTBYLE5G.js").then((guards) => {
    ...
    if (guards.shouldShowGuardiaBoardWithoutEntrega(stepId)) {
      void Promise.all([
        import("/mobile/js/chunks/clinical-entrega-LBPLXH6K.js"),
        import("/mobile/js/chunks/entrega-roster-panel-IHRBZWTK.js")
      ]).then(([entrega, roster]) => {
    ...
    if (guards.shouldOpenEntregaRosterForTour(stepId)) {
      void import("/mobile/js/chunks/clinical-entrega-LBPLXH6K.js").then((entrega) => {
        ...
        void import("/mobile/js/chunks/entrega-roster-panel-IHRBZWTK.js").then((roster) => {
...
function seedIcBoardDemoForTour() {
  void import("/mobile/js/chunks/interconsulta-demo-toggle-Y6XU4AXQ.js").then((m) => {
    if (!m.isInterconsultaDemoActive()) m.seedInterconsultaDemoOnMainApp(/* @__PURE__ */ new Date());
  });
}
function seedIcConsultBandDemoForTour() {
  Promise.all([import("/mobile/js/chunks/patients-bridge-LBA365TC.js"), import("/mobile/js/chunks/interconsulta-mode-chrome-QJRBRFRO.js")]).then(
    ([pb, ic]) => {
...
function applyTourOverlayChromeForStep(id, t) {
  ...
  if (t.showIcBoard) {
    void import("/mobile/js/chunks/interconsulta-mode-chrome-QJRBRFRO.js").then((m) => {
...
function applyTourTargetForStep(id) {
  ...
  if (id === "gv7_trust_strip") {
    void import("/mobile/js/chunks/guardia-trust-strip-JTBGZCIZ.js").then((m) => {
...
function maybeMarkGuardiaV7ChapterComplete(stepId) {
  ...
  void import("/mobile/js/chunks/guardia-v7-progress-HEZKRSIW.js").then((m) => {
    ...
    if (m.isGuardiaV7TrackComplete()) {
      void import("/mobile/js/chunks/guardia-board-chrome-4BHOGP7Z.js").then((chrome) => {
...
async function promptMiRotacionAfterSalaTourIfNeeded(branch) {
  ...
  const { needsTeamOnboarding } = await import("/mobile/js/chunks/clinical-onboarding-5IK256U3.js");
  ...
  const { ensureClinicalPanelSession } = await import("/mobile/js/chunks/clinical-panel-host-E4N7FS4J.js");
  ...
  try {
    const { wireClinicalTeamsModalChrome } = await import("/mobile/js/chunks/teams-roster-modal-chrome-HFRP3QNC.js");
    wireClinicalTeamsModalChrome();
    const { openClinicalTeamsPanel } = await import("/mobile/js/chunks/teams-roster-GC2OQZET.js");
    await openClinicalTeamsPanel({ skipProfileGate: true });
  } catch (err) {
    console.warn("[R+] Mi rotaci\xF3n tras tutorial Sala:", err && err.message);
    const { openMiRotacion } = await import("/mobile/js/chunks/clinical-rotation-entry-M5SNTRLZ.js");
...
//# sourceMappingURL=/js/chunks/chunk-PGJAAO4L.js.map
