...
var RELEASE_NOTES_803 = [
  ...
  },
  {
    ...
    body: "En <strong>\u21C4 \u2192 Admin Nube \u2192 Equipos</strong> asignas residentes a equipos cl\xEDnicos (equipo + ciclo). Los cambios se publican a la sala por R+ Cloud."
  },
  {
...
var RELEASE_NOTES_824 = [
  {
    title: "R+ M\xF3vil (iPad/Nube) vuelve a funcionar",
    body: "El servidor exige que cada dispositivo reporte su versi\xF3n; la build web de R+ M\xF3vil no ten\xEDa forma de reportarla, as\xED que entrar y unirse al turno fallaban en silencio. Ahora la build web incluye su propia versi\xF3n."
  },
  {
    title: "Errores de red visibles en R+ M\xF3vil",
    body: "Si Entrar se quedaba pegado por mala conexi\xF3n, no hab\xEDa ning\xFAn aviso. Ahora falla con un mensaje claro a los 15 segundos."
  }
];
var RELEASE_NOTES_HIGHLIGHTS_DEFAULT = RELEASE_NOTES_824;
  ...
  void import("/mobile/js/chunks/guardia-v7-gating-HBE5TIHB.js").then(function(gating) {
    void import("/mobile/js/chunks/guardia-v7-progress-HEZKRSIW.js").then(function(progress) {
      ...
      btn.addEventListener("click", function() {
        closeReleaseNotes(RELEASE_NOTES_DEV_FORCE_SHOW);
        void import("/mobile/js/chunks/learn-hub-T2DYNN2K.js").then(function(hub) {
...
//# sourceMappingURL=/js/chunks/chunk-WQ5L4FZX.js.map
