...
var QUICK_ROUTE_HUB_MODULE = {
  id: "ch-quick-route",
  label: "Ruta r\xE1pida \xB7 mapa, alta y turno",
...
var SALA_HUB_MODULES = [
  { id: "mod-ch1", chapterId: "ch-map", label: "C\xF3mo est\xE1 armada R+", branch: "sala" },
  { id: "mod-ch2", chapterId: "ch-patient-lab", label: "Laboratorio (Labs \xB7 Tendencias \xB7 Cultivos)", branch: "sala" },
  { id: "mod-ch3", chapterId: "ch-chart", label: "Paciente \xB7 Cl\xEDnico", branch: "sala" },
  ...
  { id: "mod-ch6", chapterId: "ch-team", label: "Equipo (R+ Cloud + m\xF3vil)", branch: "sala" }
];
var IC_HUB_MODULES = IC_CHAPTERS.map((ch) => ({
  id: ch.id,
  label: ch.title,
  chapterId: ch.id,
...
function isValidStepForBranch(stepId, branch, _mode) {
...
function migrateTourStepId(stepId, branch) {
  ...
  if (branch === "interconsulta" && (stepId === "map_sidebar" || stepId === "map_add_patient" || stepId === "map_incomplete")) {
    return "ic_board_map";
  }
  return stepId;
}
...
//# sourceMappingURL=/js/chunks/chunk-MB77G5WL.js.map
