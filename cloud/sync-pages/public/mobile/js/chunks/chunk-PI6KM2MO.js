...
} from "/mobile/js/chunks/chunk-CBLIJYMM.js";
import {
  fundamentosModuleCount,
  isFundamentosChapterId,
  loadFundamentosProgress
} from "/mobile/js/chunks/chunk-X7Z3YK4X.js";
import {
  loadTourProgress
...
} from "/mobile/js/chunks/chunk-UQ6RG7U2.js";
import {
  settingsHelpBridge
...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/mobile/js/chunks/tour-runtime-Y35YMPP6.js").then((mod) => {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/mobile/js/chunks/help-content-AMGLU4NL.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-PI6KM2MO.js.map
