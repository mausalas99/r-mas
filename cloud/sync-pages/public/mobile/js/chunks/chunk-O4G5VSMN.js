...
function deferMobileWebBoot_() {
  void import("/mobile/js/chunks/app-shell-mobile-boot-GQTNASNX.js").then(function(mod) {
...
function scheduleDeferredUiInits(showToast2) {
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/productivity-SIQCF2UG.js").then(function(mod) {
      mod.initProductivityKeyboardShortcuts();
    });
  });
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/app-shell-keyboard-HMQFAEUQ.js").then(function(mod) {
      mod.initShellKeyboardShortcuts(showToast2);
    });
    void import("/mobile/js/chunks/keyboard-shortcuts-nudge-QF2ZZCDX.js").then(function(mod) {
...
function createPatientUpdateHandler(shellCtx2, syncWorkContextChrome2) {
  function refreshPatientChromeAfterUpdate() {
    ...
    void import("/mobile/js/chunks/pase-board-BPPJ6DAV.js").then(function(mod) {
      mod.renderPaseBoard();
    });
    renderRoundOverviewPanels();
    if (shellCtx2.getActiveAppTab() === "agenda") {
      void import("/mobile/js/chunks/agenda-G2FMO6BL.js").then(function(mod) {
...
function initModalDismiss() {
  void import("/mobile/js/chunks/app-shell-modals-JHO5ZLRQ.js").then(function(mod) {
    mod.initModalDismiss();
  });
}
function quickExportCurrentPatientLazy() {
  var args = arguments;
  void import("/mobile/js/chunks/clinical-quick-export-5W2P7XIQ.js").then(function(mod) {
...
function syncWorkContextChrome() {
  ...
  void import("/mobile/js/chunks/header-context-JLLNOYIT.js").then(function(mod) {
...
//# sourceMappingURL=/js/chunks/chunk-O4G5VSMN.js.map
