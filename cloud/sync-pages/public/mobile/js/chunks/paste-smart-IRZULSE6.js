...
function loadLabPasteRuntime() {
  return import("/mobile/js/chunks/lazy-feature-routes-7T2CWP4D.js").then(function(routes) {
    return routes.ensureLabsLoaded();
  }).then(function() {
    return Promise.all([
      import("/mobile/js/chunks/lab-bulk-preview-modal-LR3P3BI4.js"),
      import("/mobile/js/chunks/lab-panel-workbench-F34F3PHM.js")
    ]);
  }).then(function(mods) {
    return {
...
//# sourceMappingURL=/js/chunks/paste-smart-IRZULSE6.js.map
