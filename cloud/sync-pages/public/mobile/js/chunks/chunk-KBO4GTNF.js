...
} from "/mobile/js/chunks/chunk-XIMAN7MO.js";
import {
  esc
...
var HELP_ARTICLES = [
  ...
  },
  {
    ...
    html: "<p>El turno se sincroniza con <strong>R+ Cloud</strong> (Nube). No hace falta un Mac anfitri\xF3n en la Wi\u2011Fi del hospital.</p><ul><li><strong>\u21C4 Conexi\xF3n</strong> \u2014 cuenta Nube, sala del equipo y estado de sincronizaci\xF3n.</li><li><strong>Equipo</strong> \u2014 en <strong>\u21C4 Conexi\xF3n \u2192 Opciones \u2192 Equipo</strong>: @usuario, equipos e integrantes (se publican por clinicalOps a la sala).</li><li><strong>Directorio de usuarios</strong> \u2014 qui\xE9n est\xE1 en la sala; el admin asigna a equipos desde Equipo.</li><li><strong>iPad / R+ M\xF3vil</strong> \u2014 enlace o QR en <strong>\u21C4 \u2192 Opciones \u2192 iPad / R+ M\xF3vil</strong>; inicia sesi\xF3n con la misma cuenta Nube.</li><li><strong>QR Internos (MIP)</strong> \u2014 enlace Nube para pregrado; sin IP local ni LAN.</li><li><strong>Censo</strong> \u2014 R1 por equipo; R4 con divisores por equipo en la grilla; sync discreta en segundo plano.</li></ul>"
  },
  {
    id: "rotacion-equipos",
    ...
    html: '<p>Cada mes los equipos de guardia rotan. R+ te gu\xEDa para no perder el hilo del censo compartido.</p><ul><li><strong>Nueva rotaci\xF3n</strong> \u2014 si ya estuviste en un equipo, R+ puede pedirte confirmar sala y abrir <strong>\u21C4 \u2192 Opciones \u2192 Equipo</strong> para unirte al equipo del mes.</li><li><strong>Heredar pacientes</strong> \u2014 al unirte a un equipo nuevo, el asistente te deja traer pacientes de tu equipo anterior (misma sala/ciclo sugerido) sin reasignar uno por uno.</li><li><strong>R4 / admin</strong> \u2014 publica equipos nuevos en <strong>Equipo</strong> para que el resto se una.</li></ul><p style="font-size:13px;color:var(--text-muted);margin:0;">\xBFCenso vac\xEDo tras rotar? Confirma Nube en \u21C4, revisa la franja sala/equipo en Guardia y abre <strong>Opciones \u2192 Equipo</strong>.</p>'
  },
  {
    id: "estructura",
    title: "C\xF3mo est\xE1 armada R+",
    keywords: "estructura pesta\xF1as paciente laboratorio manejo agenda resumen clinico salida labs tendencias cultivos censo alta incompleto",
    html: "<p>Cuatro pesta\xF1as arriba: <strong>Paciente</strong>, <strong>Laboratorio</strong>, <strong>Manejo</strong> y <strong>Agenda</strong>.</p><ul><li><strong>Paciente</strong> abre en <strong>Resumen</strong>. Grupos: Resumen \xB7 Cl\xEDnico \xB7 Salida. Atajo <strong>\u2318/Ctrl+1</strong> (repite para ciclar).</li><li><strong>Laboratorio</strong>: Labs \xB7 Tendencias \xB7 Cultivos. Atajo <strong>\u2318/Ctrl+2</strong> (repite para ciclar).</li><li><strong>Manejo</strong> es la receta hospitalaria (no est\xE1 dentro de Paciente). <strong>Agenda</strong> concentra procedimientos del turno.</li><li>En <strong>Sala</strong>, la columna izquierda es el <strong>censo</strong>: <strong>+ Agregar</strong> da de alta; sin cuarto, cama o servicio la tarjeta queda incompleta.</li><li>En <strong>Interconsultas</strong> no hay columna lateral: la pesta\xF1a Paciente abre un <strong>tablero de equipos</strong> (guardia, postguardia, activo). Toca un paciente para ver su Resumen; <strong>\u2190 Tablero</strong> o <strong>Esc</strong> regresa.</li></ul>"
  },
  {
    id: "primer-paciente",
    title: "Tu primer paciente",
    keywords: "agregar paciente nuevo registro edad sexo cuarto cama duplicado incompleto alta censo",
    html: "<p>En <strong>Sala</strong>, agrega un paciente desde la barra lateral con <strong>+ Agregar</strong> o desde un reporte de laboratorio procesado (<strong>Agregar paciente</strong>). En <strong>Interconsultas</strong> (sin barra lateral) los pacientes llegan al tablero al procesar un reporte de laboratorio.</p><ul><li>Nombre y registro bastan para empezar. <strong>Cuarto</strong>, <strong>cama</strong> y <strong>servicio</strong> cierran el censo: si faltan, la tarjeta queda <strong>incompleta</strong> \u2014 \xE1brela y completa.</li><li>R+ avisa si detecta el mismo nombre o registro para evitar duplicados.</li><li>Con <strong>R+ Cloud</strong> conectado, el alta se comparte con el equipo de la sala. Sin Nube, queda en este equipo.</li></ul>"
  },
  {
    id: "nube-vs-respaldo",
  ...
  },
  {
    ...
    html: "<p>Pega el reporte del laboratorio en el cuadro de texto de la pesta\xF1a <strong>Laboratorio</strong> y pulsa <strong>Procesar</strong>. R+ reconoce biometr\xEDa, qu\xEDmica, electrolitos, gasometr\xEDa, pruebas hep\xE1ticas y m\xE1s.</p><ul><li>Dentro de Laboratorio: <strong>Labs</strong> (diagramas y tabla), <strong>Tendencias</strong> (mini-gr\xE1ficas en el tiempo) y <strong>Cultivos</strong>.</li><li>Cada diagrama tiene un bot\xF3n <strong>Copiar</strong> para pegarlo como texto en otro sistema.</li><li>Los valores fuera de rango se resaltan en rojo.</li><li>En <strong>Labs</strong> ves cada env\xEDo guardado; puedes cambiar de fecha, <strong>Consolidar</strong> env\xEDos del mismo d\xEDa o <strong>Eliminar</strong> un conjunto si fue un error.</li></ul>"
  },
  {
    id: "nota-evolucion",
    title: "Nota de evoluci\xF3n",
    keywords: "nota evolucion docx generar expediente soap vitales diagnosticos plantilla",
    html: "<p>En <strong>Paciente \u2192 Cl\xEDnico \u2192 Notas</strong> completa fecha, hora, signos vitales, interrogatorio, evoluci\xF3n, estudios, diagn\xF3sticos y tratamiento.</p><ul><li>En modo <strong>Sala</strong>, el p\xE1rrafo estructurado (N/V/HD/HI/NM) se arma en <strong>Estado actual</strong> y se copia a la nota.</li><li>En <strong>Interconsulta</strong>, desde <strong>Medicamentos</strong> puedes volcar dosis a la plantilla SOAP o al tratamiento.</li><li><strong>Generar Nota (.docx)</strong> crea el documento con membrete (generador nativo en Node); la carpeta de salida est\xE1 en <strong>Ajustes</strong>.</li><li><strong>Salida r\xE1pida</strong> exporta el paciente activo en docx, html o txt seg\xFAn el formato elegido.</li><li>Los datos se guardan por paciente en este equipo.</li></ul>"
  },
  {
    id: "eventualidades",
    title: "Eventualidades (Sala)",
    keywords: "eventualidades bitacora intercurrencia dia clinico sala registro",
    html: '<p><strong>Paciente \u2192 Cl\xEDnico \u2192 Eventualidades</strong> guarda hechos cl\xEDnicos del turno con fecha y texto libre (orden cronol\xF3gico).</p><p style="font-size:13px;color:var(--text-muted);margin:0;">Complementa <strong>Estado actual</strong> (monitoreo estructurado). No sustituye la nota de evoluci\xF3n en Interconsulta.</p>'
  },
  {
    id: "estado-actual",
  ...
  },
  {
    ...
    html: "<p>R+ busca nuevas versiones al iniciar y, en silencio, al usar <strong>Actualizar labs</strong> o al cambiar de paciente (como m\xE1ximo cada 30 min). Si hay una versi\xF3n nueva, aparece el modal de descarga; si ya est\xE1s al d\xEDa, no interrumpe.</p><ul><li>Puedes buscar manualmente desde <strong>Ajustes \u2192 Buscar actualizaciones\u2026</strong> o el men\xFA nativo (Mac: R+; Windows: Aplicaci\xF3n). Esa b\xFAsqueda s\xED avisa si R+ ya est\xE1 actualizado.</li><li><strong>Restaurar versi\xF3n estable</strong>: en Ajustes \u2192 Aplicaci\xF3n, elige una versi\xF3n anterior curada y confirma. R+ intenta instalarla como una actualizaci\xF3n; si falla (p. ej. firma en Mac), abre el instalador correcto en GitHub. Tus datos locales no se borran.</li><li>Si la versi\xF3n elegida est\xE1 por debajo del m\xEDnimo soportado, R+ bloquea la restauraci\xF3n autom\xE1tica.</li><li>Al detectar una versi\xF3n nueva instalada, R+ muestra una ventana de <strong>Novedades</strong> con los cambios relevantes.</li></ul>"
  },
  {
    id: "atajos",
    title: "Atajos de teclado",
    keywords: "atajos shortcuts teclado ctrl cmd escape tab flechas censo paciente",
    html: '<p>Ahorra tiempo con estos atajos:</p><ul><li><strong>Ctrl/\u2318 + \u21A9</strong> \u2014 Volver a Resumen (desde cualquier sitio, incluso con un campo o modal abierto)</li><li><strong>Ctrl/\u2318 + 1</strong> \u2014 Paciente \xB7 <strong>2</strong> \u2014 Laboratorio \xB7 <strong>3</strong> \u2014 Manejo \xB7 <strong>4</strong> \u2014 Agenda. <strong>Repite el mismo n\xFAmero</strong> para ciclar subvistas: <strong>1</strong> Resumen\u2192Cl\xEDnico\u2192Salida \xB7 <strong>2</strong> Labs\u2192Tendencias\u2192Cultivos \xB7 <strong>3</strong> Manejo\u2194Perfil \xB7 <strong>4</strong> semana actual</li><li><strong>Ctrl/\u2318 + Shift + 3</strong> \u2014 Completa \u2194 Nombre+D\xEDa (texto de egreso en Manejo actual)</li><li><strong>Ctrl/\u2318 + [</strong> / <strong>]</strong> \u2014 Semana anterior / siguiente en Agenda</li><li><strong>Ctrl/\u2318 + ,</strong> \u2014 Ajustes</li><li><strong>\u2193</strong> / <strong>\u2191</strong> \u2014 Paciente siguiente / anterior en el censo (no aplica al escribir en un campo)</li><li><strong>Ctrl/\u2318 + N</strong> \u2014 Nuevo paciente</li><li><strong>Ctrl/\u2318 + G</strong> \u2014 Modo Guardia \xB7 <strong>I</strong> \u2014 Interconsulta \xB7 <strong>S</strong> \u2014 Sala</li><li><strong>Ctrl/\u2318 + E</strong> \u2014 Estado actual (en EA \u2192 Eventualidades en Sala) \xB7 <strong>T</strong> \u2014 Tendencias (en tendencias \u2192 Cultivos) \xB7 <strong>D</strong> \u2014 Datos del paciente \xB7 <strong>M</strong> \u2014 Manejo (cicla subvistas)</li><li><strong>Ctrl/\u2318 + Shift + S</strong> \u2014 Guardar estado del paciente activo</li><li><strong>Ctrl/\u2318 + /</strong> \u2014 Mostrar la hoja de atajos (tambi\xE9n el bot\xF3n del encabezado)</li><li><strong>Ctrl/\u2318 + K</strong> \u2014 Ir a secci\xF3n o paciente</li><li><strong>Ctrl/\u2318 + Shift + P</strong> \u2014 Abrir/cerrar Mi Perfil</li><li><strong>Ctrl/\u2318 + Shift + ,</strong> \u2014 Activa/desactiva <strong>sobrescribir</strong> en conflictos al importar JSON (sin preguntar)</li><li><strong>Esc</strong> o clic fuera \u2014 Cerrar ventana modal, men\xFAs o el centro de ayuda</li><li>Dentro del centro de ayuda: <strong>\u2193</strong> desde el buscador enfoca la lista; <strong>\u2191 / \u2193</strong> navegan art\xEDculos.</li></ul><p style="font-size:13px;color:var(--text-muted);margin:12px 0 0;">Si cambias mucho de pesta\xF1a con el mouse, R+ puede sugerirte estos atajos tras varios clics (sin l\xEDmite de tiempo); dejan de aparecer cuando empiezas a usarlos.</p>'
  },
  {
    id: "privacidad",
...
//# sourceMappingURL=/js/chunks/chunk-KBO4GTNF.js.map
