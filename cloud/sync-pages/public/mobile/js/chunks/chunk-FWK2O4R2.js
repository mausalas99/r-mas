...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/mobile/js/chunks/clinical-rotation-entry-4N3VIZZF.js").then((m) => m.syncClinicalRotationEntryChrome());
  void import("/mobile/js/chunks/tour-engine-6WS3W3GU.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/mobile/js/chunks/learn-hub-IXQJUWWN.js").then((m) => {
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/mobile/js/chunks/settings-dropdown-J5YSBSSQ.js");
...
//# sourceMappingURL=/js/chunks/chunk-FWK2O4R2.js.map
