...
import {
  getUserSala
} from "/mobile/js/chunks/chunk-VLTPCB4L.js";
import {
  escapeHtml
...
async function mountCloudConnectionPanel(root, deps) {
  ...
  const { shouldShowNubePanel } = await import("/mobile/js/chunks/nube-sync-policy-S57IHQAN.js");
  ...
  const { createCloudSyncApi } = await import("/mobile/js/chunks/api-client-756TIOR3.js");
  const { getSessionAdminKey } = await import("/mobile/js/chunks/panel-admin-EHBZZMIW.js");
  const { mountNubeSection } = await import("/mobile/js/chunks/panel-nube-section-Y76SI33O.js");
  const { setCloudRoomConnected } = await import("/mobile/js/chunks/nube-sync-policy-S57IHQAN.js");
  ...
  _cloudNubeMount = mountNubeSection(root, {
    ...
    onCloudRoomChange: function(connected) {
      ...
      try {
        void import("/mobile/js/chunks/clinical-rotation-entry-HJMTCXVR.js").then((m) => m.syncClinicalRotationEntryChrome?.());
      } catch {
      }
    }
  });
...
function getRuntime() {
  return {
    showToast(msg, kind) {
      try {
        import("/mobile/js/chunks/app-shell-MU274FJL.js").then((m) => m.showToast?.(msg, kind));
      } catch {
      }
    },
    closeSettingsDropdown() {
      try {
        import("/mobile/js/chunks/app-shell-MU274FJL.js").then((m) => m.closeSettingsDropdown?.());
      } catch {
      }
    }
  };
...
//# sourceMappingURL=/js/chunks/chunk-3GQWNHJN.js.map
