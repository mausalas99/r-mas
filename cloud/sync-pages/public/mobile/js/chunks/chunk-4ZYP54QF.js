...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/mobile/js/chunks/entrega-roster-panel-XPPSHP76.js").then(({ closeEntregaRosterPanel }) => {
      closeEntregaRosterPanel();
    });
    void import("/mobile/js/chunks/clinical-entrega-IXHOGSNQ.js").then(({ endEntregaPhase }) => {
      endEntregaPhase();
    });
    void import("/mobile/js/chunks/guardia-phase-bar-DUTRD3CO.js").then(({ teardownGuardiaPhaseBar }) => {
...
function setUiDensity(mode) {
  ...
  void import("/mobile/js/chunks/clinical-rotation-entry-OY24Q6TU.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-4ZYP54QF.js.map
