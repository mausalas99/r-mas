...
import {
  getUserSala
} from "/mobile/js/chunks/chunk-6OGC4PQJ.js";
import {
  closeModalAnimated
...
async function mountCloudConnectionPanel(root, deps) {
  const { shouldShowNubePanel } = await import("/mobile/js/chunks/lan-override-ZNP7RWGE.js");
  ...
  const { getSessionAdminKey } = await import("/mobile/js/chunks/panel-admin-NS4HLP5H.js");
  const { mountNubeSection } = await import("/mobile/js/chunks/panel-nube-section-6EVW6K2N.js");
  const { setCloudRoomConnected } = await import("/mobile/js/chunks/lan-override-ZNP7RWGE.js");
...
function getRuntime() {
  return {
    showToast(msg, kind) {
      try {
        import("/mobile/js/chunks/app-shell-IJZKTG6P.js").then((m) => m.showToast?.(msg, kind));
      } catch {
      }
    },
    closeSettingsDropdown() {
      try {
        import("/mobile/js/chunks/app-shell-IJZKTG6P.js").then((m) => m.closeSettingsDropdown?.());
      } catch {
      }
    }
  };
...
//# sourceMappingURL=/js/chunks/chunk-ZMCDERYV.js.map
