...
} from "/mobile/js/chunks/chunk-SLEQU5CJ.js";
import {
...
var settingsModalChromeWired = false;
var settingsSplitPaneWired = false;
...
function focusSettingsDropdownEntry() {
  ...
  var host = document.getElementById("settings-panels") || document.getElementById("settings-dropdown-scroll") || document.getElementById("settings-dropdown");
  if (!host) return;
  var target = host.querySelector(".btn-settings-help-primary") || host.querySelector("button, summary, [href], input, select, textarea");
...
function initSettingsSplitPane() {
  ...
  items.forEach(function(det, index) {
    ...
    var label = summary ? summary.textContent.trim() : "Secci\xF3n";
...
function toggleSettingsDropdown() {
  ...
  void import("/mobile/js/chunks/clinical-sync-mode-settings-5TIM6LHQ.js").then((m) => {
...
//# sourceMappingURL=/js/chunks/chunk-5QPKU4WX.js.map
