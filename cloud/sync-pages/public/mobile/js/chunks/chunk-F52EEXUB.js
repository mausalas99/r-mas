...
function isCloudLabOpPoison(path) {
  return readLabPoisonPaths().has(String(path || "").trim());
}
function shouldSkipCloudLabSidecarPush(patientId, set, setId) {
...
var CLOUD_PUSH_WARN_BODY_BYTES = 200 * 1024;
var CLOUD_PUSH_WARN_OP_BYTES = 180 * 1024;
var CLOUD_LAB_SET_ALLOWLIST = ["id", "fecha", "hora", "resLabs", "bhExtras"];
...
//# sourceMappingURL=/js/chunks/chunk-F52EEXUB.js.map
