...
} from "/mobile/js/chunks/chunk-F22TO3UT.js";
import {
...
function hideMainClinicalOnboarding() {
  ...
  if (host) host.remove();
  void import("/mobile/js/chunks/clinical-rotation-entry-OY24Q6TU.js").then((m) => m.syncClinicalRotationEntryChrome());
  void import("/mobile/js/chunks/tour-engine-UX2WDYG5.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/mobile/js/chunks/learn-hub-PMG4DVJN.js").then((m) => {
...
async function showMainClinicalOnboardingBody() {
  ...
  try {
    const { fetchClinicalTeamsFromDb } = await import("/mobile/js/chunks/clinical-access-runtime-D63B6FH7.js");
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/mobile/js/chunks/settings-dropdown-SVEJTOG6.js");
...
//# sourceMappingURL=/js/chunks/chunk-RU3FUJKX.js.map
