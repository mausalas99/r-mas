import {
  ...
  getSalaRoomCache
} from "/mobile/js/chunks/chunk-S2WKHVXQ.js";
...
import {
  pushCloudOpsDirect
} from "/mobile/js/chunks/chunk-HT2CLYXO.js";
...
async function buildPatientCensusMirrorOps(patient, actorId) {
  ...
  try {
    const { buildPatientEntry } = await import("/mobile/js/chunks/patients-modal-commit-W7YXHPIN.js");
...
async function repairCensusSalasFromTeamAssignments(opts = {}) {
  ...
  const { pushClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-FWUW5UL4.js");
  for (const sala of clinicalOpsSalas) {
    await pushClinicalOpsForSala(sala).catch(() => null);
  }
  try {
    const bridge = await import("/mobile/js/chunks/mutate-bridge-SSVVHAFB.js");
...
//# sourceMappingURL=/js/chunks/cloud-census-sala-push-EDA764K3.js.map
