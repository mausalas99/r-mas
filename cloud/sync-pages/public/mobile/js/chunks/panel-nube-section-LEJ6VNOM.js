...
} from "/mobile/js/chunks/chunk-JCUQ27JT.js";
import {
  applyConexionView,
  authFormsHtml,
  conexionShellHtml,
...
function mountAdminShell(section, deps, toast) {
  ...
  async function ensureAdminOpen() {
    ...
    if (!host) return;
    if (!adminMount) {
      const { mountCloudAdminPanel } = await import("/mobile/js/chunks/panel-admin-WMCC6TVL.js");
      host.textContent = "";
...
function createEnsureTurn(deps, ui) {
  ...
  return async function tryAutoEnsureTurnRoom() {
    ...
    const { ensureTurnRoom } = await import("/mobile/js/chunks/ensure-turn-room-3NEIT5HX.js");
...
//# sourceMappingURL=/js/chunks/panel-nube-section-LEJ6VNOM.js.map
