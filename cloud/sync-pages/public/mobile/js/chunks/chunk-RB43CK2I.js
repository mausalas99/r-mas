...
async function applyClinicalOpsSnapshot(clinicalOps) {
  ...
  try {
    const { isClinicalOpsLanAvailable, applyClinicalOpsLanSnapshot, refreshClinicalOpsSnapshotCache } = await import("/mobile/js/chunks/clinical-ops-sync-PLIALYMP.js");
    ...
    if (applied) {
      const { hydrateClinicalTeamsAfterCloudPull } = await import("/mobile/js/chunks/clinical-ops-hydrate-C4VWADEG.js");
...
async function refreshCloudTodoUIs(patientIds) {
  ...
  try {
    const mod = await import("/mobile/js/chunks/todos-refresh-J54QTZWM.js");
...
async function refreshSidebarAfterCloudPull(result) {
  ...
  try {
    const { renderPatientList } = await import("/mobile/js/chunks/patients-KV425J4Y.js");
...
//# sourceMappingURL=/js/chunks/chunk-RB43CK2I.js.map
