...
function buildOnboardingBootLoadingHtml(opts = {}) {
  const title = opts.title || "Preparando R+";
  const message = opts.message || "Iniciando R+\u2026";
  const stepper = opts.stepperIndex != null ? buildClinicalOnboardingStepperHtml(
    /** @type {1|2|3} */
    opts.stepperIndex
  ) : "";
  return `
...
var MODE_NUBE_ICON = `<svg class="clinical-onboard-mode-card-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z"/></svg>`;
  ...
  return `
        <div class="clinical-onboard-mode-grid" role="group" aria-label="Modo de uso">
          <button type="button" class="clinical-onboard-mode-card clinical-onboard-mode-card--primary" data-sync-mode="nube">
            ...
            <span class="clinical-onboard-mode-card-desc">Crea tu @usuario, elige rotaci\xF3n y sincroniza censo y equipos por <strong>Nube</strong>.</span>
          </button>
          <button type="button" class="clinical-onboard-mode-card" data-sync-mode="existing">
            ...
            <span class="clinical-onboard-mode-card-desc">Inicia sesi\xF3n en Nube, recuerda este dispositivo y restaura tu censo y <strong>Mi rotaci\xF3n</strong>.</span>
          </button>
...
//# sourceMappingURL=/js/chunks/chunk-JAVEC37I.js.map
