...
function splitLabOpsIntoOutboxItems(patientId, ops, baseRevision) {
...
async function pushCloudCensusNow() {
  ...
  const { collectPatientEntriesForCloudPush } = await import("/mobile/js/chunks/cloud-census-collect-YE55DTUI.js");
  ...
  try {
    ...
    const { pushCloudOpsDirect } = await import("/mobile/js/chunks/cloud-push-direct-O767ABS2.js");
    ...
    void import("/mobile/js/chunks/lab-sync-diagnostics-64CSW3CR.js").then(function(labDiag) {
...
async function collectCloudBundleOps(meta) {
  ...
  } = await import("/mobile/js/chunks/cloud-census-collect-YE55DTUI.js");
  const entries = await collectPatientEntriesForCloudPush();
  ...
  const {
    ...
    pushOpsToSalaRoom
  } = await import("/mobile/js/chunks/cloud-census-sala-push-FUYE5QJF.js");
...
function enqueueCloudLabSidecarsForPatient(patientId) {
  ...
  void import("/mobile/js/chunks/cloud-census-sala-push-FUYE5QJF.js").then(async function(mod) {
    const { getClinicalScopeContextForEvaluate } = await import("/mobile/js/chunks/clinical-access-runtime-3IIQQT2K.js");
    const scopeCtx = getClinicalScopeContextForEvaluate();
...
function enqueueCloudPatientAdmit(patient) {
  ...
  void (async function() {
    const mod = await import("/mobile/js/chunks/cloud-census-sala-push-FUYE5QJF.js");
    const { getClinicalScopeContextForEvaluate } = await import("/mobile/js/chunks/clinical-access-runtime-3IIQQT2K.js");
    const scopeCtx = getClinicalScopeContextForEvaluate();
...
async function pushCloudClinicalOpsNow() {
  ...
  const { pushClinicalOpsForSalas, listLocalTeamSalas, pushClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-6EU24WFI.js");
...
//# sourceMappingURL=/js/chunks/chunk-B7NNRK4H.js.map
