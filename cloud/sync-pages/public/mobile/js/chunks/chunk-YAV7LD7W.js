...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/mobile/js/chunks/entrega-roster-panel-VEO7JBFR.js").then(({ closeEntregaRosterPanel }) => {
      closeEntregaRosterPanel();
    });
    void import("/mobile/js/chunks/clinical-entrega-CMS6USA5.js").then(({ endEntregaPhase }) => {
      endEntregaPhase();
    });
    void import("/mobile/js/chunks/guardia-phase-bar-GV4CYJK7.js").then(({ teardownGuardiaPhaseBar }) => {
...
function setUiDensity(mode) {
  ...
  void import("/mobile/js/chunks/clinical-rotation-entry-M2UXTZ6K.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-YAV7LD7W.js.map
