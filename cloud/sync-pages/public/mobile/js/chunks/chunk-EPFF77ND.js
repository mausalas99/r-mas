...
async function mountCloudConnectionPanel(root, deps) {
  ...
  const { shouldShowNubePanel } = await import("/mobile/js/chunks/nube-sync-policy-R57E3IIE.js");
  ...
  const settings = await import("/mobile/js/chunks/settings-X3WJCWR2.js");
  const { createCloudSyncApi } = await import("/mobile/js/chunks/api-client-AG6QZENB.js");
  const { getSessionAdminKey } = await import("/mobile/js/chunks/panel-admin-PV76ZGJ3.js");
  const { mountNubeSection } = await import("/mobile/js/chunks/panel-nube-section-O52O5XGZ.js");
  const { setCloudRoomConnected } = await import("/mobile/js/chunks/nube-sync-policy-R57E3IIE.js");
  ...
  _cloudNubeMount = mountNubeSection(root, {
    ...
    onCloudRoomChange: function(connected) {
      ...
      try {
        void import("/mobile/js/chunks/clinical-rotation-entry-KWXHGOOS.js").then((m) => m.syncClinicalRotationEntryChrome?.());
      } catch {
      }
    }
  });
...
function getRuntime() {
  return {
    showToast(msg, kind) {
      try {
        import("/mobile/js/chunks/app-shell-CYKX4DYP.js").then((m) => m.showToast?.(msg, kind));
      } catch {
      }
    },
    closeSettingsDropdown() {
      try {
        import("/mobile/js/chunks/app-shell-CYKX4DYP.js").then((m) => m.closeSettingsDropdown?.());
      } catch {
      }
    }
  };
...
function setConnectionDropdownOpen(open) {
  ...
  void renderConnectionPanel({ force: true, runtime: getRuntime }).then(function() {
    return import("/mobile/js/chunks/panel-conexion-tour-ERBJFOY2.js").then(function(m) {
...
//# sourceMappingURL=/js/chunks/chunk-EPFF77ND.js.map
