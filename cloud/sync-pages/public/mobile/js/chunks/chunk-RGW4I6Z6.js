...
} from "/mobile/js/chunks/chunk-WOI2MHQW.js";
import {
...
async function handleClinicalRegistrationSubmit(deps) {
  ...
  const { refreshClinicalUserProfile } = await import("/mobile/js/chunks/clinical-access-runtime-KABKCTTJ.js");
  await refreshClinicalUserProfile();
  deps.closeModal();
  maybePersistMobilePairing_();
  resolvePendingRegistration_(deps);
  try {
    const { refreshMainClinicalOnboardingIfNeeded: refreshMainClinicalOnboardingIfNeeded2 } = await import("/mobile/js/chunks/clinical-onboarding-main-ZM6SYRA6.js");
...
function hideMainClinicalOnboarding() {
  ...
  void import("/mobile/js/chunks/tour-engine-OLESMIIZ.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/mobile/js/chunks/learn-hub-TVBSABBF.js").then((m) => {
...
async function showMainClinicalOnboardingBody() {
  ...
  try {
    const { fetchClinicalTeamsFromDb } = await import("/mobile/js/chunks/clinical-access-runtime-KABKCTTJ.js");
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/mobile/js/chunks/settings-dropdown-2FWJ37B5.js");
...
//# sourceMappingURL=/js/chunks/chunk-RGW4I6Z6.js.map
