...
import {
  ensureTurnRoom
} from "/mobile/js/chunks/chunk-YSBJHYC4.js";
import {
  loadCutoverSnapshot,
  shouldShowCutoverWizard
} from "/mobile/js/chunks/chunk-JYYMJKCB.js";
import {
  isCutoverDone,
  isCutoverPending,
  setCutoverFlag
...
async function refreshOnboardingHost() {
  const { refreshMainClinicalOnboardingIfNeeded } = await import("/mobile/js/chunks/clinical-onboarding-main-6UO2PEEB.js");
...
async function scheduleOptionalPush() {
  try {
    const { scheduleCloudSyncPush } = await import("/mobile/js/chunks/mutate-bridge-AKDBX5VY.js");
...
async function renderCompletedOnboarding(host) {
  ...
  if (host.closest("#clinical-teams-panel-body")) {
    const { renderClinicalTeamsPanel } = await import("/mobile/js/chunks/clinical-teams-6PKG6CM7.js");
...
async function renderNoSessionOnboarding(host) {
  ...
  const { buildOnboardingSessionBlockHtml } = await import("/mobile/js/chunks/clinical-onboarding-main-6UO2PEEB.js");
...
async function renderOnboardingPanelInto(host) {
  ...
  if (isClinicalLocalOnlyMode(settings)) {
    ...
    const { wireOnboardingSessionRecoveryOnce } = await import("/mobile/js/chunks/clinical-onboarding-main-6UO2PEEB.js");
...
//# sourceMappingURL=/js/chunks/chunk-J6VINJP7.js.map
