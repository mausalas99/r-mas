...
// lib/historia-clinica/migrate-legacy-fields.mjs
function hasLegacyFlatHistoriaFields(legacy) {
  return typeof legacy.ficha === "string" || typeof legacy.ahf === "string" || typeof legacy.app === "string" || typeof legacy.apnp === "string" || typeof legacy.peea === "string";
}
function migrateLegacyFicha(out, legacy) {
...
function migrateLegacyApp(out, legacy) {
...
function migrateLegacyAhf(out, legacy) {
...
function migrateLegacyApnpPeea(out, legacy) {
...
//# sourceMappingURL=/js/chunks/chunk-ZRPAKVXD.js.map
