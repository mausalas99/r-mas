...
async function deleteProcedureAgendaFromModal() {
  var editId = (document.getElementById("pa-edit-id").value || "").trim();
  if (!editId) return;
  var result = await openConfirm({
    weight: "destructive",
    title: "\xBFEliminar este procedimiento de la agenda? No se puede deshacer desde aqu\xED.",
...
//# sourceMappingURL=/js/chunks/chunk-7I4MHGPD.js.map
