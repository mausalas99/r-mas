...
} from "/mobile/js/chunks/chunk-H6H7IXWV.js";
import {
...
function wireGuardiaV7UpgradeCardOnce(el) {
  ...
  el.querySelector("#guardia-v7-upgrade-start")?.addEventListener("click", () => {
    ...
    void import("/mobile/js/chunks/tour-runtime-GJIQBT2E.js").then((mod) => {
...
function maybeShowGuardiaV7UpgradeCard({ delayMs = 0 } = {}) {
  ...
  const run = () => {
    ...
    el.innerHTML = '<h3 class="clinical-onboarding-title">Novedades de guardia</h3><p class="guardia-v7-upgrade-progress" aria-live="polite">Progreso: <strong>' + progress.completed + "/" + progress.total + "</strong> cap\xEDtulos (" + progress.percent + '%)</p><div class="guardia-v7-upgrade-meter" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="' + progress.percent + '"><span class="guardia-v7-upgrade-meter-fill" style="width:' + progress.percent + '%"></span></div><ul class="guardia-v7-upgrade-bullets"><li><strong>Modo Guardia</strong> \u2014 tablero de turno, censo y alcance por rango.</li><li><strong>Modo Entrega</strong> \u2014 handoff por paciente, roster y pendientes.</li><li><strong>R+ Cloud</strong> \u2014 sala Nube, equipos y enlace m\xF3vil desde \u21C4.</li></ul><div class="modal-actions guardia-v7-upgrade-actions"><button type="button" class="btn-save" id="guardia-v7-upgrade-start">' + startLabel + '</button><button type="button" class="btn-med-secondary" id="guardia-v7-upgrade-later">Ver despu\xE9s</button></div>';
    main.prepend(el);
...
//# sourceMappingURL=/js/chunks/chunk-OISKLUV5.js.map
