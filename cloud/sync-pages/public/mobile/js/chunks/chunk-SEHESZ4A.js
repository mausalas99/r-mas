...
} from "/mobile/js/chunks/chunk-RBUONLJQ.js";
import {
...
async function ensureClinicalPanelSession(opts = {}) {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/mobile/js/chunks/db-unlock-HJ73Z62W.js");
...
async function publishClinicalTeamsToSync() {
  try {
    const mod = await import("/mobile/js/chunks/mutate-bridge-clinical-ops-D3JL4VIH.js");
...
async function pullClinicalOpsFromCloudRoom(options = {}) {
  ...
  cloudClinicalOpsPullInFlight = (async () => {
    try {
      ...
      const { clinicalSessionContext: clinicalSessionContext2 } = await import("/mobile/js/chunks/clinical-access-runtime-OFZ4WTIT.js");
      ...
      if (!salas.length) {
        const { autostartCloudSyncIfConfigured } = await import("/mobile/js/chunks/autostart-6B4FU6TC.js");
        const rtMod = await import("/mobile/js/chunks/panel-conexion-runtime-YM4VFDND.js");
      ...
      const { pullClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-QBGEN6LN.js");
...
function scheduleBackgroundClinicalOpsPush(options = {}) {
  void (async () => {
    try {
      const { pushClinicalOpsForSalas, listLocalTeamSalas } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-QBGEN6LN.js");
...
async function publishClinicalTeamsAfterChange(options = {}) {
  if (isCloudSyncActive()) {
    try {
      const { syncClinicalOpsForSala, pushClinicalOpsForSalas, listLocalTeamSalas } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-QBGEN6LN.js");
...
async function handleLanDeleteDirectoryUserClick(btn) {
  ...
  const { reloadDirectoryUsersAfterMutation } = await import("/mobile/js/chunks/teams-roster-directory-load-IQKY6AKT.js");
...
async function handleLanAssignButtonClick(btn) {
  ...
  try {
    const { scheduleCloudSyncPush: scheduleCloudSyncPush2 } = await import("/mobile/js/chunks/mutate-bridge-7T3WSPQH.js");
...
async function resolveTeamIdFromDirectory(raw) {
  try {
    const { pullClinicalOpsFromCloudRoom: pullClinicalOpsFromCloudRoom2 } = await import("/mobile/js/chunks/teams-guardia-bridge-HNU52HJ5.js");
    await pullClinicalOpsFromCloudRoom2({ timeoutMs: 8e3, force: true });
    const { fetchClinicalTeamsFromDb: fetchClinicalTeamsFromDb2 } = await import("/mobile/js/chunks/clinical-access-runtime-OFZ4WTIT.js");
...
async function openTeamsPanelAfterAlreadyJoined() {
  ...
  const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/mobile/js/chunks/teams-roster-KIZ2Z54J.js");
...
async function finalizeSuccessfulTeamJoin(team, teamId, cycle) {
  ...
  const { closeClinicalTeamsPanel: closeClinicalTeamsPanel2, refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/mobile/js/chunks/teams-roster-shell-5VF6EK6A.js");
  await fetchClinicalTeamsFromDb();
  ...
  void import("/mobile/js/chunks/ensure-turn-room-3NEIT5HX.js").then(
...
async function redirectLanInviteFromTeamJoinField(raw) {
  ...
  const { openConnectionDropdown } = await import("/mobile/js/chunks/panel-chrome-UMZYXQUM.js");
...
function loadRoster() {
  return import("/mobile/js/chunks/teams-roster-KIZ2Z54J.js");
}
...
async function mountEquipoTeamsPanel(host, opts = {}) {
  ...
  try {
    const { needsClinicalOnboarding: needsClinicalOnboarding2 } = await import("/mobile/js/chunks/clinical-onboarding-QL3MWQA3.js");
  ...
  try {
    const { renderClinicalTeamsPanelInto: renderClinicalTeamsPanelInto2 } = await import("/mobile/js/chunks/teams-roster-panel-ZYLOPRW2.js");
...
function restoreCreateTeamPanelDraft(draft) {
  ...
  void import("/mobile/js/chunks/teams-roster-create-2PFWXJ4P.js").then((m) => {
...
async function maybeRefreshClinicalOpsDirectory(skipPull, browseSala, homeSala) {
  ...
  const { isClinicalTeamsPanelActive: isClinicalTeamsPanelActive2 } = await import("/mobile/js/chunks/teams-roster-shell-5VF6EK6A.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/mobile/js/chunks/teams-roster-interactions-EWJXMZ27.js");
...
async function refreshTeamsUiAfterChange(opts = {}) {
  const { isDirectoryModalOpen: isDirectoryModalOpen2 } = await import("/mobile/js/chunks/teams-roster-users-JPJ2APSQ.js");
  if (isDirectoryModalOpen2()) return;
  const { refreshClinicalPatientListForScope: refreshClinicalPatientListForScope2 } = await import("/mobile/js/chunks/clinical-access-runtime-OFZ4WTIT.js");
  await refreshClinicalPatientListForScope2({ allowLanPull: true });
  import("/mobile/js/chunks/clinical-rotation-entry-DPKDAZ3H.js").then((m) => m.syncClinicalRotationEntryChrome());
  if (isClinicalTeamsPanelActive()) {
    if (!opts.force) {
      const { isClinicalTeamsPanelUserInteracting: isClinicalTeamsPanelUserInteracting2 } = await import("/mobile/js/chunks/teams-roster-panel-draft-IPD4LJ7E.js");
...
async function openClinicalTeamsPanelModal(opts = {}) {
  ...
  try {
    const { wireClinicalTeamsModalChrome: wireClinicalTeamsModalChrome2 } = await import("/mobile/js/chunks/teams-roster-modal-chrome-56MFDDA4.js");
...
async function persistProfileFromPanel(fields) {
  ...
  if (ok && upgraded) {
    ...
    try {
      const main = await import("/mobile/js/chunks/clinical-onboarding-main-TRAQBRY5.js");
...
async function handleProfileFormSubmit(ev) {
  ...
  void import("/mobile/js/chunks/teams-guardia-bridge-HNU52HJ5.js").then((mod) => mod.publishClinicalTeamsAfterChange({ sala: fields.sala })).catch(() => {
  });
  void import("/mobile/js/chunks/patients-PW5HBT3C.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
function wireInheritPatientsButtons() {
  document.querySelectorAll(".clinical-teams-inherit-btn").forEach((btn) => {
    ...
    btn.addEventListener("click", async () => {
      ...
      const { openInheritPatientsModal, wireInheritPatientsModal } = await import("/mobile/js/chunks/teams-roster-inherit-patients-modal-LMD2RXH7.js");
...
function wireClinicalTeamsControls() {
  void import("/mobile/js/chunks/teams-roster-modal-chrome-56MFDDA4.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/mobile/js/chunks/clinical-rotation-entry-DPKDAZ3H.js").then((mod) => {
    mod.wireClinicalRotationEntryControls();
    mod.syncClinicalRotationEntryChrome();
  });
  void import("/mobile/js/chunks/clinical-rotation-Y45CTC57.js").then((mod) => {
...
async function persistSalaFromModal() {
  ...
  const { persistProfileFromPanel: persistProfileFromPanel2 } = await import("/mobile/js/chunks/teams-roster-profile-persist-G25JES6G.js");
  const user = clinicalSessionContext.user || {};
...
async function confirmNuevaRotacion() {
  ...
  document.dispatchEvent(new CustomEvent("rpc-guardia-rotation-changed"));
  try {
    const { publishClinicalTeamsAfterChange: publishClinicalTeamsAfterChange2 } = await import("/mobile/js/chunks/teams-guardia-bridge-HNU52HJ5.js");
...
function wireGuardiaRotationControls() {
  ...
  void import("/mobile/js/chunks/teams-roster-inherit-patients-modal-LMD2RXH7.js").then(
...
async function pushClinicalOpsAfterTeamAssign(teamSala) {
  const lan = await import("/mobile/js/chunks/mutate-bridge-7T3WSPQH.js").catch(() => null);
...
async function mirrorAssignedPatientToCloud(pid) {
  ...
  const { getClinicalScopeContextForEvaluate: getClinicalScopeContextForEvaluate2 } = await import("/mobile/js/chunks/clinical-access-runtime-OFZ4WTIT.js");
  const scopeCtx = getClinicalScopeContextForEvaluate2();
  try {
    const cloud = await import("/mobile/js/chunks/mutate-bridge-7T3WSPQH.js");
    if (!patient) {
      if (typeof cloud.scheduleCloudSyncPush === "function") cloud.scheduleCloudSyncPush();
      return;
    }
    const { mirrorPatientCensusToOperationalSala, patientBelongsToActiveCloudRoom } = await import("/mobile/js/chunks/cloud-census-sala-push-NUJHVZDI.js");
...
async function onPatientTeamAssignChange(teamId) {
  ...
  if (res.ok) {
    ...
    const patientsMod = await import("/mobile/js/chunks/patients-PW5HBT3C.js").catch(() => null);
...
async function notifyAssignToast(msg, type) {
  try {
    const shell = await import("/mobile/js/chunks/app-shell-6H37RPZ4.js");
...
function wireRosterFooter(guardiasMap, censusPatients) {
  document.getElementById("roster-btn-cancel")?.addEventListener("click", () => {
    void (async () => {
      ...
      const { endEntregaPhase: endEntregaPhase2 } = await import("/mobile/js/chunks/clinical-entrega-MXCLZZTE.js");
      endEntregaPhase2();
...
async function tryRestoreOrphanPatientFromLan(patientId) {
  ...
  const lan = await import("/mobile/js/chunks/mutate-bridge-7T3WSPQH.js");
...
async function openEntregaForOrphan(patientId, guardiaId) {
  const entrega = await import("/mobile/js/chunks/clinical-entrega-MXCLZZTE.js");
...
async function removeOrphanPatientLocally(patientId) {
  if (!patientInLocalCensus(patientId)) return;
  const lanMod = await import("/mobile/js/chunks/mutate-bridge-7T3WSPQH.js");
...
function invalidateEventualidadesRelatedCaches() {
  ...
  void import("/mobile/js/chunks/expediente-inner-cache-MZ6AKQWS.js").then(function(m) {
...
function importLazyRoutes() {
  return import("/mobile/js/chunks/lazy-feature-routes-SNUITVIW.js");
}
...
function openCommandPaletteFromShell() {
  void import("/mobile/js/chunks/command-palette-U6CI3QII.js").then(function(mod) {
...
function appendGuardiaLearnNudge(host) {
  void Promise.all([
    ...
    import("/mobile/js/chunks/learn-hub-5RHCGI6C.js")
  ]).then(function(mods) {
...
function invalidateMobileSidebarPatientCache() {
  if (typeof document === "undefined") return;
  void import("/mobile/js/chunks/patients-PW5HBT3C.js").then((mod) => {
...
async function countTeamMemberMissingPatients(user, teams, assignments, localIds, now) {
  const { filterJoinedTeams: filterJoinedTeams2 } = await import("/mobile/js/chunks/shared-L3Q2YO54.js");
...
async function runNubePatientReconcile(_reason) {
  ...
  nubePatientReconcileInFlight = (async function() {
    try {
      const { getSharedNubeRuntime } = await import("/mobile/js/chunks/panel-conexion-runtime-YM4VFDND.js");
      const { autostartCloudSyncIfConfigured } = await import("/mobile/js/chunks/autostart-6B4FU6TC.js");
...
async function refreshClinicalPatientListForScope(options) {
  ...
  setRefreshClinicalPatientListForScopeInFlight(
    (async function() {
      ...
      if (typeof document === "undefined") return;
      try {
        const mod = await import("/mobile/js/chunks/patients-PW5HBT3C.js");
...
function scheduleClinicalActivityLanPush() {
  ...
  setClinicalActivityLanPushTimer(
    setTimeout(() => {
      ...
      void import("/mobile/js/chunks/mutate-bridge-clinical-ops-D3JL4VIH.js").then((mod) => {
        if (typeof mod.pushCloudClinicalOpsNow === "function") {
          return mod.pushCloudClinicalOpsNow();
        }
      }).catch(() => {
...
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/mobile/js/chunks/patients-PW5HBT3C.js").then((mod) => mod.renderPatientList({ silent: true })).catch(() => {
      });
    }
  }
  return migrated;
...
function syncHardwareAccelerationUI() {
  ...
  if (!api2 || typeof api2.getPerformancePrefs !== "function") {
    ...
    void import("/mobile/js/chunks/settings-dropdown-FI4QDWTS.js").then(function(m) {
...
async function refreshDesktopPatientListAfterScopePrune() {
  ...
  try {
    const { renderGuardiaCensusGrid: renderGuardiaCensusGrid2 } = await import("/mobile/js/chunks/guardia-grid-MQEGTTU6.js");
...
//# sourceMappingURL=/js/chunks/chunk-SEHESZ4A.js.map
