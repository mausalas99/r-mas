...
function deferMobileWebBoot_() {
  void import("/mobile/js/chunks/app-shell-mobile-boot-ALKUG3V5.js").then(function(mod) {
...
function scheduleDeferredShellInits(_showToast) {
  ...
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/paste-smart-WZZRTVR2.js").then(function(mod) {
      mod.initPasteSmart();
    });
  });
  _rpcDeferInit(function() {
...
function scheduleDeferredUiInits(showToast2) {
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/productivity-TQQGDA7F.js").then(function(mod) {
      mod.initProductivityKeyboardShortcuts();
    });
  });
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/app-shell-keyboard-ITXHBIVX.js").then(function(mod) {
      mod.initShellKeyboardShortcuts(showToast2);
    });
    void import("/mobile/js/chunks/keyboard-shortcuts-nudge-HTRJ3PEN.js").then(function(mod) {
...
function createPatientUpdateHandler(shellCtx2, syncWorkContextChrome2) {
  function refreshPatientChromeAfterUpdate() {
    ...
    void import("/mobile/js/chunks/pase-board-UY4EDUNJ.js").then(function(mod) {
      mod.renderPaseBoard();
    });
    renderRoundOverviewPanels();
    if (shellCtx2.getActiveAppTab() === "agenda") {
      void import("/mobile/js/chunks/agenda-B6W6CX2F.js").then(function(mod) {
...
function loadShowToast() {
  ...
  if (!showToastLoadPromise) {
    showToastLoadPromise = import("/mobile/js/chunks/ui-toast-SJAQCYNH.js").then(function(mod) {
...
if (typeof window !== "undefined") {
  ...
  window.__hybridDemoSheet = function() {
    return import("/mobile/js/chunks/ui-overlay-UDMOKFQT.js").then(function(mod) {
...
function initModalDismiss() {
  void import("/mobile/js/chunks/app-shell-modals-MQJABZZL.js").then(function(mod) {
    mod.initModalDismiss();
  });
}
function quickExportCurrentPatientLazy() {
  var args = arguments;
  void import("/mobile/js/chunks/clinical-quick-export-P6KVWK7V.js").then(function(mod) {
...
function syncWorkContextChrome() {
  ...
  void import("/mobile/js/chunks/header-context-7G3SU2X3.js").then(function(mod) {
...
//# sourceMappingURL=/js/chunks/chunk-4X4ZORS3.js.map
