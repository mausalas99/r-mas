...
} from "/mobile/js/chunks/chunk-TJUDFX3R.js";
import {
...
} from "/mobile/js/chunks/chunk-GL7AY57V.js";
import {
...
async function applyCultivoLabRepoBatch(patientId, registro, studies, errors) {
  await import("/mobile/js/chunks/lazy-feature-routes-QX4QMBNP.js").then(function(routes) {
...
function populateProfileVersionBlock() {
  ...
  window.electronAPI.getAppVersion().then(async function(v) {
    ...
    if (versionChanged || window.__RPC_RELEASE_NOTES_DEV__) {
      var notes = await import("/mobile/js/chunks/release-notes-4QJTULNM.js");
...
function syncInterconsultaModeChrome() {
  import("/mobile/js/chunks/interconsulta-mode-chrome-QJRBRFRO.js").then(function(mod) {
...
//# sourceMappingURL=/js/chunks/chunk-IJRAT5KF.js.map
