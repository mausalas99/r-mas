...
function deferMobileWebBoot_() {
  void import("/mobile/js/chunks/app-shell-mobile-boot-6EDJUAWV.js").then(function(mod) {
...
function scheduleDeferredShellInits(_showToast) {
  ...
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/paste-smart-F2MT3R62.js").then(function(mod) {
      mod.initPasteSmart();
    });
  });
  _rpcDeferInit(function() {
...
function scheduleDeferredUiInits(showToast2) {
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/productivity-TXNKUZOD.js").then(function(mod) {
      mod.initProductivityKeyboardShortcuts();
    });
  });
  void import("/mobile/js/chunks/app-shell-keyboard-DKLMGWVE.js").then(function(mod) {
    mod.initShellKeyboardShortcuts(showToast2);
  });
  void import("/mobile/js/chunks/keyboard-shortcuts-nudge-X3D7YTVY.js").then(function(mod) {
...
function initModalDismiss() {
  void import("/mobile/js/chunks/app-shell-modals-BOD45ZSC.js").then(function(mod) {
    mod.initModalDismiss();
  });
}
function quickExportCurrentPatientLazy() {
  var args = arguments;
  void import("/mobile/js/chunks/clinical-quick-export-CHCBIM76.js").then(function(mod) {
...
function syncWorkContextChrome() {
  ...
  void import("/mobile/js/chunks/header-context-4TWXQ2QN.js").then(function(mod) {
...
//# sourceMappingURL=/js/chunks/chunk-2QLNQU7C.js.map
