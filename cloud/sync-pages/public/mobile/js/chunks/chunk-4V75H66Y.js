...
// public/js/mobile-query-persist.mjs
...
function ensureMobileAppTabAllowed() {
  void import("/mobile/js/chunks/app-tabs-runtime-SOZTAIK6.js").then(function(mod) {
    var rt = mod.rt;
    ...
    return import("/mobile/js/chunks/app-tabs-PIAIARBA.js").then(function(tabs) {
...
function syncMobileLabReferenceHeaderState() {
  ...
  if (pickerLabel) {
    pickerLabel.textContent = "D\xEDa";
...
function refreshMobileLabReferencePanel() {
  ...
  syncMobileLabReferenceChrome();
  void import("/mobile/js/chunks/lazy-feature-routes-SNUITVIW.js").then(function(routes) {
...
//# sourceMappingURL=/js/chunks/chunk-4V75H66Y.js.map
