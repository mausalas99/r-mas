...
async function loadPatientsForSnapshot(deps) {
  try {
    ...
    const appState = await import("/mobile/js/chunks/app-state-WGMETPH2.js");
...
async function refreshRuntimeAfterWipe() {
  try {
    const runtime = await import("/mobile/js/chunks/clinical-access-runtime-AH4HT4U3.js");
    if (typeof runtime.initClinicalAccessRuntime !== "function") return;
    const settingsMod = await import("/mobile/js/chunks/clinical-settings-LWHIEZQA.js");
...
//# sourceMappingURL=/js/chunks/chunk-KY3W2VTY.js.map
