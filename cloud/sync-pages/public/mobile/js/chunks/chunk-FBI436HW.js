import {
  loadTourProgress
} from "/mobile/js/chunks/chunk-TW7GVT5U.js";
import {
  settingsHelpBridge
...
import {
  GUIDED_TOUR_LS_KEY,
  tourState
} from "/mobile/js/chunks/chunk-DYX4ICUP.js";
import {
  isMobileWeb
...
function tryShowGuidedTourIntroIfNeeded() {
  void import("/mobile/js/chunks/tour-intro-education-2ZL3VUHJ.js").then((mod) => {
...
function initGuidedTourGate() {
  ...
  void import("/mobile/js/chunks/learn-hub-5PAIH7FG.js").then(function(hub) {
...
function openTutorialIntroFromSettings() {
  return resolveAppVersionForTour().then(function(v) {
    window.__RPC_APP_VERSION__ = normalizeTourVersionLabel(v);
    return import("/mobile/js/chunks/learn-hub-5PAIH7FG.js").then((hub) => {
...
function launchGuidedTourBranch(branch) {
  ...
  void import("/mobile/js/chunks/tour-flow-54WCTVGK.js").then((mod) => {
...
async function tryShowPostRegistrationEducationIfNeeded() {
  ...
  const { needsClinicalOnboarding, needsTeamOnboardingStep } = await import("/mobile/js/chunks/clinical-onboarding-G7RT3BU5.js");
  ...
  const { isGuardiaV7TrackComplete } = await import("/mobile/js/chunks/guardia-v7-progress-JEWFEK4Z.js");
  ...
  if (shouldOfferGuardiaV7Education({
    ...
    const { maybeShowGuardiaV7UpgradeCard } = await import("/mobile/js/chunks/guardia-v7-upgrade-card-EQQLM7WH.js");
  ...
  if (shouldShowFundamentosTourIntro({ curVersion: cur, storedDoneVersion: stored, needsOnboarding: false })) {
    markGuidedTourVersionDone();
    setTimeout(() => {
      void import("/mobile/js/chunks/learn-hub-5PAIH7FG.js").then((hub) => {
        if (typeof hub.openLearnHub === "function") hub.openLearnHub({ focusTrack: "fundamentos" });
      });
    }, 80);
  }
...
//# sourceMappingURL=/js/chunks/chunk-FBI436HW.js.map
