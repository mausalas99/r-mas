...
async function applyClinicalOpsSnapshot(clinicalOps) {
  ...
  try {
    ...
    const { applyClinicalScopeFromLanOpsSnapshot } = await import("/mobile/js/chunks/clinical-access-runtime-KABKCTTJ.js");
    let applied = false;
    ...
    if (applied) {
      const { hydrateClinicalTeamsAfterCloudPull } = await import("/mobile/js/chunks/clinical-ops-hydrate-3D5ZGEED.js");
...
async function refreshCloudTodoUIs(patientIds) {
  ...
  try {
    const mod = await import("/mobile/js/chunks/todos-refresh-7VN23UBD.js");
...
async function refreshSidebarAfterCloudPull(result) {
  ...
  try {
    const { renderPatientList } = await import("/mobile/js/chunks/patients-FRNAP5DS.js");
...
//# sourceMappingURL=/js/chunks/chunk-YLVR4STO.js.map
