...
async function loadMobileBootModules() {
  const mods = await Promise.all([
    import("/mobile/js/chunks/session-clinical-wipe-JDIYPXZR.js"),
    import("/mobile/js/chunks/mobile-lan-query-persist-OIA7VJPG.js"),
    import("/mobile/js/chunks/mobile-lan-boot-OR2BYHKT.js"),
    import("/mobile/js/chunks/mobile-sharer-sync-GHGDEPLM.js"),
    importLazyRoutes()
  ]);
  return {
...
async function initMobileWebBoot() {
  if (isCloudMobileClient()) {
    const { initCloudMobileBoot } = await import("/mobile/js/chunks/boot-EIQEHQTT.js");
...
//# sourceMappingURL=/js/chunks/app-shell-mobile-boot-J66WQAND.js.map
