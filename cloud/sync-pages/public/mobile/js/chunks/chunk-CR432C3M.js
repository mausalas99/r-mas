...
// public/js/lan-sync-diagnostics-build.mjs
function resolveClinicalOpsTraceSource(d) {
...
function buildLanSyncTransportFields(d) {
  return {
    ...
    wardHostRegistry: d.wardHostRegistry && typeof d.wardHostRegistry === "object" ? { ...d.wardHostRegistry } : null,
    role: String(d.role || "")
  };
}
function buildLanSyncDiagnosticsCore(d) {
  return {
...
async function collectClinicalOpsForLanSync(opts) {
  const api = dbApi();
...
//# sourceMappingURL=/js/chunks/chunk-CR432C3M.js.map
