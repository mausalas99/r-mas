...
function loadLabPasteRuntime() {
  return import("/mobile/js/chunks/lazy-feature-routes-IJS5AV5S.js").then(function(routes) {
    return routes.ensureLabsLoaded();
  }).then(function() {
    return Promise.all([
      import("/mobile/js/chunks/lab-bulk-preview-modal-AYRNLC6A.js"),
      import("/mobile/js/chunks/lab-panel-workbench-PHZAGVI5.js")
    ]);
  }).then(function(mods) {
    return {
...
//# sourceMappingURL=/js/chunks/paste-smart-E7QPY2TY.js.map
