...
import {
  GUIDED_TOUR_LS_KEY,
  tourState
} from "/mobile/js/chunks/chunk-GJUAH75C.js";
import {
  isMobileWeb
...
function tryShowGuidedTourIntroIfNeeded() {
  void import("/mobile/js/chunks/tour-intro-education-M5JM5HCH.js").then((mod) => {
...
function initGuidedTourGate() {
  ...
  void import("/mobile/js/chunks/learn-hub-Y5DT67WL.js").then(function(hub) {
...
function openTutorialIntroFromSettings() {
  return resolveAppVersionForTour().then(function(v) {
    window.__RPC_APP_VERSION__ = normalizeTourVersionLabel(v);
    return import("/mobile/js/chunks/learn-hub-Y5DT67WL.js").then((hub) => {
...
function launchGuidedTourBranch(branch) {
  ...
  void import("/mobile/js/chunks/tour-flow-YJDF2W4Z.js").then((mod) => {
...
async function tryShowPostRegistrationEducationIfNeeded() {
  ...
  const { needsClinicalOnboarding } = await import("/mobile/js/chunks/clinical-onboarding-6WUU376Q.js");
  ...
  if (shouldOfferGuardiaV7Education({
    ...
    const { maybeShowGuardiaV7UpgradeCard } = await import("/mobile/js/chunks/guardia-v7-upgrade-card-XZGFMJ3T.js");
  ...
  if (shouldShowFundamentosTourIntro({ curVersion: cur, storedDoneVersion: stored, needsOnboarding: false })) {
    markGuidedTourVersionDone();
    setTimeout(() => {
      void import("/mobile/js/chunks/learn-hub-Y5DT67WL.js").then((hub) => {
        if (typeof hub.openLearnHub === "function") hub.openLearnHub({ focusTrack: "fundamentos" });
      });
    }, 80);
  }
...
//# sourceMappingURL=/js/chunks/chunk-CA3QXIB4.js.map
