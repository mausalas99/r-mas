...
async function mountCloudConnectionPanel(root, deps) {
  ...
  const { getSessionAdminKey } = await import("/mobile/js/chunks/panel-admin-SE3FY6KW.js");
  const { mountNubeSection } = await import("/mobile/js/chunks/panel-nube-section-37C72VQW.js");
  ...
  _cloudNubeMount = mountNubeSection(root, {
    ...
    onCloudRoomChange: function(connected) {
      ...
      try {
        void import("/mobile/js/chunks/clinical-rotation-entry-4QY3QSUG.js").then((m) => m.syncClinicalRotationEntryChrome?.());
      } catch {
      }
    }
  });
...
function getRuntime() {
  return {
    showToast(msg, kind) {
      try {
        import("/mobile/js/chunks/app-shell-7T6KXOLW.js").then((m) => m.showToast?.(msg, kind));
      } catch {
      }
    },
    closeSettingsDropdown() {
      try {
        import("/mobile/js/chunks/app-shell-7T6KXOLW.js").then((m) => m.closeSettingsDropdown?.());
      } catch {
      }
    }
  };
...
function setConnectionDropdownOpen(open) {
  ...
  void renderConnectionPanel({ force: true, runtime: getRuntime }).then(function() {
    return import("/mobile/js/chunks/panel-conexion-tour-7JYDVXEQ.js").then(function(m) {
...
//# sourceMappingURL=/js/chunks/chunk-YFJ366MU.js.map
