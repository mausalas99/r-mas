...
function deferMobileWebBoot_() {
  void import("/mobile/js/chunks/app-shell-mobile-boot-KWGNY7MB.js").then(function(mod) {
...
function scheduleDeferredShellInits(_showToast) {
  ...
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/paste-smart-NSKKVZUP.js").then(function(mod) {
      mod.initPasteSmart();
    });
  });
...
function scheduleDeferredUiInits(showToast2) {
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/productivity-RT7MT6ZY.js").then(function(mod) {
      mod.initProductivityKeyboardShortcuts();
    });
  });
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/app-shell-keyboard-5J32T4AM.js").then(function(mod) {
...
function createPatientUpdateHandler(shellCtx2, syncWorkContextChrome2) {
  function refreshPatientChromeAfterUpdate() {
    ...
    void import("/mobile/js/chunks/pase-board-OPJB64HL.js").then(function(mod) {
      mod.renderPaseBoard();
    });
    renderRoundOverviewPanels();
    if (shellCtx2.getActiveAppTab() === "agenda") {
      void import("/mobile/js/chunks/agenda-ZEIX3MZN.js").then(function(mod) {
...
function initModalDismiss() {
  void import("/mobile/js/chunks/app-shell-modals-PNKHZLFW.js").then(function(mod) {
    mod.initModalDismiss();
  });
}
function quickExportCurrentPatientLazy() {
  var args = arguments;
  void import("/mobile/js/chunks/clinical-quick-export-QGYKIGCP.js").then(function(mod) {
...
function syncWorkContextChrome() {
  ...
  void import("/mobile/js/chunks/header-context-V5HWBBLP.js").then(function(mod) {
...
//# sourceMappingURL=/js/chunks/chunk-UUWOL5VH.js.map
