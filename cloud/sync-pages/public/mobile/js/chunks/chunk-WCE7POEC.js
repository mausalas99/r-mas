...
} from "/mobile/js/chunks/chunk-OM6K3YU2.js";
import {
  isCutoverDone,
  isCutoverPending,
  setCutoverFlag
...
async function defaultAssignPatientToTeam(patientId, teamId) {
  const { assignPatientToTeamClinical } = await import("/mobile/js/chunks/patient-team-assign-ui-R3ZC5GR7.js");
...
async function handleUsernameStepSubmit(ev) {
  ...
  try {
    ...
    const { refreshMainClinicalOnboardingIfNeeded } = await import("/mobile/js/chunks/clinical-onboarding-main-TRAQBRY5.js");
...
async function renderCompletedOnboarding(host) {
  ...
  if (host.closest("#clinical-teams-panel-body")) {
    const { renderClinicalTeamsPanel } = await import("/mobile/js/chunks/clinical-teams-BRILDUDA.js");
...
async function renderNoSessionOnboarding(host) {
  ...
  const { buildOnboardingSessionBlockHtml } = await import("/mobile/js/chunks/clinical-onboarding-main-TRAQBRY5.js");
...
//# sourceMappingURL=/js/chunks/chunk-WCE7POEC.js.map
