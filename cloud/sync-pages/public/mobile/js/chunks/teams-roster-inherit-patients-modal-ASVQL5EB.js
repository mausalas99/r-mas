...
function buildInheritStepPacientesHtml(model) {
  const patients2 = Array.isArray(model.patients) ? model.patients : [];
  const rows = patients2.length === 0 ? `<p class="inherit-patients-lead">No hay pacientes locales de ese origen en este Mac. Puedes continuar o elegir otro equipo.</p>` : `<ul class="inherit-patients-list">` + patients2.map((p) => {
...
function renderCurrentStep() {
  ...
  if (state.step === 0) {
    ...
    const patients2 = patientsForInheritSource(state.grouped, state.sourceTeamId, {
...
//# sourceMappingURL=/js/chunks/teams-roster-inherit-patients-modal-ASVQL5EB.js.map
