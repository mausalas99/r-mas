...
async function refreshChromeAfterLocalOnlyExit() {
  try {
    const { closeSettingsDropdown, syncTeamSyncHeaderButton } = await import("/mobile/js/chunks/settings-dropdown-TVRS2TGZ.js");
  ...
  try {
    const main = await import("/mobile/js/chunks/clinical-onboarding-main-KA27AVM4.js");
    await main.refreshMainClinicalOnboardingIfNeeded();
  } catch (_e) {
    void _e;
  }
  try {
    const rot = await import("/mobile/js/chunks/clinical-rotation-entry-AB4YA4QV.js");
...
async function enableClinicalLanFromSettings() {
  ...
  setClinicalSyncModeLocalOnly(false);
  try {
    const lan = await import("/mobile/js/chunks/mutate-bridge-TBOGIAHM.js");
...
//# sourceMappingURL=/js/chunks/clinical-sync-mode-settings-AHZBARER.js.map
