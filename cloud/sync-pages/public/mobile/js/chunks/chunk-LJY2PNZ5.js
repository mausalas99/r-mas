...
async function mountCloudConnectionPanel(root, deps) {
  ...
  const { createCloudSyncApi } = await import("/mobile/js/chunks/api-client-BDDJNVP4.js");
  const { getSessionAdminKey } = await import("/mobile/js/chunks/panel-admin-R7XXJR7L.js");
  const { mountNubeSection } = await import("/mobile/js/chunks/panel-nube-section-INHFRO74.js");
...
function getRuntime() {
  return {
    showToast(msg, kind) {
      try {
        import("/mobile/js/chunks/app-shell-JT5U253I.js").then((m) => m.showToast?.(msg, kind));
      } catch {
      }
    },
    closeSettingsDropdown() {
      try {
        import("/mobile/js/chunks/app-shell-JT5U253I.js").then((m) => m.closeSettingsDropdown?.());
      } catch {
      }
    }
  };
...
function setConnectionDropdownOpen(open) {
  ...
  void renderConnectionPanel({ force: true, runtime: getRuntime }).then(function() {
    return import("/mobile/js/chunks/panel-conexion-tour-KLDTVA5F.js").then(function(m) {
...
//# sourceMappingURL=/js/chunks/chunk-LJY2PNZ5.js.map
