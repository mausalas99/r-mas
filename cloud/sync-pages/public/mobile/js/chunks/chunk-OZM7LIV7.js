...
var commandPaletteWindowHandlersLazy = buildLazyWindowHandlers(
  ...
  function() {
    return import("/mobile/js/chunks/command-palette-ONXF6D5R.js");
  }
);
var clinicalSyncModeSettingsHandlersLazy = buildLazyWindowHandlers(
  ...
  function() {
    return import("/mobile/js/chunks/clinical-sync-mode-settings-IMUDRFP3.js");
  }
);
...
function ensureChartsLoaded() {
  ...
  if (!chartsPromise) {
    chartsPromise = Promise.all([
      import("/mobile/js/chunks/tendencias-ZNNE7HKF.js"),
      import("/mobile/js/chunks/estado-actual-charts-modal-JPMQMGHA.js")
    ]).then(function(pair) {
...
var chartsRuntimeProxies = {
  ...
  inferFechaLabSetFromId: chartsSyncFn("inferFechaLabSetFromId", inferFechaLabSetFromId),
...
var notaEvolucionPromise = null;
var notaEvolucionModule = null;
var notaEvolucionRuntimeCtx = null;
...
function ensureSettingsHelpLoaded() {
  ...
  if (!settingsHelpPromise) {
    settingsHelpPromise = import("/mobile/js/chunks/settings-help-MKN3WYJ2.js").then(function(mod) {
...
function ensurePlatformLoaded() {
  ...
  if (!platformPromise) {
    platformPromise = import("/mobile/js/chunks/platform-IM2LOUG5.js").then(function(mod) {
      platformModule = mod;
...
function ensureEntregaLoaded() {
  ...
  if (!entregaPromise) {
    entregaPromise = import("/mobile/js/chunks/clinical-entrega-LBPLXH6K.js").then(function(mod) {
      entregaModule = mod;
      return mod;
    });
  }
...
function ensureEaVitalHistoryLoaded() {
  ...
  if (!eaVitalHistoryPromise) {
    eaVitalHistoryPromise = import("/mobile/js/chunks/estado-actual-vital-history-modal-BINFBCT5.js").then(function(mod) {
...
function bindLazyNotaEvolucionRuntimeCtx(ctx) {
  notaEvolucionRuntimeCtx = ctx;
}
function ensureNotaEvolucionLoaded() {
  if (notaEvolucionModule) return Promise.resolve(notaEvolucionModule);
  if (!notaEvolucionPromise) {
    notaEvolucionPromise = import("/mobile/js/chunks/nota-evolucion-panel-OFGR4QN3.js").then(function(mod) {
...
var notaEvolucionWindowHandlersLazy = buildLazyWindowHandlers(
  {
...
function ensureLabsLoaded() {
  ...
  if (!labsPromise) {
    labsPromise = import("/mobile/js/chunks/lab-panel-7OAUFRTW.js").then(function(mod) {
      labsModule = mod;
...
//# sourceMappingURL=/js/chunks/chunk-OZM7LIV7.js.map
