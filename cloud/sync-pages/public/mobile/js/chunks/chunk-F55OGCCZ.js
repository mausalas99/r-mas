...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/mobile/js/chunks/entrega-roster-panel-V5J7ACHF.js").then(({ closeEntregaRosterPanel }) => {
      closeEntregaRosterPanel();
    });
    void import("/mobile/js/chunks/clinical-entrega-FQ5SI7AN.js").then(({ endEntregaPhase }) => {
      endEntregaPhase();
    });
    void import("/mobile/js/chunks/guardia-phase-bar-QI6Z5VQM.js").then(({ teardownGuardiaPhaseBar }) => {
...
function setUiDensity(mode) {
  ...
  void import("/mobile/js/chunks/clinical-rotation-entry-4KEGZ3XZ.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-F55OGCCZ.js.map
