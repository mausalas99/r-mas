...
} from "/mobile/js/chunks/chunk-TSKLUCJT.js";
import {
  fundamentosModuleCount,
  isFundamentosChapterId,
  loadFundamentosProgress
} from "/mobile/js/chunks/chunk-V6HRE3QI.js";
import {
  loadTourProgress
...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/mobile/js/chunks/tour-runtime-6Z7AON6N.js").then((mod) => {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/mobile/js/chunks/help-content-IJHKS2RY.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-2H3BHMRK.js.map
