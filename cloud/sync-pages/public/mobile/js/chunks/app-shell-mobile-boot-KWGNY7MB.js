...
async function loadMobileBootModules() {
  const mods = await Promise.all([
    import("/mobile/js/chunks/session-clinical-wipe-4KFX7TKY.js"),
    import("/mobile/js/chunks/mobile-lan-query-persist-FTU2VQ4Y.js"),
    import("/mobile/js/chunks/mobile-lan-boot-BDVZK3OX.js"),
    import("/mobile/js/chunks/mobile-sharer-sync-S5GAP6I7.js"),
    importLazyRoutes()
  ]);
  return {
...
async function initMobileWebBoot() {
  if (isCloudMobileClient()) {
    const { initCloudMobileBoot } = await import("/mobile/js/chunks/boot-IG4U57LZ.js");
...
//# sourceMappingURL=/js/chunks/app-shell-mobile-boot-KWGNY7MB.js.map
