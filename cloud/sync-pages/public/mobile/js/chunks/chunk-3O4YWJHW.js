...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/mobile/js/chunks/entrega-roster-panel-RERBVYKR.js").then(({ closeEntregaRosterPanel }) => {
      closeEntregaRosterPanel();
    });
    void import("/mobile/js/chunks/clinical-entrega-46H4VWNN.js").then(({ endEntregaPhase }) => {
      endEntregaPhase();
    });
    void import("/mobile/js/chunks/guardia-phase-bar-KDDG6YFL.js").then(({ teardownGuardiaPhaseBar }) => {
...
function setUiDensity(mode) {
  ...
  void import("/mobile/js/chunks/clinical-rotation-entry-AB4YA4QV.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-3O4YWJHW.js.map
