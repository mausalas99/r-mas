...
} from "/mobile/js/chunks/chunk-ELUZVSMQ.js";
import {
...
async function ensureClinicalPanelSession(opts = {}) {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/mobile/js/chunks/db-unlock-RKYIZIMR.js");
...
async function publishClinicalTeamsToSync() {
  try {
    const mod = await import("/mobile/js/chunks/mutate-bridge-clinical-ops-MBPPVVQO.js");
...
async function pullClinicalOpsFromCloudRoom(options = {}) {
  ...
  cloudClinicalOpsPullInFlight = (async () => {
    try {
      ...
      const { clinicalSessionContext: clinicalSessionContext2 } = await import("/mobile/js/chunks/clinical-access-runtime-7PNW7XFE.js");
      ...
      if (!salas.length) {
        const { autostartCloudSyncIfConfigured } = await import("/mobile/js/chunks/autostart-J2NN5G7K.js");
        const rtMod = await import("/mobile/js/chunks/panel-conexion-runtime-ACBPAA4Y.js");
      ...
      const { pullClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-SWM445J2.js");
...
function scheduleBackgroundClinicalOpsPush(options = {}) {
  void (async () => {
    try {
      const { pushClinicalOpsForSalas, listLocalTeamSalas } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-SWM445J2.js");
...
async function publishClinicalTeamsAfterChange(options = {}) {
  if (isCloudSyncActive()) {
    try {
      const { syncClinicalOpsForSala, pushClinicalOpsForSalas, listLocalTeamSalas } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-SWM445J2.js");
...
async function handleLanDeleteDirectoryUserClick(btn) {
  ...
  const { reloadDirectoryUsersAfterMutation } = await import("/mobile/js/chunks/teams-roster-directory-load-MTCB27TF.js");
...
async function handleLanAssignButtonClick(btn) {
  ...
  try {
    const { scheduleCloudSyncPush: scheduleCloudSyncPush2 } = await import("/mobile/js/chunks/mutate-bridge-KCVUIRYA.js");
...
async function resolveTeamIdFromDirectory(raw) {
  try {
    const { pullClinicalOpsFromCloudRoom: pullClinicalOpsFromCloudRoom2 } = await import("/mobile/js/chunks/teams-guardia-bridge-SUPG6GP2.js");
    await pullClinicalOpsFromCloudRoom2({ timeoutMs: 8e3, force: true });
    const { fetchClinicalTeamsFromDb: fetchClinicalTeamsFromDb2 } = await import("/mobile/js/chunks/clinical-access-runtime-7PNW7XFE.js");
...
async function openTeamsPanelAfterAlreadyJoined() {
  ...
  const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/mobile/js/chunks/teams-roster-GC2OQZET.js");
...
async function finalizeSuccessfulTeamJoin(team, teamId, cycle) {
  ...
  const { closeClinicalTeamsPanel: closeClinicalTeamsPanel2, refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/mobile/js/chunks/teams-roster-shell-TUY2QMXN.js");
  await fetchClinicalTeamsFromDb();
  ...
  void import("/mobile/js/chunks/ensure-turn-room-OLS6SUVU.js").then(
...
async function redirectLanInviteFromTeamJoinField(raw) {
  ...
  const { openConnectionDropdown } = await import("/mobile/js/chunks/panel-chrome-O2IZDPPP.js");
...
function loadRoster() {
  return import("/mobile/js/chunks/teams-roster-GC2OQZET.js");
}
...
async function mountEquipoTeamsPanel(host, opts = {}) {
  ...
  try {
    const { needsClinicalOnboarding: needsClinicalOnboarding2 } = await import("/mobile/js/chunks/clinical-onboarding-5IK256U3.js");
    if (needsClinicalOnboarding2()) {
      const mainMod = await import("/mobile/js/chunks/clinical-onboarding-main-JGMTC5M4.js");
  ...
  try {
    const { renderClinicalTeamsPanelInto: renderClinicalTeamsPanelInto2 } = await import("/mobile/js/chunks/teams-roster-panel-ZJMP5HQO.js");
...
function restoreCreateTeamPanelDraft(draft) {
  ...
  void import("/mobile/js/chunks/teams-roster-create-WTPKFPS7.js").then((m) => {
...
async function maybeRefreshClinicalOpsDirectory(skipPull, browseSala, homeSala) {
  ...
  const { isClinicalTeamsPanelActive: isClinicalTeamsPanelActive2 } = await import("/mobile/js/chunks/teams-roster-shell-TUY2QMXN.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/mobile/js/chunks/teams-roster-interactions-V2A5UXRY.js");
...
async function refreshTeamsUiAfterChange(opts = {}) {
  const { isDirectoryModalOpen: isDirectoryModalOpen2 } = await import("/mobile/js/chunks/teams-roster-users-MPEL5BCQ.js");
  if (isDirectoryModalOpen2()) return;
  const { refreshClinicalPatientListForScope: refreshClinicalPatientListForScope2 } = await import("/mobile/js/chunks/clinical-access-runtime-7PNW7XFE.js");
  await refreshClinicalPatientListForScope2({ allowLanPull: true });
  import("/mobile/js/chunks/clinical-rotation-entry-M5SNTRLZ.js").then((m) => m.syncClinicalRotationEntryChrome());
  if (isClinicalTeamsPanelActive()) {
    if (!opts.force) {
      const { isClinicalTeamsPanelUserInteracting: isClinicalTeamsPanelUserInteracting2 } = await import("/mobile/js/chunks/teams-roster-panel-draft-3OULLZQB.js");
...
async function openClinicalTeamsPanel(opts = {}) {
  const { openConexionEquipoPanel } = await import("/mobile/js/chunks/panel-equipo-nav-YYUH3XRS.js");
...
async function openClinicalTeamsPanelModal(opts = {}) {
  ...
  try {
    const { wireClinicalTeamsModalChrome: wireClinicalTeamsModalChrome2 } = await import("/mobile/js/chunks/teams-roster-modal-chrome-HFRP3QNC.js");
...
async function handleProfileFormSubmit(ev) {
  ...
  void import("/mobile/js/chunks/teams-guardia-bridge-SUPG6GP2.js").then((mod) => mod.publishClinicalTeamsAfterChange({ sala: fields.sala })).catch(() => {
  });
  void import("/mobile/js/chunks/patients-LO6X2Z6Z.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
function wireInheritPatientsButtons() {
  document.querySelectorAll(".clinical-teams-inherit-btn").forEach((btn) => {
    ...
    btn.addEventListener("click", async () => {
      ...
      const { openInheritPatientsModal, wireInheritPatientsModal } = await import("/mobile/js/chunks/teams-roster-inherit-patients-modal-JQSQO4W5.js");
...
function wireClinicalTeamsControls() {
  void import("/mobile/js/chunks/teams-roster-modal-chrome-HFRP3QNC.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/mobile/js/chunks/clinical-rotation-entry-M5SNTRLZ.js").then((mod) => {
    mod.wireClinicalRotationEntryControls();
    mod.syncClinicalRotationEntryChrome();
  });
  void import("/mobile/js/chunks/clinical-rotation-F6UZ26Q7.js").then((mod) => {
...
async function persistSalaFromModal() {
  ...
  const { persistProfileFromPanel: persistProfileFromPanel2 } = await import("/mobile/js/chunks/teams-roster-profile-persist-MM5HX3CH.js");
  const user = clinicalSessionContext.user || {};
...
async function confirmNuevaRotacion() {
  ...
  document.dispatchEvent(new CustomEvent("rpc-guardia-rotation-changed"));
  try {
    const { publishClinicalTeamsAfterChange: publishClinicalTeamsAfterChange2 } = await import("/mobile/js/chunks/teams-guardia-bridge-SUPG6GP2.js");
...
function wireGuardiaRotationControls() {
  ...
  void import("/mobile/js/chunks/teams-roster-inherit-patients-modal-JQSQO4W5.js").then(
...
async function pushClinicalOpsAfterTeamAssign(teamSala) {
  const lan = await import("/mobile/js/chunks/mutate-bridge-KCVUIRYA.js").catch(() => null);
  if (lan?.pushClinicalOpsLanNow) await lan.pushClinicalOpsLanNow();
  if (!teamSala) return;
  try {
    const { pushClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-SWM445J2.js");
...
async function mirrorAssignedPatientToCloud(pid) {
  ...
  const { getClinicalScopeContextForEvaluate: getClinicalScopeContextForEvaluate2 } = await import("/mobile/js/chunks/clinical-access-runtime-7PNW7XFE.js");
  const scopeCtx = getClinicalScopeContextForEvaluate2();
  try {
    const cloud = await import("/mobile/js/chunks/mutate-bridge-KCVUIRYA.js");
    if (!patient) {
      if (typeof cloud.scheduleCloudSyncPush === "function") cloud.scheduleCloudSyncPush();
      return;
    }
    const { mirrorPatientCensusToOperationalSala, patientBelongsToActiveCloudRoom } = await import("/mobile/js/chunks/cloud-census-sala-push-4WRZZEKA.js");
...
async function onPatientTeamAssignChange(teamId) {
  ...
  if (res.ok) {
    ...
    const patientsMod = await import("/mobile/js/chunks/patients-LO6X2Z6Z.js").catch(() => null);
...
async function notifyAssignToast(msg, type) {
  try {
    const shell = await import("/mobile/js/chunks/app-shell-JT5U253I.js");
...
function wireRosterFooter(guardiasMap, censusPatients) {
  document.getElementById("roster-btn-cancel")?.addEventListener("click", () => {
    void (async () => {
      ...
      const { endEntregaPhase: endEntregaPhase2 } = await import("/mobile/js/chunks/clinical-entrega-LBPLXH6K.js");
      endEntregaPhase2();
...
async function openEntregaForOrphan(patientId, guardiaId) {
  const entrega = await import("/mobile/js/chunks/clinical-entrega-LBPLXH6K.js");
...
async function removeOrphanPatientLocally(patientId) {
  if (!patientInLocalCensus(patientId)) return;
  const lanMod = await import("/mobile/js/chunks/mutate-bridge-KCVUIRYA.js");
...
function invalidateEventualidadesRelatedCaches() {
  ...
  void import("/mobile/js/chunks/expediente-inner-cache-JH6XWM2I.js").then(function(m) {
...
function appendGuardiaLearnNudge(host) {
  void Promise.all([
    ...
    import("/mobile/js/chunks/learn-hub-BWAQVDU3.js")
  ]).then(function(mods) {
...
function ensureGuardiaBoardBootstrapped(settings) {
  ...
  void import("/mobile/js/chunks/clinical-rotation-entry-M5SNTRLZ.js").then((mod) => {
    mod.syncClinicalRotationEntryChrome?.();
  });
...
function invalidateMobileSidebarPatientCache() {
  if (typeof document === "undefined") return;
  void import("/mobile/js/chunks/patients-LO6X2Z6Z.js").then((mod) => {
...
async function countTeamMemberMissingPatients(user, teams, assignments, localIds, now) {
  const { filterJoinedTeams: filterJoinedTeams2 } = await import("/mobile/js/chunks/shared-JGG43LCJ.js");
...
async function runNubePatientReconcile(_reason) {
  ...
  nubePatientReconcileInFlight = (async function() {
    try {
      const { getSharedNubeRuntime } = await import("/mobile/js/chunks/panel-conexion-runtime-ACBPAA4Y.js");
      const { autostartCloudSyncIfConfigured } = await import("/mobile/js/chunks/autostart-J2NN5G7K.js");
...
async function refreshClinicalPatientListForScope(options) {
  ...
  setRefreshClinicalPatientListForScopeInFlight(
    (async function() {
      ...
      if (typeof document === "undefined") return;
      try {
        const mod = await import("/mobile/js/chunks/patients-LO6X2Z6Z.js");
...
function scheduleClinicalActivityLanPush() {
  ...
  setClinicalActivityLanPushTimer(
    setTimeout(() => {
      ...
      void import("/mobile/js/chunks/mutate-bridge-clinical-ops-MBPPVVQO.js").then((mod) => {
        if (typeof mod.pushCloudClinicalOpsNow === "function") {
          return mod.pushCloudClinicalOpsNow();
        }
      }).catch(() => {
...
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/mobile/js/chunks/patients-LO6X2Z6Z.js").then((mod) => mod.renderPatientList({ silent: true })).catch(() => {
      });
    }
  }
  return migrated;
...
function syncHardwareAccelerationUI() {
  ...
  if (!api2 || typeof api2.getPerformancePrefs !== "function") {
    ...
    void import("/mobile/js/chunks/settings-dropdown-KB74A445.js").then(function(m) {
...
async function refreshDesktopPatientListAfterScopePrune() {
  ...
  try {
    const { renderGuardiaCensusGrid: renderGuardiaCensusGrid2 } = await import("/mobile/js/chunks/guardia-grid-RRGZEV7D.js");
...
//# sourceMappingURL=/js/chunks/chunk-6J2G5HNR.js.map
