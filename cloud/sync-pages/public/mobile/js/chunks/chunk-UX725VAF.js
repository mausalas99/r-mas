...
async function loadPatientsForSnapshot(deps) {
  try {
    ...
    const appState = await import("/mobile/js/chunks/app-state-VTJEBUUK.js");
...
async function refreshRuntimeAfterWipe() {
  try {
    const runtime = await import("/mobile/js/chunks/clinical-access-runtime-KABKCTTJ.js");
    if (typeof runtime.initClinicalAccessRuntime !== "function") return;
    const settingsMod = await import("/mobile/js/chunks/clinical-settings-VUNDYSKU.js");
...
//# sourceMappingURL=/js/chunks/chunk-UX725VAF.js.map
