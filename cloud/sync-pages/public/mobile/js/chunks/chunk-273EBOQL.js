...
import {
  ensureTurnRoom
} from "/mobile/js/chunks/chunk-3FIUPWII.js";
import {
  createCloudSyncApi
...
async function scheduleOptionalPush() {
  try {
    const { scheduleCloudSyncPush } = await import("/mobile/js/chunks/mutate-bridge-7T3WSPQH.js");
...
function wireExistingAccountLoginInteractions() {
  ...
  if (switchBtn && !switchBtn._rpcSwitchExistingWired) {
    ...
    switchBtn.addEventListener("click", () => {
      setClinicalExistingAccountPath(true);
      void import("/mobile/js/chunks/clinical-onboarding-main-TRAQBRY5.js").then((m) => m.refreshMainClinicalOnboardingIfNeeded());
    });
  }
}
...
//# sourceMappingURL=/js/chunks/chunk-273EBOQL.js.map
