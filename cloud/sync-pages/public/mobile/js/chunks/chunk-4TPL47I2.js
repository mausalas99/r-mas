...
function deferMobileWebBoot_() {
  void import("/mobile/js/chunks/app-shell-mobile-boot-MHZMXXZC.js").then(function(mod) {
...
function scheduleDeferredShellInits(_showToast) {
  ...
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/paste-smart-A3REWYM7.js").then(function(mod) {
      mod.initPasteSmart();
    });
  });
  _rpcDeferInit(function() {
...
function scheduleDeferredUiInits(showToast2) {
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/productivity-HZP5I5MH.js").then(function(mod) {
      mod.initProductivityKeyboardShortcuts();
    });
  });
  _rpcDeferInit(function() {
    void import("/mobile/js/chunks/app-shell-keyboard-JETOCZQN.js").then(function(mod) {
      mod.initShellKeyboardShortcuts(showToast2);
    });
    void import("/mobile/js/chunks/keyboard-shortcuts-nudge-SSRQOE4V.js").then(function(mod) {
...
function createPatientUpdateHandler(shellCtx2, syncWorkContextChrome2) {
  function refreshPatientChromeAfterUpdate() {
    ...
    void import("/mobile/js/chunks/pase-board-QFZHM5OK.js").then(function(mod) {
      mod.renderPaseBoard();
    });
    renderRoundOverviewPanels();
    if (shellCtx2.getActiveAppTab() === "agenda") {
      void import("/mobile/js/chunks/agenda-XXKM5I6N.js").then(function(mod) {
...
function loadShowToast() {
  ...
  if (!showToastLoadPromise) {
    showToastLoadPromise = import("/mobile/js/chunks/ui-toast-YSDPTPMA.js").then(function(mod) {
...
function initModalDismiss() {
  void import("/mobile/js/chunks/app-shell-modals-DD4BUZ6S.js").then(function(mod) {
    mod.initModalDismiss();
  });
}
function quickExportCurrentPatientLazy() {
  var args = arguments;
  void import("/mobile/js/chunks/clinical-quick-export-JMDN77KW.js").then(function(mod) {
...
function syncWorkContextChrome() {
  ...
  void import("/mobile/js/chunks/header-context-TUYFD6ZU.js").then(function(mod) {
...
//# sourceMappingURL=/js/chunks/chunk-4TPL47I2.js.map
