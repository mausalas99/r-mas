...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/mobile/js/chunks/tour-runtime-55RX3MMN.js").then((mod) => {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/mobile/js/chunks/help-content-JQ5DFPTS.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-QCYIXF7H.js.map
