...
async function connectShiftPinIfNeeded_(shiftPin, sala, _runtime) {
  ...
  if (isLanSkipShiftPin()) {
    var { tryEasyLanShiftPinConnect } = await import("/mobile/js/chunks/lan-shift-pin-connect-P2H6BGVU.js");
    await tryEasyLanShiftPinConnect({ sala, force: true });
    return;
  }
  if (!shiftPin) return;
  var { connectLanWithShiftPin } = await import("/mobile/js/chunks/lan-shift-pin-connect-P2H6BGVU.js");
...
async function handleClinicalRegistrationSubmit(deps) {
  ...
  const { refreshClinicalUserProfile } = await import("/mobile/js/chunks/clinical-access-runtime-D63B6FH7.js");
...
//# sourceMappingURL=/js/chunks/chunk-V53FQ62F.js.map
