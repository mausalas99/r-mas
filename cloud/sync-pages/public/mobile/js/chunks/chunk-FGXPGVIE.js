...
function equiposActivityHistoryModalMarkup(opts) {
  ...
  return '<div class="lab-conflict-backdrop" data-equipos-activity-history-modal><div class="lab-conflict-modal cloud-sync-equipos-history-modal material-glass ui-overlay-dialog" role="dialog" aria-modal="true" aria-labelledby="equipos-activity-history-title"><div class="cloud-sync-equipos-history-modal-head"><h3 id="equipos-activity-history-title">Historial de actividad</h3><p class="cloud-sync-equipos-history-modal-sub">' + esc(subtitle) + "</p></div>" + equiposActivityHistoryListHtml(opts?.history) + '<div class="cloud-sync-equipos-history-modal-foot"><button type="button" class="cloud-sync-btn" data-equipos-history-close>Cerrar</button></div></div></div>';
}
...
//# sourceMappingURL=/js/chunks/chunk-FGXPGVIE.js.map
