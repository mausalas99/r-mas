...
function tryShowGuidedTourIntroIfNeeded() {
  void import("/mobile/js/chunks/tour-intro-education-QOQZ2IQ7.js").then((mod) => {
...
function openTutorialIntroFromSettings() {
  return resolveAppVersionForTour().then(function(v) {
    window.__RPC_APP_VERSION__ = normalizeTourVersionLabel(v);
    return import("/mobile/js/chunks/learn-hub-T2DYNN2K.js").then((hub) => {
...
async function tryShowPostRegistrationEducationIfNeeded() {
  ...
  const { needsClinicalOnboarding, needsTeamOnboardingStep } = await import("/mobile/js/chunks/clinical-onboarding-P2ZGDIVY.js");
  ...
  if (shouldOfferGuardiaV7Education({
    ...
    const { maybeShowGuardiaV7UpgradeCard } = await import("/mobile/js/chunks/guardia-v7-upgrade-card-ZLZ6BE7O.js");
  ...
  if (shouldShowFundamentosTourIntro({ curVersion: cur, storedDoneVersion: stored, needsOnboarding: false })) {
    markGuidedTourVersionDone();
    setTimeout(() => {
      void import("/mobile/js/chunks/learn-hub-T2DYNN2K.js").then((hub) => {
        if (typeof hub.openLearnHub === "function") hub.openLearnHub({ focusTrack: "fundamentos" });
      });
    }, 80);
  }
...
//# sourceMappingURL=/js/chunks/chunk-ZNI4EPCO.js.map
