...
async function pushCloudCensusNow() {
  ...
  const { collectPatientEntriesForCloudPush } = await import("/mobile/js/chunks/cloud-census-collect-AUYVLCQX.js");
  ...
  try {
    ...
    const { pushCloudOpsDirect } = await import("/mobile/js/chunks/cloud-push-direct-ONEFJROK.js");
    ...
    void import("/mobile/js/chunks/lab-sync-diagnostics-F3GK4S7O.js").then(function(labDiag) {
...
async function collectCloudBundleOps(meta) {
  ...
  } = await import("/mobile/js/chunks/cloud-census-collect-AUYVLCQX.js");
  const entries = await collectPatientEntriesForCloudPush();
  ...
  const {
    ...
    pushOpsToSalaRoom
  } = await import("/mobile/js/chunks/cloud-census-sala-push-XW4SNQ32.js");
  const { getClinicalScopeContextForEvaluate } = await import("/mobile/js/chunks/clinical-access-runtime-AIZQAPAG.js");
...
function enqueueCloudLabSidecarsForPatient(patientId) {
  ...
  void import("/mobile/js/chunks/cloud-census-sala-push-XW4SNQ32.js").then(async function(mod) {
    const { getClinicalScopeContextForEvaluate } = await import("/mobile/js/chunks/clinical-access-runtime-AIZQAPAG.js");
    const scopeCtx = getClinicalScopeContextForEvaluate();
...
function enqueueCloudPatientAdmit(patient) {
  ...
  void (async function() {
    const mod = await import("/mobile/js/chunks/cloud-census-sala-push-XW4SNQ32.js");
    const { getClinicalScopeContextForEvaluate } = await import("/mobile/js/chunks/clinical-access-runtime-AIZQAPAG.js");
    const scopeCtx = getClinicalScopeContextForEvaluate();
...
async function pushCloudClinicalOpsNow() {
  ...
  const { pushClinicalOpsForSalas, listLocalTeamSalas, pushClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-HQSTMOK5.js");
...
//# sourceMappingURL=/js/chunks/chunk-P7EHNYUF.js.map
