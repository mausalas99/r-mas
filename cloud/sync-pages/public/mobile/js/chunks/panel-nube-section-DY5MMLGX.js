import {
  ...
  userHasJoinedTeam,
  wireCloudAuthTabs
} from "/mobile/js/chunks/chunk-QWAHM5JX.js";
import {
  buildCloudMobileJoinUrl
} from "/mobile/js/chunks/chunk-OBGB2GI4.js";
import {
  canAccessCloudAdmin
} from "/mobile/js/chunks/chunk-ZH34R4VL.js";
import {
  createNubeRuntime,
  getSharedNubeOutbox,
...
function mountAdminShell(section, deps, toast) {
  ...
  async function ensureAdminOpen() {
    ...
    if (!host) return;
    if (!adminMount) {
      const { mountCloudAdminPanel } = await import("/mobile/js/chunks/panel-admin-MAB55KLO.js");
      host.textContent = "";
...
//# sourceMappingURL=/js/chunks/panel-nube-section-DY5MMLGX.js.map
