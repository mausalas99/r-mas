...
var commandPaletteWindowHandlersLazy = buildLazyWindowHandlers(
  ...
  function() {
    return import("/mobile/js/chunks/command-palette-B2I5M6JF.js");
  }
);
var clinicalSyncModeSettingsHandlersLazy = buildLazyWindowHandlers(
  ...
  function() {
    return import("/mobile/js/chunks/clinical-sync-mode-settings-AHZBARER.js");
  }
);
...
function ensureChartsLoaded() {
  ...
  if (!chartsPromise) {
    chartsPromise = Promise.all([
      import("/mobile/js/chunks/tendencias-H7OU7T6R.js"),
      import("/mobile/js/chunks/estado-actual-charts-modal-5H4CXHGG.js")
    ]).then(function(pair) {
...
function ensureSettingsHelpLoaded() {
  ...
  if (!settingsHelpPromise) {
    settingsHelpPromise = import("/mobile/js/chunks/settings-help-UPRLKWI3.js").then(function(mod) {
...
function ensurePlatformLoaded() {
  ...
  if (!platformPromise) {
    platformPromise = import("/mobile/js/chunks/platform-7AVUW22U.js").then(function(mod) {
      platformModule = mod;
...
function ensureEntregaLoaded() {
  ...
  if (!entregaPromise) {
    entregaPromise = import("/mobile/js/chunks/clinical-entrega-46H4VWNN.js").then(function(mod) {
      entregaModule = mod;
      return mod;
    });
  }
...
function ensureEaVitalHistoryLoaded() {
  ...
  if (!eaVitalHistoryPromise) {
    eaVitalHistoryPromise = import("/mobile/js/chunks/estado-actual-vital-history-modal-4JACW4U4.js").then(function(mod) {
...
function ensureLabsLoaded() {
  ...
  if (!labsPromise) {
    labsPromise = import("/mobile/js/chunks/lab-panel-UPY3YJ6A.js").then(function(mod) {
      labsModule = mod;
...
//# sourceMappingURL=/js/chunks/chunk-SPXDZARY.js.map
