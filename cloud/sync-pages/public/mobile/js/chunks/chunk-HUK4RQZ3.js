...
var commandPaletteWindowHandlersLazy = buildLazyWindowHandlers(
  ...
  function() {
    return import("/mobile/js/chunks/command-palette-KQWWRM2Z.js");
  }
);
var clinicalSyncModeSettingsHandlersLazy = buildLazyWindowHandlers(
  ...
  function() {
    return import("/mobile/js/chunks/clinical-sync-mode-settings-3ARLNCGB.js");
  }
);
...
function ensureChartsLoaded() {
  ...
  if (!chartsPromise) {
    chartsPromise = Promise.all([
      import("/mobile/js/chunks/tendencias-5H4QRHDX.js"),
...
function ensureSettingsHelpLoaded() {
  ...
  if (!settingsHelpPromise) {
    settingsHelpPromise = import("/mobile/js/chunks/settings-help-3USHII5J.js").then(function(mod) {
...
function ensurePlatformLoaded() {
  ...
  if (!platformPromise) {
    platformPromise = import("/mobile/js/chunks/platform-X2LDE2M6.js").then(function(mod) {
      platformModule = mod;
...
function ensureEntregaLoaded() {
  ...
  if (!entregaPromise) {
    entregaPromise = import("/mobile/js/chunks/clinical-entrega-PJWZ2K27.js").then(function(mod) {
      entregaModule = mod;
      return mod;
    });
  }
...
function ensureEaVitalHistoryLoaded() {
  ...
  if (!eaVitalHistoryPromise) {
    eaVitalHistoryPromise = import("/mobile/js/chunks/estado-actual-vital-history-modal-LFVL5DJ2.js").then(function(mod) {
...
function ensureLabsLoaded() {
  ...
  if (!labsPromise) {
    labsPromise = import("/mobile/js/chunks/lab-panel-MQCX7W3V.js").then(function(mod) {
      labsModule = mod;
...
//# sourceMappingURL=/js/chunks/chunk-HUK4RQZ3.js.map
