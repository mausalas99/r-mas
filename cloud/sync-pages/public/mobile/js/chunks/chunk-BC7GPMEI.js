...
async function loadPatientsForSnapshot(deps) {
  try {
    ...
    const appState = await import("/mobile/js/chunks/app-state-5XHQAGQP.js");
...
async function refreshRuntimeAfterWipe() {
  try {
    const runtime = await import("/mobile/js/chunks/clinical-access-runtime-KAV32YSL.js");
    if (typeof runtime.initClinicalAccessRuntime !== "function") return;
    const settingsMod = await import("/mobile/js/chunks/clinical-settings-KXWATNLD.js");
...
//# sourceMappingURL=/js/chunks/chunk-BC7GPMEI.js.map
