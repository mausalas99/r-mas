...
async function refreshChromeAfterLocalOnlyExit() {
  try {
    const { closeSettingsDropdown, syncTeamSyncHeaderButton } = await import("/mobile/js/chunks/settings-dropdown-I3LWLXOL.js");
  ...
  try {
    const main = await import("/mobile/js/chunks/clinical-onboarding-main-5D4T7BZW.js");
...
//# sourceMappingURL=/js/chunks/clinical-sync-mode-settings-5TZMQVDL.js.map
