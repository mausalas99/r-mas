...
async function forceLabMobileSyncPull() {
  ...
  try {
    const { getCloudMobileRuntime } = await import("/mobile/js/chunks/runtime-JNHWYWYE.js");
    const runtime = getCloudMobileRuntime();
    if (!runtime?.syncCycle) {
      const { showToast: showToast2 } = await import("/mobile/js/chunks/ui-toast-SWURMUHL.js");
      showToast2("Sync Nube no est\xE1 activo en esta sesi\xF3n", "error");
      return;
    }
    const { showToast } = await import("/mobile/js/chunks/ui-toast-SWURMUHL.js");
...
//# sourceMappingURL=/js/chunks/chunk-X6BDSFTA.js.map
