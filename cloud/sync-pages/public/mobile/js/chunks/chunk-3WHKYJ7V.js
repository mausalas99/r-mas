...
} from "/mobile/js/chunks/chunk-FXT4EGAN.js";
import {
  isCloudSyncActive
...
async function pushCloudClinicalOpsNow() {
  ...
  const { pushClinicalOpsForSalas, listLocalTeamSalas, pushClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-A7FFMSUY.js");
...
async function pushCloudBundleOps() {
  ...
  try {
    ...
    } = await import("/mobile/js/chunks/cloud-census-collect-HSR7FYCS.js");
...
async function pushCloudCensusNow() {
  ...
  ensureLiveCensusClocks(meta.updatedAt);
  const { collectPatientEntriesForCloudPush } = await import("/mobile/js/chunks/cloud-census-collect-HSR7FYCS.js");
  const entries = await collectPatientEntriesForCloudPush();
  const ops = [];
  for (let i = 0; i < entries.length; i += 1) {
    ops.push(...mapPatientEntryToCloudBundleOps(entries[i], meta));
  ...
  try {
    ...
    const { pushCloudOpsDirect } = await import("/mobile/js/chunks/cloud-push-direct-WFTNUEKG.js");
...
//# sourceMappingURL=/js/chunks/chunk-3WHKYJ7V.js.map
