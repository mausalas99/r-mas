...
} from "/mobile/js/chunks/chunk-PEG2E4FB.js";
import {
...
} from "/mobile/js/chunks/chunk-B4Q7USSM.js";
import {
  isCloudSyncActive
...
async function persistSalaFromModal() {
  ...
  const { persistProfileFromPanel: persistProfileFromPanel2 } = await import("/mobile/js/chunks/teams-roster-profile-persist-DI5UPIDI.js");
...
async function handleOpenMiRotacion() {
  ...
  closeRotationRejoinModal();
  const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/mobile/js/chunks/teams-roster-DXBELHRJ.js");
...
async function confirmNuevaRotacion() {
  ...
  document.dispatchEvent(new CustomEvent("rpc-guardia-rotation-changed"));
  try {
    const { publishClinicalTeamsAfterChange: publishClinicalTeamsAfterChange2 } = await import("/mobile/js/chunks/teams-guardia-bridge-IXAPIYFD.js");
...
function wireGuardiaRotationControls() {
  ...
  void import("/mobile/js/chunks/teams-roster-inherit-patients-modal-BFIQF4B7.js").then(
...
async function ensureClinicalPanelSession(opts = {}) {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/mobile/js/chunks/db-unlock-D272KXOZ.js");
...
async function publishClinicalTeamsToLan() {
  try {
    const mod = await import("/mobile/js/chunks/mutate-bridge-clinical-ops-FV6HYIO4.js");
...
async function pullClinicalOpsFromCloudRoom(options = {}) {
  ...
  cloudClinicalOpsPullInFlight = (async () => {
    try {
      ...
      const { clinicalSessionContext: clinicalSessionContext2 } = await import("/mobile/js/chunks/clinical-access-runtime-SR4BGCT5.js");
      ...
      if (!salas.length) {
        const { autostartCloudSyncIfConfigured } = await import("/mobile/js/chunks/autostart-636AKJRV.js");
        const rtMod = await import("/mobile/js/chunks/panel-conexion-runtime-KWCE7MXJ.js");
...
function scheduleBackgroundClinicalOpsPush(options = {}) {
  void (async () => {
    try {
      const { pushClinicalOpsForSalas, listLocalTeamSalas } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-I6RKIORX.js");
...
async function publishClinicalTeamsAfterChange(options = {}) {
  if (isCloudSyncActive()) {
    try {
      const { pushClinicalOpsForSala, pushClinicalOpsForSalas, listLocalTeamSalas } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-I6RKIORX.js");
...
Desaparecer\xE1 del directorio. Las dem\xE1s R+ en la misma sala Nube lo quitar\xE1n al sincronizar.`
  ...
  const { reloadLanUsersDirectoryAfterMutation } = await import("/mobile/js/chunks/teams-roster-lan-load-5YO462HV.js");
...
async function handleLanAssignButtonClick(btn) {
  ...
  try {
    const { scheduleCloudSyncPush: scheduleCloudSyncPush2 } = await import("/mobile/js/chunks/mutate-bridge-AKDBX5VY.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/mobile/js/chunks/teams-roster-interactions-F3AAOBOV.js");
...
async function refreshTeamsUiAfterChange(opts = {}) {
  const { isLanDirectoryModalOpen: isLanDirectoryModalOpen2 } = await import("/mobile/js/chunks/teams-roster-lan-7EX5OIGN.js");
  if (isLanDirectoryModalOpen2()) return;
  const { refreshClinicalPatientListForScope: refreshClinicalPatientListForScope2 } = await import("/mobile/js/chunks/clinical-access-runtime-SR4BGCT5.js");
  await refreshClinicalPatientListForScope2({ allowLanPull: true });
  import("/mobile/js/chunks/clinical-rotation-entry-QSY6PLN3.js").then((m) => m.syncClinicalRotationEntryChrome());
  if (isClinicalTeamsPanelOpen()) {
    if (!opts.force) {
      const { isClinicalTeamsPanelUserInteracting: isClinicalTeamsPanelUserInteracting2 } = await import("/mobile/js/chunks/teams-roster-panel-draft-MSED542Z.js");
...
async function openClinicalTeamsPanel(opts = {}) {
  ...
  try {
    const { wireClinicalTeamsModalChrome: wireClinicalTeamsModalChrome2 } = await import("/mobile/js/chunks/teams-roster-modal-chrome-AFOSWS67.js");
    wireClinicalTeamsModalChrome2();
  } catch {
  }
  void import("/mobile/js/chunks/cloud-mobile-lan-strip-E46D6SPO.js").then((m) => {
  ...
  if (!sessionOk) {
    ...
    const mainMod = await import("/mobile/js/chunks/clinical-onboarding-main-6UO2PEEB.js");
  ...
  try {
    if (!opts.skipProfileGate) {
      const { needsClinicalOnboarding } = await import("/mobile/js/chunks/clinical-onboarding-ZAKLJDGB.js");
...
async function handleProfileFormSubmit(ev) {
  ...
  void import("/mobile/js/chunks/mutate-bridge-clinical-ops-FV6HYIO4.js").then((mod) => {
    if (typeof mod.pushCloudClinicalOpsNow === "function") void mod.pushCloudClinicalOpsNow();
  }).catch(() => {
  });
  void import("/mobile/js/chunks/patients-NZGK6JDQ.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
async function notifyPatientTeamAssigned(pid, tid) {
  ...
  const lan = await import("/mobile/js/chunks/mutate-bridge-AKDBX5VY.js").catch(() => null);
  if (lan?.pushClinicalOpsLanNow) await lan.pushClinicalOpsLanNow();
  try {
    const cloud = await import("/mobile/js/chunks/mutate-bridge-AKDBX5VY.js");
...
async function onPatientTeamAssignChange(teamId) {
  ...
  if (res.ok) {
    ...
    const patientsMod = await import("/mobile/js/chunks/patients-NZGK6JDQ.js").catch(() => null);
...
async function notifyAssignToast(msg, type) {
  try {
    const shell = await import("/mobile/js/chunks/app-shell-IJZKTG6P.js");
...
async function tryOpenInheritPatientsModal(tid, teamName) {
  const { openInheritPatientsModal, wireInheritPatientsModal } = await import("/mobile/js/chunks/teams-roster-inherit-patients-modal-BFIQF4B7.js");
...
async function joinClinicalTeamByButton(teamId) {
  ...
  void import("/mobile/js/chunks/ensure-turn-room-WZ3BOB5F.js").then(
...
async function resolveTeamIdFromLanDirectory(raw) {
  try {
    const { pullClinicalOpsFromCloudRoom: pullClinicalOpsFromCloudRoom2 } = await import("/mobile/js/chunks/teams-guardia-bridge-IXAPIYFD.js");
    await pullClinicalOpsFromCloudRoom2({ timeoutMs: 8e3, force: true });
    const { fetchClinicalTeamsFromDb: fetchClinicalTeamsFromDb2 } = await import("/mobile/js/chunks/clinical-access-runtime-SR4BGCT5.js");
...
async function finalizeSuccessfulTeamJoin(team, teamId, cycle) {
  ...
  await offerBringPatientsAfterTeamJoin(teamId, team.name || "");
  const { refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/mobile/js/chunks/teams-roster-DXBELHRJ.js");
...
async function redirectLanInviteFromTeamJoinField(raw) {
  ...
  const { openConnectionDropdown } = await import("/mobile/js/chunks/panel-chrome-FNVDVLTI.js");
...
function loadRoster() {
  return import("/mobile/js/chunks/teams-roster-DXBELHRJ.js");
}
...
function wireClinicalTeamsControls() {
  void import("/mobile/js/chunks/teams-roster-modal-chrome-AFOSWS67.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/mobile/js/chunks/clinical-rotation-entry-QSY6PLN3.js").then((mod) => {
    mod.wireClinicalRotationEntryControls();
    mod.syncClinicalRotationEntryChrome();
  });
  void import("/mobile/js/chunks/clinical-rotation-ITZMTUOH.js").then((mod) => {
...
function wireRosterFooter(guardiasMap) {
  document.getElementById("roster-btn-cancel")?.addEventListener("click", () => {
    void (async () => {
      ...
      const { endEntregaPhase: endEntregaPhase2 } = await import("/mobile/js/chunks/clinical-entrega-2SRJBIYS.js");
      endEntregaPhase2();
...
async function persistEntregaFormState(form, opts = {}) {
  ...
  try {
    ...
    import("/mobile/js/chunks/lan-mutation-registry-P655IS3L.js").then(function(m) {
...
async function openEntregaForOrphan(patientId, guardiaId) {
  const entrega = await import("/mobile/js/chunks/clinical-entrega-2SRJBIYS.js");
...
async function removeOrphanPatientLocally(patientId) {
  if (!patientInLocalCensus(patientId)) return;
  const lanMod = await import("/mobile/js/chunks/mutate-bridge-AKDBX5VY.js");
...
function syncGuardiaLearnNudgeChrome() {
  const host = document.getElementById("guardia-census-head");
  if (!host) return;
  void import("/mobile/js/chunks/guardia-v7-progress-YBFV42OK.js").then(function(progressMod) {
...
function appendGuardiaLearnNudge(host) {
  void Promise.all([
    import("/mobile/js/chunks/guardia-v7-progress-YBFV42OK.js"),
    import("/mobile/js/chunks/learn-hub-S2TD64RW.js")
  ]).then(function(mods) {
...
function ensureGuardiaBoardBootstrapped(settings) {
  ...
  void import("/mobile/js/chunks/clinical-rotation-entry-QSY6PLN3.js").then((mod) => {
    mod.syncClinicalRotationEntryChrome?.();
  });
...
function invalidateMobileSidebarPatientCache() {
  if (typeof document === "undefined") return;
  void import("/mobile/js/chunks/patients-NZGK6JDQ.js").then((mod) => {
...
async function countTeamMemberMissingPatients(user, teams, assignments, localIds, now) {
  const { filterJoinedTeams: filterJoinedTeams2 } = await import("/mobile/js/chunks/shared-W2E4VK6A.js");
...
async function refreshClinicalPatientListForScope(options) {
  ...
  setRefreshClinicalPatientListForScopeInFlight(
    (async function() {
      ...
      if (typeof document === "undefined") return;
      try {
        const mod = await import("/mobile/js/chunks/patients-NZGK6JDQ.js");
...
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/mobile/js/chunks/patients-NZGK6JDQ.js").then((mod) => mod.renderPatientList({ silent: true })).catch(() => {
      });
    }
  }
  return migrated;
...
async function refreshDesktopPatientListAfterScopePrune() {
  ...
  try {
    const { renderGuardiaCensusGrid: renderGuardiaCensusGrid2 } = await import("/mobile/js/chunks/guardia-grid-KVX73GVP.js");
...
//# sourceMappingURL=/js/chunks/chunk-QQOJTZU6.js.map
