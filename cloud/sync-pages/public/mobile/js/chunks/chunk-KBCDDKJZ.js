import {
  loadTourProgress
} from "/mobile/js/chunks/chunk-5C7JYUSB.js";
import {
...
function resumeClinicalOnboardingAfterTourIfNeeded() {
  void import("/mobile/js/chunks/tour-flow-UV4RYRZU.js").then((mod) => {
    if (mod && typeof mod.handlePostGuidedTourOnboardingResume === "function") {
      void mod.handlePostGuidedTourOnboardingResume();
      return;
    }
    void import("/mobile/js/chunks/clinical-onboarding-main-6UO2PEEB.js").then((main) => {
...
function tryShowGuidedTourIntroIfNeeded() {
  void import("/mobile/js/chunks/tour-intro-education-27QQNIJG.js").then((mod) => {
...
function initGuidedTourGate() {
  ...
  void import("/mobile/js/chunks/learn-hub-S2TD64RW.js").then(function(hub) {
...
function openTutorialIntroFromSettings() {
  return resolveAppVersionForTour().then(function(v) {
    window.__RPC_APP_VERSION__ = normalizeTourVersionLabel(v);
    return import("/mobile/js/chunks/learn-hub-S2TD64RW.js").then((hub) => {
...
async function tryShowPostRegistrationEducationIfNeeded() {
  ...
  const { needsClinicalOnboarding, needsTeamOnboardingStep } = await import("/mobile/js/chunks/clinical-onboarding-ZAKLJDGB.js");
  ...
  const { isGuardiaV7TrackComplete } = await import("/mobile/js/chunks/guardia-v7-progress-YBFV42OK.js");
  ...
  if (shouldOfferGuardiaV7Education({
    ...
    const { maybeShowGuardiaV7UpgradeCard } = await import("/mobile/js/chunks/guardia-v7-upgrade-card-LDBMCXWN.js");
  ...
  if (shouldShowFundamentosTourIntro({ curVersion: cur, storedDoneVersion: stored, needsOnboarding: false })) {
    markGuidedTourVersionDone();
    setTimeout(() => {
      void import("/mobile/js/chunks/learn-hub-S2TD64RW.js").then((hub) => {
        if (typeof hub.openLearnHub === "function") hub.openLearnHub({ focusTrack: "fundamentos" });
      });
    }, 80);
  }
...
//# sourceMappingURL=/js/chunks/chunk-KBCDDKJZ.js.map
