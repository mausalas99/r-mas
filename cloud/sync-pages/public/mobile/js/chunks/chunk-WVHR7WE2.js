...
} from "/mobile/js/chunks/chunk-WCE7POEC.js";
import {
  renderSyncModeChoicePanel,
  wireSyncModeOnboardingInteractions
} from "/mobile/js/chunks/chunk-273EBOQL.js";
import {
...
function hideMainClinicalOnboarding() {
  ...
  void import("/mobile/js/chunks/tour-engine-6MTETQBB.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/mobile/js/chunks/learn-hub-5RHCGI6C.js").then((m) => {
...
async function refreshTeamOnboardingShellOnly() {
  ...
  const { renderTeamOnboardingInto, wireTeamOnboardingInteractions } = await import("/mobile/js/chunks/clinical-onboarding-team-3OBHCP5S.js");
...
async function reloadClinicalTeamsBeforeGate() {
  try {
    const { fetchClinicalTeamsFromDb } = await import("/mobile/js/chunks/clinical-access-runtime-OFZ4WTIT.js");
...
async function resumeStoredCloudTokenIfPresent() {
  try {
    ...
    const { tryResumeOnboardingFromStoredCloudToken } = await import("/mobile/js/chunks/clinical-onboarding-existing-login-YFFT6LO7.js");
...
async function renderOnboardingRegistrationForm(host) {
  ...
  try {
    ...
    prefillRegistrationFromUrlParams();
    wireClinicalRegistrationForm();
    const rot = await import("/mobile/js/chunks/clinical-rotation-entry-DPKDAZ3H.js");
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/mobile/js/chunks/settings-dropdown-FI4QDWTS.js");
...
//# sourceMappingURL=/js/chunks/chunk-WVHR7WE2.js.map
