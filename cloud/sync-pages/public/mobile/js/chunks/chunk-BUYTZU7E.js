...
async function connectShiftPinIfNeeded_(shiftPin, sala, _runtime) {
  ...
  if (isLanSkipShiftPin()) {
    var { tryEasyLanShiftPinConnect } = await import("/mobile/js/chunks/lan-shift-pin-connect-6VUXJOEJ.js");
    await tryEasyLanShiftPinConnect({ sala, force: true });
    return;
  }
  if (!shiftPin) return;
  var { connectLanWithShiftPin } = await import("/mobile/js/chunks/lan-shift-pin-connect-6VUXJOEJ.js");
...
async function handleClinicalRegistrationSubmit(deps) {
  ...
  const { refreshClinicalUserProfile } = await import("/mobile/js/chunks/clinical-access-runtime-AE6KBGJD.js");
...
//# sourceMappingURL=/js/chunks/chunk-BUYTZU7E.js.map
