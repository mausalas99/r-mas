...
} from "/mobile/js/chunks/chunk-2NQHBQXK.js";
import {
  fundamentosModuleCount,
  isFundamentosChapterId,
  loadFundamentosProgress
} from "/mobile/js/chunks/chunk-MK4XUM7H.js";
import {
  GUARDIA_V7_CHAPTERS,
...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/mobile/js/chunks/tour-runtime-PGUQ67GG.js").then((mod) => {
...
function wireLearnHubBodyOnce(host) {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-continue")) {
      closeLearnHub();
      void import("/mobile/js/chunks/tour-flow-JM6YR64K.js").then((mod) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/mobile/js/chunks/help-content-MHFTDYFS.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-I3AXFSR6.js.map
