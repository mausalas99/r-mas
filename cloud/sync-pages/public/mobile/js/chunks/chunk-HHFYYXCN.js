...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/mobile/js/chunks/entrega-roster-panel-M3T46QHB.js").then(({ closeEntregaRosterPanel }) => {
      closeEntregaRosterPanel();
    });
    void import("/mobile/js/chunks/clinical-entrega-D6KFNGZJ.js").then(({ endEntregaPhase }) => {
      endEntregaPhase();
    });
    void import("/mobile/js/chunks/guardia-phase-bar-FY7VV2EL.js").then(({ teardownGuardiaPhaseBar }) => {
...
//# sourceMappingURL=/js/chunks/chunk-HHFYYXCN.js.map
