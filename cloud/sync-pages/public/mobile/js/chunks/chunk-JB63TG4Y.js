...
} from "/mobile/js/chunks/chunk-BZPGDWNR.js";
import {
...
} from "/mobile/js/chunks/chunk-HKGXY6ZZ.js";
import {
  collectClinicalLsSnapshot
} from "/mobile/js/chunks/chunk-FVMS5JSH.js";
import {
...
} from "/mobile/js/chunks/chunk-CYT2QRK7.js";
import {
  isMobileWeb
...
async function ensureClinicalPanelSession(opts = {}) {
  ...
  try {
    const { applyClinicalDbUnlockCompletion } = await import("/mobile/js/chunks/db-unlock-VSGCQ7XR.js");
...
async function publishClinicalTeamsToLan() {
  try {
    const mod = await import("/mobile/js/chunks/mutate-bridge-clinical-ops-N3MBOG4W.js");
...
async function pullClinicalOpsFromCloudRoom(options = {}) {
  ...
  cloudClinicalOpsPullInFlight = (async () => {
    try {
      ...
      const { clinicalSessionContext: clinicalSessionContext2 } = await import("/mobile/js/chunks/clinical-access-runtime-KAV32YSL.js");
      ...
      if (!salas.length) {
        const { autostartCloudSyncIfConfigured } = await import("/mobile/js/chunks/autostart-UFJVRAKN.js");
        const rtMod = await import("/mobile/js/chunks/panel-conexion-runtime-FX2N7ZMR.js");
      ...
      const { pullClinicalOpsForSala } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-3E432XUZ.js");
...
function scheduleBackgroundClinicalOpsPush(options = {}) {
  void (async () => {
    try {
      const { pushClinicalOpsForSalas, listLocalTeamSalas } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-3E432XUZ.js");
...
async function publishClinicalTeamsAfterChange(options = {}) {
  if (isCloudSyncActive()) {
    try {
      const { pushClinicalOpsForSala, pushClinicalOpsForSalas, listLocalTeamSalas } = await import("/mobile/js/chunks/cloud-clinical-ops-sala-3E432XUZ.js");
...
Desaparecer\xE1 del directorio. Las dem\xE1s R+ en la misma sala Nube lo quitar\xE1n al sincronizar.`
  ...
  const { reloadLanUsersDirectoryAfterMutation } = await import("/mobile/js/chunks/teams-roster-lan-load-SPAHLUVI.js");
...
async function handleLanAssignButtonClick(btn) {
  ...
  try {
    const { scheduleCloudSyncPush: scheduleCloudSyncPush2 } = await import("/mobile/js/chunks/mutate-bridge-BUUZP6MQ.js");
...
async function resolveClinicalTeamsPanelContext(user, joined) {
  ...
  const { needsClinicalLanProfileGate: needsClinicalLanProfileGate2, ensureLanProfileGateDeviceReset } = await import("/mobile/js/chunks/clinical-settings-KXWATNLD.js");
...
async function renderClinicalTeamsPanelInto(host, opts = {}) {
  ...
  const { wireRenderedClinicalTeamsPanel: wireRenderedClinicalTeamsPanel2 } = await import("/mobile/js/chunks/teams-roster-interactions-4GGIGDKP.js");
...
async function refreshTeamsUiAfterChange(opts = {}) {
  const { isLanDirectoryModalOpen: isLanDirectoryModalOpen2 } = await import("/mobile/js/chunks/teams-roster-lan-AAFIQAIL.js");
  if (isLanDirectoryModalOpen2()) return;
  const { refreshClinicalPatientListForScope: refreshClinicalPatientListForScope2 } = await import("/mobile/js/chunks/clinical-access-runtime-KAV32YSL.js");
  await refreshClinicalPatientListForScope2({ allowLanPull: true });
  import("/mobile/js/chunks/clinical-rotation-entry-HJMTCXVR.js").then((m) => m.syncClinicalRotationEntryChrome());
  if (isClinicalTeamsPanelOpen()) {
    if (!opts.force) {
      const { isClinicalTeamsPanelUserInteracting: isClinicalTeamsPanelUserInteracting2 } = await import("/mobile/js/chunks/teams-roster-panel-draft-LZHULIDT.js");
...
async function openClinicalTeamsPanel(opts = {}) {
  ...
  try {
    const { wireClinicalTeamsModalChrome: wireClinicalTeamsModalChrome2 } = await import("/mobile/js/chunks/teams-roster-modal-chrome-RJHGNB7E.js");
  ...
  if (!sessionOk) {
    ...
    const mainMod = await import("/mobile/js/chunks/clinical-onboarding-main-RY7HE6NV.js");
  ...
  try {
    if (!opts.skipProfileGate) {
      const { needsClinicalOnboarding: needsClinicalOnboarding2 } = await import("/mobile/js/chunks/clinical-onboarding-E22OJSDA.js");
...
async function persistProfileFromPanel(fields) {
  ...
  if (ok && upgraded) {
    ...
    try {
      const main = await import("/mobile/js/chunks/clinical-onboarding-main-RY7HE6NV.js");
...
async function handleProfileFormSubmit(ev) {
  ...
  void import("/mobile/js/chunks/mutate-bridge-clinical-ops-N3MBOG4W.js").then((mod) => {
    if (typeof mod.pushCloudClinicalOpsNow === "function") void mod.pushCloudClinicalOpsNow();
  }).catch(() => {
  });
  void import("/mobile/js/chunks/patients-PJWNILQK.js").then((m) => m.renderPatientList()).catch(() => {
  });
}
...
async function joinClinicalTeamByButton(teamId) {
  ...
  void import("/mobile/js/chunks/ensure-turn-room-Q5PSI4QG.js").then(
...
function wireInheritPatientsButtons() {
  document.querySelectorAll(".clinical-teams-inherit-btn").forEach((btn) => {
    ...
    btn.addEventListener("click", async () => {
      ...
      const { openInheritPatientsModal, wireInheritPatientsModal } = await import("/mobile/js/chunks/teams-roster-inherit-patients-modal-N74SJJ2F.js");
...
async function resolveTeamIdFromLanDirectory(raw) {
  try {
    const { pullClinicalOpsFromCloudRoom: pullClinicalOpsFromCloudRoom2 } = await import("/mobile/js/chunks/teams-guardia-bridge-ENA3P4UD.js");
    await pullClinicalOpsFromCloudRoom2({ timeoutMs: 8e3, force: true });
    const { fetchClinicalTeamsFromDb: fetchClinicalTeamsFromDb2 } = await import("/mobile/js/chunks/clinical-access-runtime-KAV32YSL.js");
...
async function openTeamsPanelAfterAlreadyJoined() {
  ...
  const { openClinicalTeamsPanel: openClinicalTeamsPanel2 } = await import("/mobile/js/chunks/teams-roster-M5ZVOJB2.js");
...
async function finalizeSuccessfulTeamJoin(team, teamId, cycle) {
  ...
  const { refreshTeamsUiAfterChange: refreshTeamsUiAfterChange2 } = await import("/mobile/js/chunks/teams-roster-M5ZVOJB2.js");
...
async function redirectLanInviteFromTeamJoinField(raw) {
  ...
  const { openConnectionDropdown } = await import("/mobile/js/chunks/panel-chrome-7KHDENBG.js");
...
function loadRoster() {
  return import("/mobile/js/chunks/teams-roster-M5ZVOJB2.js");
}
...
function wireClinicalTeamsControls() {
  void import("/mobile/js/chunks/teams-roster-modal-chrome-RJHGNB7E.js").then((m) => m.wireClinicalTeamsModalChrome());
  if (teamsControlsWired) return;
  teamsControlsWired = true;
  import("/mobile/js/chunks/clinical-rotation-entry-HJMTCXVR.js").then((mod) => {
    mod.wireClinicalRotationEntryControls();
    mod.syncClinicalRotationEntryChrome();
  });
  void import("/mobile/js/chunks/clinical-rotation-E5Q4TTQM.js").then((mod) => {
...
async function persistSalaFromModal() {
  ...
  const { persistProfileFromPanel: persistProfileFromPanel2 } = await import("/mobile/js/chunks/teams-roster-profile-persist-TUOVKJT4.js");
  const user = clinicalSessionContext.user || {};
...
async function confirmNuevaRotacion() {
  ...
  document.dispatchEvent(new CustomEvent("rpc-guardia-rotation-changed"));
  try {
    const { publishClinicalTeamsAfterChange: publishClinicalTeamsAfterChange2 } = await import("/mobile/js/chunks/teams-guardia-bridge-ENA3P4UD.js");
...
function wireGuardiaRotationControls() {
  ...
  void import("/mobile/js/chunks/teams-roster-inherit-patients-modal-N74SJJ2F.js").then(
...
async function notifyPatientTeamAssigned(pid, tid) {
  ...
  await fetchClinicalScopeContextFromDb();
  const lan = await import("/mobile/js/chunks/mutate-bridge-BUUZP6MQ.js").catch(() => null);
  if (lan?.pushClinicalOpsLanNow) await lan.pushClinicalOpsLanNow();
  try {
    const cloud = await import("/mobile/js/chunks/mutate-bridge-BUUZP6MQ.js");
...
async function onPatientTeamAssignChange(teamId) {
  ...
  if (res.ok) {
    ...
    const patientsMod = await import("/mobile/js/chunks/patients-PJWNILQK.js").catch(() => null);
...
async function notifyAssignToast(msg, type) {
  try {
    const shell = await import("/mobile/js/chunks/app-shell-MU274FJL.js");
...
function wireRosterFooter(guardiasMap) {
  document.getElementById("roster-btn-cancel")?.addEventListener("click", () => {
    void (async () => {
      ...
      const { endEntregaPhase: endEntregaPhase2 } = await import("/mobile/js/chunks/clinical-entrega-D6KFNGZJ.js");
      endEntregaPhase2();
...
async function tryRestoreOrphanPatientFromLan(patientId) {
  ...
  const lan = await import("/mobile/js/chunks/mutate-bridge-BUUZP6MQ.js");
...
async function openEntregaForOrphan(patientId, guardiaId) {
  const entrega = await import("/mobile/js/chunks/clinical-entrega-D6KFNGZJ.js");
...
async function removeOrphanPatientLocally(patientId) {
  if (!patientInLocalCensus(patientId)) return;
  const lanMod = await import("/mobile/js/chunks/mutate-bridge-BUUZP6MQ.js");
...
function appendGuardiaLearnNudge(host) {
  void Promise.all([
    ...
    import("/mobile/js/chunks/learn-hub-AUOVLRBJ.js")
  ]).then(function(mods) {
...
function ensureGuardiaBoardBootstrapped(settings) {
  ...
  void import("/mobile/js/chunks/clinical-rotation-entry-HJMTCXVR.js").then((mod) => {
    mod.syncClinicalRotationEntryChrome?.();
  });
...
function invalidateMobileSidebarPatientCache() {
  if (typeof document === "undefined") return;
  void import("/mobile/js/chunks/patients-PJWNILQK.js").then((mod) => {
...
async function countTeamMemberMissingPatients(user, teams, assignments, localIds, now) {
  const { filterJoinedTeams: filterJoinedTeams2 } = await import("/mobile/js/chunks/shared-GLOQVNWN.js");
...
async function refreshClinicalPatientListForScope(options) {
  ...
  setRefreshClinicalPatientListForScopeInFlight(
    (async function() {
      ...
      if (typeof document === "undefined") return;
      try {
        const mod = await import("/mobile/js/chunks/patients-PJWNILQK.js");
...
function migrateLocalPatientsClinicalSala() {
  ...
  if (migrated > 0) {
    ...
    if (typeof document !== "undefined") {
      void import("/mobile/js/chunks/patients-PJWNILQK.js").then((mod) => mod.renderPatientList({ silent: true })).catch(() => {
      });
    }
  }
  return migrated;
...
async function refreshClinicalUserProfile() {
  const { ensureLanProfileGateDeviceReset } = await import("/mobile/js/chunks/clinical-settings-KXWATNLD.js");
...
async function refreshDesktopPatientListAfterScopePrune() {
  ...
  try {
    const { renderGuardiaCensusGrid: renderGuardiaCensusGrid2 } = await import("/mobile/js/chunks/guardia-grid-YIRZODEX.js");
...
//# sourceMappingURL=/js/chunks/chunk-JB63TG4Y.js.map
