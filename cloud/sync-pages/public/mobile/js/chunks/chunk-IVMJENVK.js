...
} from "/mobile/js/chunks/chunk-WVHR7WE2.js";
import {
  hideTourIntroModal,
...
} from "/mobile/js/chunks/chunk-AZYHJLRG.js";
import {
...
} from "/mobile/js/chunks/chunk-DJZDGTZ7.js";
import {
  DEMO_PATIENT_ID,
  DEMO_PATIENT_ID_2,
  DEMO_REGISTRO,
...
function ensureConnectionExpandedForTour(_stepId) {
  ...
  void import("/mobile/js/chunks/panel-conexion-tour-Y3YO23AN.js").then(function(m) {
...
function applyGuardiaTourLayoutForStep(stepId) {
  void import("/mobile/js/chunks/tour-guards-BTBYLE5G.js").then((guards) => {
    ...
    if (guards.shouldShowGuardiaBoardWithoutEntrega(stepId)) {
      void Promise.all([
        import("/mobile/js/chunks/clinical-entrega-MXCLZZTE.js"),
        import("/mobile/js/chunks/entrega-roster-panel-B32VGCKX.js")
      ]).then(([entrega, roster]) => {
    ...
    if (guards.shouldOpenEntregaRosterForTour(stepId)) {
      void import("/mobile/js/chunks/clinical-entrega-MXCLZZTE.js").then((entrega) => {
        ...
        void import("/mobile/js/chunks/entrega-roster-panel-B32VGCKX.js").then((roster) => {
...
function seedIcBoardDemoForTour() {
  void import("/mobile/js/chunks/interconsulta-demo-toggle-JSBCKAFH.js").then((m) => {
    if (!m.isInterconsultaDemoActive()) m.seedInterconsultaDemoOnMainApp(/* @__PURE__ */ new Date());
  });
}
function seedIcConsultBandDemoForTour() {
  Promise.all([import("/mobile/js/chunks/patients-bridge-LBA365TC.js"), import("/mobile/js/chunks/interconsulta-mode-chrome-UZYTOZA5.js")]).then(
    ([pb, ic]) => {
...
function applyTourOverlayChromeForStep(id, t) {
  ...
  if (t.showIcBoard) {
    void import("/mobile/js/chunks/interconsulta-mode-chrome-UZYTOZA5.js").then((m) => {
...
function applyTourTargetForStep(id) {
  ...
  if (id === "gv7_trust_strip") {
    void import("/mobile/js/chunks/guardia-trust-strip-ZEZWS5BN.js").then((m) => {
...
function maybeMarkGuardiaV7ChapterComplete(stepId) {
  ...
  void import("/mobile/js/chunks/guardia-v7-progress-HEZKRSIW.js").then((m) => {
    ...
    if (m.isGuardiaV7TrackComplete()) {
      void import("/mobile/js/chunks/guardia-board-chrome-XNJBCEKX.js").then((chrome) => {
...
async function promptMiRotacionAfterSalaTourIfNeeded(branch) {
  ...
  const { needsTeamOnboarding } = await import("/mobile/js/chunks/clinical-onboarding-QL3MWQA3.js");
  ...
  const { ensureClinicalPanelSession } = await import("/mobile/js/chunks/clinical-panel-host-TIK6UGE4.js");
  ...
  try {
    const { wireClinicalTeamsModalChrome } = await import("/mobile/js/chunks/teams-roster-modal-chrome-56MFDDA4.js");
    ...
    const { openMiRotacion } = await import("/mobile/js/chunks/clinical-rotation-entry-DPKDAZ3H.js");
...
//# sourceMappingURL=/js/chunks/chunk-IVMJENVK.js.map
