...
async function undoLastOperation() {
  ...
  var result = await openConfirm({
    weight: "consequence",
    title: '\xBFRevertir "' + (snap.label || "\xFAltima operaci\xF3n") + '"?',
    consequenceText: "La aplicaci\xF3n se recargar\xE1.",
...
async function deleteExtraTemplate(id) {
  var arr = ensureExtraTemplatesArray();
  var tmpl = arr.find(function(t) {
    return t.id === id;
  });
  ...
  var result = await openConfirm({
    weight: "destructive",
    title: '\xBFEliminar la plantilla "' + (tmpl.label || "") + '"?',
...
//# sourceMappingURL=/js/chunks/chunk-W47JGUYX.js.map
