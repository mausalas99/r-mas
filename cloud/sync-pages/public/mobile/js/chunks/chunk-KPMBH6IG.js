...
function toggleGuardiaMode() {
  if (isGuardiaMode()) {
    void import("/mobile/js/chunks/entrega-roster-panel-A4VEU3LI.js").then(({ closeEntregaRosterPanel }) => {
      closeEntregaRosterPanel();
    });
    void import("/mobile/js/chunks/clinical-entrega-2SRJBIYS.js").then(({ endEntregaPhase }) => {
      endEntregaPhase();
    });
    void import("/mobile/js/chunks/guardia-phase-bar-FR6D6MEN.js").then(({ teardownGuardiaPhaseBar }) => {
...
//# sourceMappingURL=/js/chunks/chunk-KPMBH6IG.js.map
