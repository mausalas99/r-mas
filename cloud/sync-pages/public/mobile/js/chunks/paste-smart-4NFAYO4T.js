...
function loadLabPasteRuntime() {
  return import("/mobile/js/chunks/lazy-feature-routes-Q6ZFNJCB.js").then(function(routes) {
    return routes.ensureLabsLoaded();
  }).then(function() {
    return Promise.all([
      import("/mobile/js/chunks/lab-bulk-preview-modal-5VZDCTSS.js"),
      import("/mobile/js/chunks/lab-panel-workbench-SIMW3RY6.js")
    ]);
  }).then(function(mods) {
    return {
...
//# sourceMappingURL=/js/chunks/paste-smart-4NFAYO4T.js.map
