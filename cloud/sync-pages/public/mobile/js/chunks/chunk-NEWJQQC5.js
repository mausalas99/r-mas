...
var HELP_ARTICLES = [
  ...
  },
  {
    ...
    html: "<p>Cuatro pesta\xF1as arriba: <strong>Paciente</strong>, <strong>Laboratorio</strong>, <strong>Manejo</strong> y <strong>Agenda</strong>.</p><ul><li><strong>Paciente</strong> abre en <strong>Resumen</strong>. Grupos: Resumen \xB7 Cl\xEDnico \xB7 Salida. Atajo <strong>\u2318/Ctrl+1</strong> (repite para ciclar).</li><li><strong>Laboratorio</strong>: Labs \xB7 Tendencias \xB7 Cultivos. Atajo <strong>\u2318/Ctrl+2</strong> (repite para ciclar).</li><li><strong>Manejo</strong> es la receta hospitalaria (no est\xE1 dentro de Paciente). <strong>Agenda</strong> concentra procedimientos del turno.</li><li>La columna izquierda es el <strong>censo</strong>. <strong>+ Agregar</strong> da de alta; sin cuarto, cama o servicio la tarjeta queda incompleta.</li></ul>"
  },
  {
    id: "primer-paciente",
    title: "Tu primer paciente",
    keywords: "agregar paciente nuevo registro edad sexo cuarto cama duplicado incompleto alta censo",
    html: "<p>Agrega un paciente desde la barra lateral con <strong>+ Agregar</strong> o desde un reporte de laboratorio procesado (<strong>Agregar paciente</strong>).</p><ul><li>Nombre y registro bastan para empezar. <strong>Cuarto</strong>, <strong>cama</strong> y <strong>servicio</strong> cierran el censo: si faltan, la tarjeta queda <strong>incompleta</strong> \u2014 \xE1brela y completa.</li><li>R+ avisa si detecta el mismo nombre o registro para evitar duplicados.</li><li>Con <strong>R+ Cloud</strong> conectado, el alta se comparte con el equipo de la sala. Sin Nube, queda en este equipo.</li></ul>"
  },
  {
    id: "nube-vs-respaldo",
...
//# sourceMappingURL=/js/chunks/chunk-NEWJQQC5.js.map
