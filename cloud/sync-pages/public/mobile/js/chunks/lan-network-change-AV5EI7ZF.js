...
} from "/mobile/js/chunks/chunk-HTYUJDH3.js";
import {
...
async function restartLanDiscoveryAfterNetworkChange() {
  ...
  seedBundledWardConnectionPoints();
  const room = await import("/mobile/js/chunks/room-LGGBGSPP.js");
  if (typeof room.resumeAutoHostDetectAndReconnect === "function") {
    room.resumeAutoHostDetectAndReconnect();
  }
  const panel = await import("/mobile/js/chunks/panel-ETZBXEO5.js");
  ...
  const transport = await import("/mobile/js/chunks/transport-2TCXW235.js");
  const pin = await import("/mobile/js/chunks/lan-shift-pin-connect-P2H6BGVU.js");
...
//# sourceMappingURL=/js/chunks/lan-network-change-AV5EI7ZF.js.map
