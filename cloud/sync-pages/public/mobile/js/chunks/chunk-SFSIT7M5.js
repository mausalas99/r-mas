...
} from "/mobile/js/chunks/chunk-GOCO3KEM.js";
import {
  isCutoverDone,
  isCutoverPending,
  setCutoverFlag
...
async function defaultAssignPatientToTeam(patientId, teamId) {
  const { assignPatientToTeamClinical } = await import("/mobile/js/chunks/patient-team-assign-ui-UJD2H2IM.js");
...
async function handleUsernameStepSubmit(ev) {
  ...
  try {
    ...
    const { refreshMainClinicalOnboardingIfNeeded } = await import("/mobile/js/chunks/clinical-onboarding-main-H75X5GZK.js");
...
async function renderCompletedOnboarding(host) {
  ...
  if (host.closest("#clinical-teams-panel-body")) {
    const { renderClinicalTeamsPanel } = await import("/mobile/js/chunks/clinical-teams-7MP6IW2K.js");
...
async function renderNoSessionOnboarding(host) {
  ...
  const { buildOnboardingSessionBlockHtml } = await import("/mobile/js/chunks/clinical-onboarding-main-H75X5GZK.js");
...
//# sourceMappingURL=/js/chunks/chunk-SFSIT7M5.js.map
