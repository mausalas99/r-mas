...
function loadLabPasteRuntime() {
  return import("/mobile/js/chunks/lazy-feature-routes-M6YXD76H.js").then(function(routes) {
    return routes.ensureLabsLoaded();
  }).then(function() {
    return Promise.all([
      import("/mobile/js/chunks/lab-bulk-preview-modal-NNDHQUKJ.js"),
      import("/mobile/js/chunks/lab-panel-workbench-5N6W2MSK.js")
    ]);
  }).then(function(mods) {
    return {
...
//# sourceMappingURL=/js/chunks/paste-smart-DQNDS2CC.js.map
