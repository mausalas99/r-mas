import {
  ...
  handleRegister,
  renderAfterAuth
} from "/mobile/js/chunks/chunk-SUKFT7F5.js";
import {
...
function mountAdminShell(section, deps, toast) {
  ...
  async function ensureAdminOpen() {
    ...
    if (!host) return;
    if (!adminMount) {
      const { mountCloudAdminPanel } = await import("/mobile/js/chunks/panel-admin-PV76ZGJ3.js");
      host.textContent = "";
...
//# sourceMappingURL=/js/chunks/panel-nube-section-O52O5XGZ.js.map
