...
} from "/mobile/js/chunks/chunk-SFSIT7M5.js";
import {
  renderSyncModeChoicePanel,
  wireSyncModeOnboardingInteractions
} from "/mobile/js/chunks/chunk-AKOXVOX7.js";
import {
...
function hideMainClinicalOnboarding() {
  ...
  void import("/mobile/js/chunks/tour-engine-ZASB33Q6.js").then((m) => {
    if (typeof m.tryShowPostRegistrationEducationIfNeeded === "function") {
      void m.tryShowPostRegistrationEducationIfNeeded();
    }
  });
  void import("/mobile/js/chunks/learn-hub-MOTWQ4OS.js").then((m) => {
...
async function refreshTeamOnboardingShellOnly() {
  ...
  const { renderTeamOnboardingInto, wireTeamOnboardingInteractions } = await import("/mobile/js/chunks/clinical-onboarding-team-QDAWH2EM.js");
...
async function reloadClinicalTeamsBeforeGate() {
  try {
    const { fetchClinicalTeamsFromDb } = await import("/mobile/js/chunks/clinical-access-runtime-AIZQAPAG.js");
...
async function resumeStoredCloudTokenIfPresent() {
  try {
    const { getCloudSyncToken } = await import("/mobile/js/chunks/settings-X3WJCWR2.js");
    if (!getCloudSyncToken()) return;
    const { tryResumeOnboardingFromStoredCloudToken } = await import("/mobile/js/chunks/clinical-onboarding-existing-login-X2V2ELSM.js");
...
async function renderOnboardingRegistrationForm(host) {
  ...
  try {
    ...
    prefillRegistrationFromUrlParams();
    wireClinicalRegistrationForm();
    const rot = await import("/mobile/js/chunks/clinical-rotation-entry-KWXHGOOS.js");
...
async function syncChromeAfterOnboardingChange() {
  ...
  try {
    const settings = await import("/mobile/js/chunks/settings-dropdown-OHH3ADKS.js");
...
//# sourceMappingURL=/js/chunks/chunk-WG3CB4AY.js.map
