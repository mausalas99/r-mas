...
async function openConexionEquipoPanel(opts = {}) {
  ...
  if (!section) {
    const { openClinicalTeamsPanelModal } = await import("/mobile/js/chunks/teams-roster-shell-TUY2QMXN.js");
  ...
  if (!opts.skipProfileGate) {
    try {
      const { needsClinicalOnboarding } = await import("/mobile/js/chunks/clinical-onboarding-5IK256U3.js");
...
//# sourceMappingURL=/js/chunks/panel-equipo-nav-YYUH3XRS.js.map
