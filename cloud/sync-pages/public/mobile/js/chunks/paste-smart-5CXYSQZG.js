...
function loadLabPasteRuntime() {
  return import("/mobile/js/chunks/lazy-feature-routes-QX4QMBNP.js").then(function(routes) {
    return routes.ensureLabsLoaded();
  }).then(function() {
    return Promise.all([
      import("/mobile/js/chunks/lab-bulk-preview-modal-VEVCHJG5.js"),
      import("/mobile/js/chunks/lab-panel-workbench-RKSA7UVY.js")
    ]);
  }).then(function(mods) {
    return {
...
//# sourceMappingURL=/js/chunks/paste-smart-5CXYSQZG.js.map
