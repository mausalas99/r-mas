...
} from "/mobile/js/chunks/chunk-6PGGUNDR.js";
import {
  loadGuardiaV7Progress,
  resetGuardiaV7Chapter
} from "/mobile/js/chunks/chunk-LUVBSH6H.js";
import {
  loadTourProgress
...
function startLearnModule(chapterId) {
  closeLearnHub();
  void import("/mobile/js/chunks/tour-runtime-32IHKISR.js").then((mod) => {
...
function renderLearnHubQuickRouteCard(parts) {
  parts.push(
    `<div class="learn-hub-module-card learn-hub-module-card--cta learn-hub-module-card--quick"><button type="button" class="learn-hub-module-hit learn-hub-module-hit--cta" data-learn-chapter="${escapeHtml(QUICK_ROUTE_HUB_MODULE.chapterId)}" data-learn-branch="quick-route" title="Ruta r\xE1pida \u2014 mapa, alta, labs y turno"><span class="learn-hub-module-index learn-hub-module-index--cta" aria-hidden="true">5\u2032</span><span class="learn-hub-module-main"><span class="learn-hub-module-title">${escapeHtml(QUICK_ROUTE_HUB_MODULE.label)}</span><span class="learn-hub-module-meta">${QUICK_ROUTE_HUB_MODULE.stepCount} pasos \xB7 ~5 min</span></span><span class="learn-hub-module-chevron" aria-hidden="true">\u203A</span></button></div>`
  );
}
...
function renderLearnHubFundamentosTrack(parts, focusTrack, fundamentosProgress, tourProgress) {
  ...
  parts.push('<div class="learn-hub-track-body">');
  parts.push(
    '<p class="learn-hub-fundamentos-lead">Empieza por la estructura (Paciente \xB7 Laboratorio \xB7 Manejo), da de alta y completa cuarto/cama/servicio. DEMO P\xC9REZ en ~15 min. Elige Sala o Interconsulta seg\xFAn tu rol.</p>'
  );
...
function wireLearnHubBodyOnce(host) {
  ...
  host.addEventListener("click", (ev) => {
    ...
    if (ev.target.closest("#learn-hub-btn-continue")) {
      closeLearnHub();
      void import("/mobile/js/chunks/tour-flow-GCQPM3GW.js").then((mod) => {
    ...
    if (ev.target.closest("#learn-hub-btn-help")) {
      ...
      if (typeof settingsHelpBridge.openQuickHelp === "function") {
        ...
        void import("/mobile/js/chunks/help-content-76QASQKH.js").then((mod) => {
...
//# sourceMappingURL=/js/chunks/chunk-JIMIXI3V.js.map
