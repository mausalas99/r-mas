...
} from "/mobile/js/chunks/chunk-BZFH7ZFF.js";
import {
  ensureTurnRoom
} from "/mobile/js/chunks/chunk-22PMAIWL.js";
import {
  createCloudSyncApi
...
async function scheduleOptionalPush() {
  try {
    const { scheduleCloudSyncPush } = await import("/mobile/js/chunks/mutate-bridge-NAGIKQFO.js");
...
function wireExistingAccountLoginInteractions() {
  ...
  if (switchBtn && !switchBtn._rpcSwitchExistingWired) {
    ...
    switchBtn.addEventListener("click", () => {
      setClinicalExistingAccountPath(true);
      void import("/mobile/js/chunks/clinical-onboarding-main-RTQEC5VT.js").then((m) => m.refreshMainClinicalOnboardingIfNeeded());
    });
  }
}
...
//# sourceMappingURL=/js/chunks/chunk-DIWOGDCA.js.map
