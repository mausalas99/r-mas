...
import {
  ensureTurnRoom
} from "/mobile/js/chunks/chunk-P2KI6J4W.js";
import {
  createCloudSyncApi
...
async function scheduleOptionalPush() {
  try {
    const { scheduleCloudSyncPush } = await import("/mobile/js/chunks/mutate-bridge-OGE2GEEP.js");
...
function wireExistingAccountLoginInteractions() {
  ...
  if (switchBtn && !switchBtn._rpcSwitchExistingWired) {
    ...
    switchBtn.addEventListener("click", () => {
      setClinicalExistingAccountPath(true);
      void import("/mobile/js/chunks/clinical-onboarding-main-H75X5GZK.js").then((m) => m.refreshMainClinicalOnboardingIfNeeded());
    });
  }
}
...
//# sourceMappingURL=/js/chunks/chunk-AKOXVOX7.js.map
