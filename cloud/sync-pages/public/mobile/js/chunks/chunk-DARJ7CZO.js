...
async function connectShiftPinIfNeeded_(shiftPin, sala, _runtime) {
  ...
  if (isLanSkipShiftPin()) {
    var { tryEasyLanShiftPinConnect } = await import("/mobile/js/chunks/lan-shift-pin-connect-IC6DCXRK.js");
    await tryEasyLanShiftPinConnect({ sala, force: true });
    return;
  }
  if (!shiftPin) return;
  var { connectLanWithShiftPin } = await import("/mobile/js/chunks/lan-shift-pin-connect-IC6DCXRK.js");
...
async function handleClinicalRegistrationSubmit(deps) {
  ...
  const { refreshClinicalUserProfile } = await import("/mobile/js/chunks/clinical-access-runtime-AH4HT4U3.js");
...
//# sourceMappingURL=/js/chunks/chunk-DARJ7CZO.js.map
