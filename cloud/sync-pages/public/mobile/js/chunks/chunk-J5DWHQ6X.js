...
import {
  ...
  todoPriorityLabel
} from "/mobile/js/chunks/chunk-3BAWU2QN.js";
import {
...
function buildTodoRow(t) {
  ...
  expand.addEventListener("click", function(ev) {
    ev.preventDefault();
    ev.stopPropagation();
    var detail2 = row.querySelector(".todo-row-detail");
    if (!detail2) return;
    var open = detail2.classList.toggle("is-open");
  ...
  inner.textContent = bits.join(" \xB7 ");
...
//# sourceMappingURL=/js/chunks/chunk-J5DWHQ6X.js.map
