 ...
 * future change to the room-key/DEK format. R+ HF's version numbering
 * restarted at 1.0.0 (see CLAUDE.md) — this is NOT R+'s 8.2.1; keep the gate
 * (NUBE_VERSION_GATE_ENABLED in wrangler.toml) off until this is set to a
 * real R+ HF release number.
 */
export const MIN_NUBE_APP_VERSION = '1.0.0';
